...
Check out the [guides](/forgetool/csi/) to get started!
...
- [VM Setup](/systemrequirements)
- [Getting Started with Clustertool](/forgetool/getting-started/)
- [clustertool init](/forgetool/commands/cluster/init/)
- Edit your config (talconfig.yaml and clusterenv.yaml)
- [clustertool genconfig](/forgetool/commands/cluster/genconfig/)
- [clustertool apply](/forgetool/commands/talos/apply/)
...
- [clustertool scaleexport](/forgetool/commands/scale/export)
...
- [clustertool helmrelease install](/forgetool/commands/helmrelease/install/)
