...
![Version: 43.0.15](https://img.shields.io/badge/Version-43.0.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 33.0.2](https://img.shields.io/badge/AppVersion-33.0.2-informational?style=flat-square)
...
For more information about this Chart, please check the docs on the TrueCharts [website](https://truecharts.org/charts/stable/nextcloud)
...
https://truecharts.org/stable/nextcloud
