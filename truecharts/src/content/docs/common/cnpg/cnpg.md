...
- See the [Full Examples](/common/cnpg/cnpg#full-examples) section for complete examples.
...
must be [enabled](/common/cnpg/cnpg#enabled) if needed.
...
See more details in [CNPG Cluster](/common/cnpg/cluster)
...
See the dedicated [CNPG backup/restore guide](/guides/backup%20%26%20restore/cnpg-backup-restore)
