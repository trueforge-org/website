...
If you want to install a chart using helm, lookup the name of the chart in our [Chart list](/charts/). Then, run this command to install it directly from our OCI repository:
