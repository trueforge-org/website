...
](/systemrequirements) to be alligable for ticket support.
...
- We do provide *basic* assistance with [Talos OS](/truetech/guides/talos/), when deployed or maintained through ClusterTool (upgrades, config changes etc)
