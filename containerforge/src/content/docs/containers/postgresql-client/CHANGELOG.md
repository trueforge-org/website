...
All history information can be found at [Github History](https://github.com/trueforge-org/truecharts/commits/master/charts//postgresql-client)
...
- BREAKING CHANGE(deps): Update docker.io/library/postgres Docker tag 1.1.0 → 9.6.24 (#1639) • [`64663f0`](https://github.com/trueforge-org/truecharts/commit/64663f0242278239309966f7e8c501da343b06ed) • [@TrueCharts Bot] (2026-03-18)
...
- release(postgresql-client): update ghcr.io/trueforge-org/ubuntu ( → ) (#228) • [`f68cd9e`](https://github.com/trueforge-org/truecharts/commit/f68cd9ebf97f0cba05cafcce9a870086c84b8bf2) • [@TrueCharts Bot] (2025-11-10)
