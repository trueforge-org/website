...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9787bbeb10058b7e4d6b1772d282c152WORD
      MARIADB_ROOT_PASSWORD: bff5e24850c5dee44cd4db4c99bf2766WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9787bbeb10058b7e4d6b1772d282c152WORD
      DB_PORT: "3306"
