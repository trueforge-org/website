...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 070d2432057284d1587dda1ed4fdaf4bWORD
      MARIADB_ROOT_PASSWORD: f292c67b03cc39e21749db14d01c5d01WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 070d2432057284d1587dda1ed4fdaf4bWORD
      DB_PORT: "3306"
