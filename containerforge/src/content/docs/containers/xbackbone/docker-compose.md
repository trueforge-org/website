...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3b983aa8fd42b5844cf584d63a07a813WORD
      MARIADB_ROOT_PASSWORD: 8e1f6de95799af5b065feaac802a00a6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3b983aa8fd42b5844cf584d63a07a813WORD
      DB_PORT: "3306"
