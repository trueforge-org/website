...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dad78cb01394ed68ddaf0988fee95775WORD
      MARIADB_ROOT_PASSWORD: 9efbf7a50b306be04050bc70e4ea151dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dad78cb01394ed68ddaf0988fee95775WORD
      DB_PORT: "3306"
