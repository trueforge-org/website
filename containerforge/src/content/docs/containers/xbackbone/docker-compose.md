...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 35e8658bd68a7cae272a7246621ccad8WORD
      MARIADB_ROOT_PASSWORD: 35f5db0a164492ac863e92c5c2c4c55dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 35e8658bd68a7cae272a7246621ccad8WORD
      DB_PORT: "3306"
