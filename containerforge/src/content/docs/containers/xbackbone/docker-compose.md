...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 349cd26acdf89beca1c9b527933cce93WORD
      MARIADB_ROOT_PASSWORD: e5556d6eb3e05afc35250cceb2eb823dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 349cd26acdf89beca1c9b527933cce93WORD
      DB_PORT: "3306"
