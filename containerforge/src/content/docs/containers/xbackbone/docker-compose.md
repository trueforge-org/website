...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8b60a866083631908ac1e8e2cd213de8WORD
      MARIADB_ROOT_PASSWORD: f7fdc721fa0deec35551a20e8d68eb79WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8b60a866083631908ac1e8e2cd213de8WORD
      DB_PORT: "3306"
