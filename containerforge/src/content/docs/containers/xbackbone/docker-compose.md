...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8960e413c207b1cb9acdaf4325716266WORD
      MARIADB_ROOT_PASSWORD: a066afdf96b8431c289030a9369cffb4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8960e413c207b1cb9acdaf4325716266WORD
      DB_PORT: "3306"
