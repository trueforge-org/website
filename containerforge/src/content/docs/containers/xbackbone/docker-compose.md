...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9c3ac4940207407324cee92b3719503bWORD
      MARIADB_ROOT_PASSWORD: f3b9c15ae943a4856f24ee15d774eda0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9c3ac4940207407324cee92b3719503bWORD
      DB_PORT: "3306"
