...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0fd104c5cd476a7e448fcb96b3dc595cWORD
      MARIADB_ROOT_PASSWORD: 24143a65c084bf84dcc2b6a270cdedc5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0fd104c5cd476a7e448fcb96b3dc595cWORD
      DB_PORT: "3306"
