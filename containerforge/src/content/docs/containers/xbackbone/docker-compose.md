...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 34a1fca3567fa6e0f491470311fcdd34WORD
      MARIADB_ROOT_PASSWORD: b39945052a54d8fbecade6d5f51c9462WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 34a1fca3567fa6e0f491470311fcdd34WORD
      DB_PORT: "3306"
