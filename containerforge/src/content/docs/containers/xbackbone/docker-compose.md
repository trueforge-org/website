...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 30e72c1a9db9a96e75f8cadbe680a8f3WORD
      MARIADB_ROOT_PASSWORD: 947b24794d7532630ba9b6fa5e09642fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 30e72c1a9db9a96e75f8cadbe680a8f3WORD
      DB_PORT: "3306"
