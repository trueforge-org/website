...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 74efc9fd52d49655da5f92818f48e938WORD
      MARIADB_ROOT_PASSWORD: 901a31ad625e583db2ec3a29386edfd2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 74efc9fd52d49655da5f92818f48e938WORD
      DB_PORT: "3306"
