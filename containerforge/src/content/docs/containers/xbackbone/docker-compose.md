...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fe08915a8319ac7ed0d50a3aaa20d9afWORD
      MARIADB_ROOT_PASSWORD: 0752b3e73e20a47c2c77ec368ed83377WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fe08915a8319ac7ed0d50a3aaa20d9afWORD
      DB_PORT: "3306"
