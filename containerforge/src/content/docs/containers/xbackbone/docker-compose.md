...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d1e8bedc786567722d22dc72271e7dccWORD
      MARIADB_ROOT_PASSWORD: 47b8cd8b3fcabba3d2a116171f7f44f3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d1e8bedc786567722d22dc72271e7dccWORD
      DB_PORT: "3306"
