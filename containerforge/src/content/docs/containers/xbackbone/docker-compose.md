...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8c2eb6806625609ce772d3c44e98bee1WORD
      MARIADB_ROOT_PASSWORD: a908c854e9ec83e6a2d293fa9a21dd88WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8c2eb6806625609ce772d3c44e98bee1WORD
      DB_PORT: "3306"
