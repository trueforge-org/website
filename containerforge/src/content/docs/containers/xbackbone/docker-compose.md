...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ff852063708ba12f686ee87733a8439cWORD
      MARIADB_ROOT_PASSWORD: 0599538115f764b01fe197e4d647b3c7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ff852063708ba12f686ee87733a8439cWORD
      DB_PORT: "3306"
