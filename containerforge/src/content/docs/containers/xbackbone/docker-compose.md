...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 59a332cae04a27f2c158eca0b8831420WORD
      MARIADB_ROOT_PASSWORD: ae06637ba6b8715f2709ab903fb965cbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 59a332cae04a27f2c158eca0b8831420WORD
      DB_PORT: "3306"
