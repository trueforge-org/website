...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 750ea255ce0f7154825eaf9563f961c5WORD
      MARIADB_ROOT_PASSWORD: 84263f1565f1f17a84404fada79f661bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 750ea255ce0f7154825eaf9563f961c5WORD
      DB_PORT: "3306"
