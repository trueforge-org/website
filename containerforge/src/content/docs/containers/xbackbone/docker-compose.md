...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 44f175a7ba9bc1886df3e8152074a797WORD
      MARIADB_ROOT_PASSWORD: c81547f5408531cc18f55208a97b06eaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 44f175a7ba9bc1886df3e8152074a797WORD
      DB_PORT: "3306"
