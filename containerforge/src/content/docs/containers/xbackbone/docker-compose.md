...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 04025ca3428043dd04bdfa157c6abe27WORD
      MARIADB_ROOT_PASSWORD: c9ea817edca7ec57449b47b37cd50947WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 04025ca3428043dd04bdfa157c6abe27WORD
      DB_PORT: "3306"
