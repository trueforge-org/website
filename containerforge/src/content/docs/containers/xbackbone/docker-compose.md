...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e3eb1738400ff953759bcadeaaad34c0WORD
      MARIADB_ROOT_PASSWORD: ff467cc5e9446df233f9e673185f57a1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e3eb1738400ff953759bcadeaaad34c0WORD
      DB_PORT: "3306"
