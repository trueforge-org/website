...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 661e4190119049be2f240edf8fb82533WORD
      MARIADB_ROOT_PASSWORD: f741a89e9771ec3bb489a903acb87556WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 661e4190119049be2f240edf8fb82533WORD
      DB_PORT: "3306"
