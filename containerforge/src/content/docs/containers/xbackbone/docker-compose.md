...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 20296b811b995d2ecdcc6e98f56ae348WORD
      MARIADB_ROOT_PASSWORD: 4137770bb3caa4711b5b5c181eb4354eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 20296b811b995d2ecdcc6e98f56ae348WORD
      DB_PORT: "3306"
