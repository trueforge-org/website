...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8ee05959d8bc1d1b85e8f5677573f428WORD
      MARIADB_ROOT_PASSWORD: 6c2381e95e301470efa5a2b2bdffa924WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8ee05959d8bc1d1b85e8f5677573f428WORD
      DB_PORT: "3306"
