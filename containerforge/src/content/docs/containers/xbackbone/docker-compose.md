...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 06cc667941ebcffd25d442baacc96e25WORD
      MARIADB_ROOT_PASSWORD: a845050788c5e5e749f9ae269bee5a5cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 06cc667941ebcffd25d442baacc96e25WORD
      DB_PORT: "3306"
