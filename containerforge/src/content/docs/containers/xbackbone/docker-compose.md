...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 466c133829f3ae884dea59c704a05be0WORD
      MARIADB_ROOT_PASSWORD: 5be2cc3ab1e2cada296c576d0f05ca9eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 466c133829f3ae884dea59c704a05be0WORD
      DB_PORT: "3306"
