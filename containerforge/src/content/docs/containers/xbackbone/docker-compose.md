...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b1bb24aa0b6b8c9829b4a49f8ee214a2WORD
      MARIADB_ROOT_PASSWORD: a4a799010f319c8a120f58a9b072aecdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b1bb24aa0b6b8c9829b4a49f8ee214a2WORD
      DB_PORT: "3306"
