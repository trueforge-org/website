...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3771fb1dddb1268beef19dcc802c12fcWORD
      MARIADB_ROOT_PASSWORD: de632161b3345fd0615e63def805c4f2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3771fb1dddb1268beef19dcc802c12fcWORD
      DB_PORT: "3306"
