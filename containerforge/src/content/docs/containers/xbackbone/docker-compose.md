...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fc59c5972c5c7cdf30b341c934da114dWORD
      MARIADB_ROOT_PASSWORD: 8f61e09dcdfeda4a595b7c748551503eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fc59c5972c5c7cdf30b341c934da114dWORD
      DB_PORT: "3306"
