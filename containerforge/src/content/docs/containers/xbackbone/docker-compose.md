...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 63e7a6bec4bb58973e42655f3760f105WORD
      MARIADB_ROOT_PASSWORD: f0e873be2a96d980c22a6b6272b6c606WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 63e7a6bec4bb58973e42655f3760f105WORD
      DB_PORT: "3306"
