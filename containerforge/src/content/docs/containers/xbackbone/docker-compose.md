...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7c4ca22a82ac2d01b5f9a2f23d29e039WORD
      MARIADB_ROOT_PASSWORD: 90a2276f161a3dcff2645e012bc9d10bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7c4ca22a82ac2d01b5f9a2f23d29e039WORD
      DB_PORT: "3306"
