...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8100db22a224fc2838ed71cb371b93ccWORD
      MARIADB_ROOT_PASSWORD: eef558a9047b535a98c398f477ab4238WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8100db22a224fc2838ed71cb371b93ccWORD
      DB_PORT: "3306"
