...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 349b6fd8a19a311a052b6ca85c301bcbWORD
      MARIADB_ROOT_PASSWORD: 2ad5aa710e9ec889a71ff5972a660b55WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 349b6fd8a19a311a052b6ca85c301bcbWORD
      DB_PORT: "3306"
