...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e50be44589bc03b4784cad3cc723b2aWORD
      MARIADB_ROOT_PASSWORD: b489997080e0c0b34f5ea4e3a1134a20WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e50be44589bc03b4784cad3cc723b2aWORD
      DB_PORT: "3306"
