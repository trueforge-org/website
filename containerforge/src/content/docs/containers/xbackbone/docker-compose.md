...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9b39b1319eff0601f30d28976386f124WORD
      MARIADB_ROOT_PASSWORD: 098f37d4c3caa1d724b55ba679ab258cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9b39b1319eff0601f30d28976386f124WORD
      DB_PORT: "3306"
