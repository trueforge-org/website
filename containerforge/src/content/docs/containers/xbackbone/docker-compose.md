...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08990b61ef4931ea0493ffe2619d2ce0WORD
      MARIADB_ROOT_PASSWORD: 08dc632f651f8e0abee3c0945e126172WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08990b61ef4931ea0493ffe2619d2ce0WORD
      DB_PORT: "3306"
