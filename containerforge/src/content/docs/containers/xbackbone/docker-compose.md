...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 923f16ea19cd39613c7f3d17b899949bWORD
      MARIADB_ROOT_PASSWORD: 0d356fbc1168c17e17e5a4640ca574d2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 923f16ea19cd39613c7f3d17b899949bWORD
      DB_PORT: "3306"
