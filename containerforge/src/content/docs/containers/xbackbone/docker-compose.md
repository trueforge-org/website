...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0d886e489dd59f832c8333412039d1aaWORD
      MARIADB_ROOT_PASSWORD: af3886de8bcca3c3bdc1f50fd125dbabWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0d886e489dd59f832c8333412039d1aaWORD
      DB_PORT: "3306"
