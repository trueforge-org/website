...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0f4562c297a224659b417e2be95709bcWORD
      MARIADB_ROOT_PASSWORD: 5ce2a8762273ac118e3ec72f17fe3b7eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0f4562c297a224659b417e2be95709bcWORD
      DB_PORT: "3306"
