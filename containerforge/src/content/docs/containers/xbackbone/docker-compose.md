...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 25e0ad5d953c5bf8a9a92ba05f6da9ecWORD
      MARIADB_ROOT_PASSWORD: 728690ecda655186bb3d5c6d956c9877WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 25e0ad5d953c5bf8a9a92ba05f6da9ecWORD
      DB_PORT: "3306"
