...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 949bd21c8587545c554ad18aa7817f87WORD
      MARIADB_ROOT_PASSWORD: 8f9a0d39e79ddc020c32f020c74a0690WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 949bd21c8587545c554ad18aa7817f87WORD
      DB_PORT: "3306"
