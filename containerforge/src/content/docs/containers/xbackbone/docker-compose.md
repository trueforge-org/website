...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b03f66ffac05325c0c06904caff874bfWORD
      MARIADB_ROOT_PASSWORD: 11ac9fdf8e145db0b7ff21f0b11c4b63WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b03f66ffac05325c0c06904caff874bfWORD
      DB_PORT: "3306"
