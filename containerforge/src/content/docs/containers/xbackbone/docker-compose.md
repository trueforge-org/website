...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 36f1d8748f628f7e21104ebf9674fe7fWORD
      MARIADB_ROOT_PASSWORD: b73a1e27302514ed0c42e09d3e5bd03eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 36f1d8748f628f7e21104ebf9674fe7fWORD
      DB_PORT: "3306"
