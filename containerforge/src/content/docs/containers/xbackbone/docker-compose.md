...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 39f3c5e24c71ad9eb82878cc35397ac2WORD
      MARIADB_ROOT_PASSWORD: 4d0c174d9f8e362d1adaf078ac972d6bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 39f3c5e24c71ad9eb82878cc35397ac2WORD
      DB_PORT: "3306"
