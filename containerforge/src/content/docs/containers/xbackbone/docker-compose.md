...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b4e50acf4e406843812788d788111762WORD
      MARIADB_ROOT_PASSWORD: 48cb9860b318a7b1b783c696998257eeWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b4e50acf4e406843812788d788111762WORD
      DB_PORT: "3306"
