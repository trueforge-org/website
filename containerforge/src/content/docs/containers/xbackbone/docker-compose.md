...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9cafbff084b6de63dede7e9d526244e3WORD
      MARIADB_ROOT_PASSWORD: acd0cd796dfd8be5abee878fd51a677fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9cafbff084b6de63dede7e9d526244e3WORD
      DB_PORT: "3306"
