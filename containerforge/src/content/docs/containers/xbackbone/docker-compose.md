...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 86805558bbfe802e9c41a89bea8974eeWORD
      MARIADB_ROOT_PASSWORD: 4ed0fc241928bec2d79b844f0675a9baWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 86805558bbfe802e9c41a89bea8974eeWORD
      DB_PORT: "3306"
