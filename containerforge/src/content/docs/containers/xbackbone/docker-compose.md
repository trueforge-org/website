...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e3e5669b3a291c59c06362c6d8c5d2a2WORD
      MARIADB_ROOT_PASSWORD: e0b6676fa5c7a75a2f270c664e853eb1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e3e5669b3a291c59c06362c6d8c5d2a2WORD
      DB_PORT: "3306"
