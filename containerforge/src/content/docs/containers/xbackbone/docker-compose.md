...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 48d8fe6a529f18460a61ba2ab49c480bWORD
      MARIADB_ROOT_PASSWORD: 535a412b3722a960dd0b2c82d9ae94b2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 48d8fe6a529f18460a61ba2ab49c480bWORD
      DB_PORT: "3306"
