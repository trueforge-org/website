...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a5334a6c371e87abc9864dee3b689a59WORD
      MARIADB_ROOT_PASSWORD: 0191d967d10929c0d40afecd92bde7e4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a5334a6c371e87abc9864dee3b689a59WORD
      DB_PORT: "3306"
