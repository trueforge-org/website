...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e5e1a467d69d59795dec58e923dffdd7WORD
      MARIADB_ROOT_PASSWORD: fe531db877ec809cfed34be5abc8a8eaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e5e1a467d69d59795dec58e923dffdd7WORD
      DB_PORT: "3306"
