...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 60f2a0bea1003e0abcb101c5ccf5e909WORD
      MARIADB_ROOT_PASSWORD: 0e8c3648f7360a8e48645547c285d075WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 60f2a0bea1003e0abcb101c5ccf5e909WORD
      DB_PORT: "3306"
