...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: afc9128c6747fa8e69f7ac537a4c916bWORD
      MARIADB_ROOT_PASSWORD: d56ae2a532dcf576d44d0ff11e0e0649WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: afc9128c6747fa8e69f7ac537a4c916bWORD
      DB_PORT: "3306"
