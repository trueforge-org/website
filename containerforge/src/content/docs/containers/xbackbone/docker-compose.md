...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0d43ea94368d5eea6a1ad45d07138b85WORD
      MARIADB_ROOT_PASSWORD: c1e50cad107504d7ee43f55cc74b2b5dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0d43ea94368d5eea6a1ad45d07138b85WORD
      DB_PORT: "3306"
