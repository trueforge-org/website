...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 68254d6a680e7a5670b6497b80000d1bWORD
      MARIADB_ROOT_PASSWORD: a32869c44546373c4dce4d3eccdc24f8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 68254d6a680e7a5670b6497b80000d1bWORD
      DB_PORT: "3306"
