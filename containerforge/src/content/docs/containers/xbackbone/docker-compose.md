...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 819c6e40c1d43d405053c714cd897521WORD
      MARIADB_ROOT_PASSWORD: c67367d562ba2055ebe04e3aee5b0d24WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 819c6e40c1d43d405053c714cd897521WORD
      DB_PORT: "3306"
