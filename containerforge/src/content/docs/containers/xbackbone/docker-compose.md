...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 14c2b44130020c11263b3404a400fb64WORD
      MARIADB_ROOT_PASSWORD: 4e2b0440a566f521b8635363aaf3d3cdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 14c2b44130020c11263b3404a400fb64WORD
      DB_PORT: "3306"
