...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7ecf25fbd2700de97fbd479ac99cb79fWORD
      MARIADB_ROOT_PASSWORD: 2948ea39aa51faa8bdb07a796887e58bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7ecf25fbd2700de97fbd479ac99cb79fWORD
      DB_PORT: "3306"
