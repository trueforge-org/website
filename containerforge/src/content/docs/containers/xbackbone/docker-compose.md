...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bedff608b68e8d0d3cf01685c21e7365WORD
      MARIADB_ROOT_PASSWORD: f90fa8590ae6258445114570b74af2cfWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bedff608b68e8d0d3cf01685c21e7365WORD
      DB_PORT: "3306"
