...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 14ae00aea855a696318e7a710014025eWORD
      MARIADB_ROOT_PASSWORD: 7eb55560f0daca8fece7f4a8e66eaae8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 14ae00aea855a696318e7a710014025eWORD
      DB_PORT: "3306"
