...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 70a7b5fc8089c935df36a71803f408c1WORD
      MARIADB_ROOT_PASSWORD: c5d977f9c6b09428a059faa854ad791bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 70a7b5fc8089c935df36a71803f408c1WORD
      DB_PORT: "3306"
