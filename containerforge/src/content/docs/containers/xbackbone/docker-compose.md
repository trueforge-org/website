...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2fc646a194d7e5fac6eae5cad9c4d60cWORD
      MARIADB_ROOT_PASSWORD: b4c443359e2dc00c92230cc69ad6cd13WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2fc646a194d7e5fac6eae5cad9c4d60cWORD
      DB_PORT: "3306"
