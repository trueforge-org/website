...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 84924954522cd3add6f00b17f4bcca04WORD
      MARIADB_ROOT_PASSWORD: a40ae00f058b4781a8037f2923070544WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 84924954522cd3add6f00b17f4bcca04WORD
      DB_PORT: "3306"
