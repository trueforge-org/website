...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1cc2aafb39da09995bdbe4c542787c79WORD
      MARIADB_ROOT_PASSWORD: 1a74df08112be02d8ff9d4a4d072af68WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1cc2aafb39da09995bdbe4c542787c79WORD
      DB_PORT: "3306"
