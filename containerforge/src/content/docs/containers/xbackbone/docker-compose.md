...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 396344ea83ebdf1937c2cd573bdb9034WORD
      MARIADB_ROOT_PASSWORD: 246e04ecd28625f46fc78379d67f7062WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 396344ea83ebdf1937c2cd573bdb9034WORD
      DB_PORT: "3306"
