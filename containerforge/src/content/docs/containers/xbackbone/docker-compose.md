...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5443a89bbaba6196a02276f1ae214aadWORD
      MARIADB_ROOT_PASSWORD: 21430daef4fc15441ebce3e4146eb0c0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5443a89bbaba6196a02276f1ae214aadWORD
      DB_PORT: "3306"
