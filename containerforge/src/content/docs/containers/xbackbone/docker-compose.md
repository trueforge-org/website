...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a71188b5aed1840de4cf7047726c50aeWORD
      MARIADB_ROOT_PASSWORD: d936ba692285f6eb23df8d6bbe83b9d4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a71188b5aed1840de4cf7047726c50aeWORD
      DB_PORT: "3306"
