...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 26895fc193bf1edd3493e5a3ec44400eWORD
      MARIADB_ROOT_PASSWORD: 668a98c7aef06dff672929858f708df0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 26895fc193bf1edd3493e5a3ec44400eWORD
      DB_PORT: "3306"
