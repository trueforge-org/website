...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 322d97207acd05d310653d17fdd991b1WORD
      MARIADB_ROOT_PASSWORD: 10186434fee32d70595b3469639ed88dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 322d97207acd05d310653d17fdd991b1WORD
      DB_PORT: "3306"
