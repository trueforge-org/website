...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 577a3c68f15cc724eb1c30fd01c50bd4WORD
      MARIADB_ROOT_PASSWORD: b77fc9786235e9015abefd430bcfeb20WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 577a3c68f15cc724eb1c30fd01c50bd4WORD
      DB_PORT: "3306"
