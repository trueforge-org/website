...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 637415eb4f2e8861ee569a18e861d3efWORD
      MARIADB_ROOT_PASSWORD: 8dcd3b1906e8d6db06ffc092c268bfe2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 637415eb4f2e8861ee569a18e861d3efWORD
      DB_PORT: "3306"
