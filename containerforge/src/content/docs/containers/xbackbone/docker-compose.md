...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3612e1ce22f8906dd623082dcd64825bWORD
      MARIADB_ROOT_PASSWORD: 1d26f3498ccbf035970a114004f82408WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3612e1ce22f8906dd623082dcd64825bWORD
      DB_PORT: "3306"
