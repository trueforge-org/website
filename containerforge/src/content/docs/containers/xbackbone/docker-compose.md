...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d20a9cd2c9ac67125bd2850908477a50WORD
      MARIADB_ROOT_PASSWORD: a61e85612569daef5f5114b555e18cebWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d20a9cd2c9ac67125bd2850908477a50WORD
      DB_PORT: "3306"
