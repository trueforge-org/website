...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 67526895ba531dcf5ee9f8c05a54ea26WORD
      MARIADB_ROOT_PASSWORD: f244bba4f3a9ba0d8520f9f980cfb23bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 67526895ba531dcf5ee9f8c05a54ea26WORD
      DB_PORT: "3306"
