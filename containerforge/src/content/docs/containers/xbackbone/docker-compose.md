...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cd3350db328e321da302ae636569f658WORD
      MARIADB_ROOT_PASSWORD: 2cf1e147e5e8699e1d8e19596fa30f86WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cd3350db328e321da302ae636569f658WORD
      DB_PORT: "3306"
