...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dee32304a10ecccd4aef9ed7a6ef1d1bWORD
      MARIADB_ROOT_PASSWORD: 7a379a0f034e7ffab8de2048d10f95baWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dee32304a10ecccd4aef9ed7a6ef1d1bWORD
      DB_PORT: "3306"
