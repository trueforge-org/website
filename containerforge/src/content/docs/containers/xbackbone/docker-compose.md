...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6a9d77f615bd954cc4cb2762f71952a0WORD
      MARIADB_ROOT_PASSWORD: 50d3f6a5182ac77379fdf03043a4dc4dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6a9d77f615bd954cc4cb2762f71952a0WORD
      DB_PORT: "3306"
