...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b93d1b0a2db240a68fe1d07cc12c4b99WORD
      MARIADB_ROOT_PASSWORD: b77d16de40b29cf1414f3c793ca74c58WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b93d1b0a2db240a68fe1d07cc12c4b99WORD
      DB_PORT: "3306"
