...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: de08fe56e5c14920d3a03e664edf01d7WORD
      MARIADB_ROOT_PASSWORD: 01d82dc4f4de860d8b2b9e50d8374ad9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: de08fe56e5c14920d3a03e664edf01d7WORD
      DB_PORT: "3306"
