...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0da6534bc169044260b6b4e021fc5ac8WORD
      MARIADB_ROOT_PASSWORD: f562d13d48856dbd9c9e7bef6e8230d6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0da6534bc169044260b6b4e021fc5ac8WORD
      DB_PORT: "3306"
