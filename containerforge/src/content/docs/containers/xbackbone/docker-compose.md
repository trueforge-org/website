...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 28e96a3ddcc8fc5e6042f40f20151ae8WORD
      MARIADB_ROOT_PASSWORD: 25953c745fe6d6265f2cb6f1474c95d9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 28e96a3ddcc8fc5e6042f40f20151ae8WORD
      DB_PORT: "3306"
