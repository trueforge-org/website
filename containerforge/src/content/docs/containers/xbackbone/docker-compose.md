...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 929bcb12d4b54283cc10dade03c9a4b6WORD
      MARIADB_ROOT_PASSWORD: 9e3872991098ebfb331e3f7d289ec1e9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 929bcb12d4b54283cc10dade03c9a4b6WORD
      DB_PORT: "3306"
