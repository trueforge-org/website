...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fe3e840d0a0980bb2ac5a8eafe0becdfWORD
      MARIADB_ROOT_PASSWORD: 9ab87abbeadfeaf944462bb20a28c8ddWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fe3e840d0a0980bb2ac5a8eafe0becdfWORD
      DB_PORT: "3306"
