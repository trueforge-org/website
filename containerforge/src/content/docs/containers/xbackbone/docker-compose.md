...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f908ec665dc42a35056bd1a56011606dWORD
      MARIADB_ROOT_PASSWORD: 567283ecd0fb1f70e917057eead7c511WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f908ec665dc42a35056bd1a56011606dWORD
      DB_PORT: "3306"
