...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b6d4ba4215b35cc9041bcade112130e6WORD
      MARIADB_ROOT_PASSWORD: e3ed2f93b04640570064d902d5a402fcWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b6d4ba4215b35cc9041bcade112130e6WORD
      DB_PORT: "3306"
