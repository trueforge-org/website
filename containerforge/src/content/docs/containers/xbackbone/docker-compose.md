...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2709f6d08712a4f798986636cb7a449dWORD
      MARIADB_ROOT_PASSWORD: 35a8d5f051a03e8ee25342736d56c2beWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2709f6d08712a4f798986636cb7a449dWORD
      DB_PORT: "3306"
