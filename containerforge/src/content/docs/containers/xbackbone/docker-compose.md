...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9399ef65a152646e935d98af9b8bcdeeWORD
      MARIADB_ROOT_PASSWORD: 82efb5cc0d2d1f4ed9d8b27bf62fe612WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9399ef65a152646e935d98af9b8bcdeeWORD
      DB_PORT: "3306"
