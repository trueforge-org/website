...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0650e552def1623cad4b7d0bf46401cbWORD
      MARIADB_ROOT_PASSWORD: 6a9df62dceb55d2d4db6c8d904c159acWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0650e552def1623cad4b7d0bf46401cbWORD
      DB_PORT: "3306"
