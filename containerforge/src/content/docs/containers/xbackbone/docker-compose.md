...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 93ccd04405ece0f50bab13c490224754WORD
      MARIADB_ROOT_PASSWORD: eea9982936dda2375d9aab7ce8f40c32WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 93ccd04405ece0f50bab13c490224754WORD
      DB_PORT: "3306"
