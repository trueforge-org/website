...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6ff6c256f6a6ff934191de365a3d978fWORD
      MARIADB_ROOT_PASSWORD: 8b01fd107d33c107cc6d9c23d2afbfe5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6ff6c256f6a6ff934191de365a3d978fWORD
      DB_PORT: "3306"
