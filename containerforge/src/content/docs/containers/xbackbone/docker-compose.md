...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 90cac46ee21cf0e4fa302a2a4dbe2a0eWORD
      MARIADB_ROOT_PASSWORD: 01c01da19c2aeede676028662f681a12WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 90cac46ee21cf0e4fa302a2a4dbe2a0eWORD
      DB_PORT: "3306"
