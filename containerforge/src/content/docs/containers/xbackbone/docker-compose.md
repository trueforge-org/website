...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4d0ea5f7c135741ab492535f9cb658d0WORD
      MARIADB_ROOT_PASSWORD: c125744dd89d1c46fa18e0e00cc4575fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4d0ea5f7c135741ab492535f9cb658d0WORD
      DB_PORT: "3306"
