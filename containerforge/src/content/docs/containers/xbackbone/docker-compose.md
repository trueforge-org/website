...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8cf3c33cf06155a62c1c11fac31248b2WORD
      MARIADB_ROOT_PASSWORD: 358bd367d41f0d4f9f790a6754dd7cd4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8cf3c33cf06155a62c1c11fac31248b2WORD
      DB_PORT: "3306"
