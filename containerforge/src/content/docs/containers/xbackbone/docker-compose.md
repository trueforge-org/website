...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 01c4e2a80270b547e2706cbb06d4aeefWORD
      MARIADB_ROOT_PASSWORD: a18714f00febf03b2cce9a4b625b48fdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 01c4e2a80270b547e2706cbb06d4aeefWORD
      DB_PORT: "3306"
