...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0331631e908114a69000ea49968689daWORD
      MARIADB_ROOT_PASSWORD: 099f70a460cb4ab1255c87e6063b352aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0331631e908114a69000ea49968689daWORD
      DB_PORT: "3306"
