...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e0729db9383a570347f3d0ab13fc21fcWORD
      MARIADB_ROOT_PASSWORD: 7ecdd63ef445d486bea6341b262e2f27WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e0729db9383a570347f3d0ab13fc21fcWORD
      DB_PORT: "3306"
