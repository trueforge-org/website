...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 994949af0c9aa3ce3a53fd926dbd98ddWORD
      MARIADB_ROOT_PASSWORD: ebbd07bc4c7cdf00d3a048ed2c078f54WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 994949af0c9aa3ce3a53fd926dbd98ddWORD
      DB_PORT: "3306"
