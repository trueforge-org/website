...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 41b66f7edf30a9271a6cc6f3b4041069WORD
      MARIADB_ROOT_PASSWORD: af5d63b4acdc327a63d5357cb7f478e0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 41b66f7edf30a9271a6cc6f3b4041069WORD
      DB_PORT: "3306"
