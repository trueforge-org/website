...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 12ae868caad8cc10bd7be01f7dc25e45WORD
      MARIADB_ROOT_PASSWORD: 18967cee2afd9c720d0c0c5301eda9f7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 12ae868caad8cc10bd7be01f7dc25e45WORD
      DB_PORT: "3306"
