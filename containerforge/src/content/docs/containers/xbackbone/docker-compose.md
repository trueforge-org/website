...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a06186ff43ae886705d987b6fc514e31WORD
      MARIADB_ROOT_PASSWORD: d2a461ad822b503be0a6680aa68070e3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a06186ff43ae886705d987b6fc514e31WORD
      DB_PORT: "3306"
