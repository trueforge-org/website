...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 32f4c5ab6061e58a9d974b31c408cd8fWORD
      MARIADB_ROOT_PASSWORD: 5a5a5b509bfd74ec2dc907cb5e3e9867WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 32f4c5ab6061e58a9d974b31c408cd8fWORD
      DB_PORT: "3306"
