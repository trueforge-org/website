...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eeb25ed7831a7686a8310ef6d9b6843aWORD
      MARIADB_ROOT_PASSWORD: 2f2fc233ee5e4d2951423b9b40f9760bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eeb25ed7831a7686a8310ef6d9b6843aWORD
      DB_PORT: "3306"
