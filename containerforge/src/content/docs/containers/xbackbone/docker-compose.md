...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e5bc55231dafa0c5a0e4f746604866adWORD
      MARIADB_ROOT_PASSWORD: 283647de42036a2d4ee7dd6d20639c4dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e5bc55231dafa0c5a0e4f746604866adWORD
      DB_PORT: "3306"
