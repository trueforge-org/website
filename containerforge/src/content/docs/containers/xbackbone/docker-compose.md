...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eeddbaab21ef3eb8b566a5bdc7f66b92WORD
      MARIADB_ROOT_PASSWORD: e551460f72cdc87ff4c2aaca72bbaa81WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eeddbaab21ef3eb8b566a5bdc7f66b92WORD
      DB_PORT: "3306"
