...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bbb4d738f6ed55bb42d819bdda600361WORD
      MARIADB_ROOT_PASSWORD: 92628ceb17fa82d5d35add789f878abdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bbb4d738f6ed55bb42d819bdda600361WORD
      DB_PORT: "3306"
