...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d4d65c10253df2c188738ad5aaae5692WORD
      MARIADB_ROOT_PASSWORD: 6d89a37c7dbd7b0df061f57e848cfbceWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d4d65c10253df2c188738ad5aaae5692WORD
      DB_PORT: "3306"
