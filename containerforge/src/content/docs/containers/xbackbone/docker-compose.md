...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 44f3cf15c332fdd73071efe1fd90604dWORD
      MARIADB_ROOT_PASSWORD: f3cbcb351e3648fe1f107945c3b57764WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 44f3cf15c332fdd73071efe1fd90604dWORD
      DB_PORT: "3306"
