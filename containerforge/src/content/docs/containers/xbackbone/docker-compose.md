...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: da6575edeaa1211cf4a6b4daddd7c205WORD
      MARIADB_ROOT_PASSWORD: cecf30cbb80c7460a5f5fc67543c3a9cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: da6575edeaa1211cf4a6b4daddd7c205WORD
      DB_PORT: "3306"
