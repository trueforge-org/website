...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5db66496bcb419b8c09cd30a9d3c6134WORD
      MARIADB_ROOT_PASSWORD: b2379fbaa069875df127eae9e91d7035WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5db66496bcb419b8c09cd30a9d3c6134WORD
      DB_PORT: "3306"
