...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7a7d58f6caa1d1e5d0c4c75eaceb3afcWORD
      MARIADB_ROOT_PASSWORD: 30589bbd1beee60849cf21b51d001c46WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7a7d58f6caa1d1e5d0c4c75eaceb3afcWORD
      DB_PORT: "3306"
