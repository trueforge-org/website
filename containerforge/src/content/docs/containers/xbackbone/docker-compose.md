...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5be48ef1286d30afe35cfd0f90df7b45WORD
      MARIADB_ROOT_PASSWORD: 84b21fe59bc116fbfee3a691eb5b2f3dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5be48ef1286d30afe35cfd0f90df7b45WORD
      DB_PORT: "3306"
