...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d1cf37e9035f2f0707080151e467f23cWORD
      MARIADB_ROOT_PASSWORD: a36db9063a2f1b8cc4ca936914abe4d8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d1cf37e9035f2f0707080151e467f23cWORD
      DB_PORT: "3306"
