...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 662553bedde256f6de6e8d6bf94c9a2dWORD
      MARIADB_ROOT_PASSWORD: 8f49d929058f9b55f2681f8783eec7e8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 662553bedde256f6de6e8d6bf94c9a2dWORD
      DB_PORT: "3306"
