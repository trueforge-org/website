...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b90cb35d239b1d91fd72a4a1053969e0WORD
      MARIADB_ROOT_PASSWORD: 599226f9fe99aa09c789959c6fe01edbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b90cb35d239b1d91fd72a4a1053969e0WORD
      DB_PORT: "3306"
