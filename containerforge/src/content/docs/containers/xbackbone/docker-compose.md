...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d4c4612da82a823b2dd082318a006e3fWORD
      MARIADB_ROOT_PASSWORD: 8bdbfee29d4933ef262b04b62ca10b05WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d4c4612da82a823b2dd082318a006e3fWORD
      DB_PORT: "3306"
