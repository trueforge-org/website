...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3b1885e64b44a6b83fb8f42011db9a69WORD
      MARIADB_ROOT_PASSWORD: e3918ab26660bdafefdbcf06726b39e0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3b1885e64b44a6b83fb8f42011db9a69WORD
      DB_PORT: "3306"
