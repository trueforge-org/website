...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 523e2bf68ce6805150174ec7eaa84fc5WORD
      MARIADB_ROOT_PASSWORD: 7b69eafbfd3c92fc22fa124a49ffebdfWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 523e2bf68ce6805150174ec7eaa84fc5WORD
      DB_PORT: "3306"
