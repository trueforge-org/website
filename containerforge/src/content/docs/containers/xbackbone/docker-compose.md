...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: accb773a2e61fc4d4ec7404e6b484873WORD
      MARIADB_ROOT_PASSWORD: 8cc44c6ecbbbd71f97e6fd0fd6308ed5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: accb773a2e61fc4d4ec7404e6b484873WORD
      DB_PORT: "3306"
