...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b688c36e1a0eecccb0b022294c76ce08WORD
      MARIADB_ROOT_PASSWORD: 16a2afcecacd92bae31f81d241dff5aaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b688c36e1a0eecccb0b022294c76ce08WORD
      DB_PORT: "3306"
