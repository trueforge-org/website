...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8eeca12ec69047711b7be519cbb9ba72WORD
      MARIADB_ROOT_PASSWORD: 2c85f78044259a65035f16b81d7d7edbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8eeca12ec69047711b7be519cbb9ba72WORD
      DB_PORT: "3306"
