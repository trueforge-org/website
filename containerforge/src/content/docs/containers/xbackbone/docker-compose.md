...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5834629015cdfcdf1ef8760a37cd7d3dWORD
      MARIADB_ROOT_PASSWORD: 78f4c13bc5fd725680fb5fffb156e23dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5834629015cdfcdf1ef8760a37cd7d3dWORD
      DB_PORT: "3306"
