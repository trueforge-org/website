...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5993bdee60401f750b553eadddeb8faeWORD
      MARIADB_ROOT_PASSWORD: bcc5aebd9c7c9b08658d80b3c958738fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5993bdee60401f750b553eadddeb8faeWORD
      DB_PORT: "3306"
