...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ed95435947fc0842b82d03f727afb091WORD
      MARIADB_ROOT_PASSWORD: 5c67eb37f17b283562367f35be9a5b0dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ed95435947fc0842b82d03f727afb091WORD
      DB_PORT: "3306"
