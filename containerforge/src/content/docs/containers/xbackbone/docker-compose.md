...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: faf8c3259bc342ac0503adffdfb21a0aWORD
      MARIADB_ROOT_PASSWORD: af822e2e45f7c6e00017fb97827e3938WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: faf8c3259bc342ac0503adffdfb21a0aWORD
      DB_PORT: "3306"
