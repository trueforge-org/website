...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e85aea9289445ec488c9ea0e768b6975WORD
      MARIADB_ROOT_PASSWORD: e97d3a9c28e333bf0b9572268102bae2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e85aea9289445ec488c9ea0e768b6975WORD
      DB_PORT: "3306"
