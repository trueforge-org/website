...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f7394790e01ecbd54414518c3560e7fdWORD
      MARIADB_ROOT_PASSWORD: df9c38936b72992d649c21932419bc1eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f7394790e01ecbd54414518c3560e7fdWORD
      DB_PORT: "3306"
