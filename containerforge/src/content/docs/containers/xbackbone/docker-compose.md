...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dd63dcdc66a7ecd04c5210683eeaff29WORD
      MARIADB_ROOT_PASSWORD: 119b0ebcb4916dfe250cd41f9e7106bbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dd63dcdc66a7ecd04c5210683eeaff29WORD
      DB_PORT: "3306"
