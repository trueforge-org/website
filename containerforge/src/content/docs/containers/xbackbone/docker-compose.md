...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1b051a64372973c234b48c7daa457319WORD
      MARIADB_ROOT_PASSWORD: 41f286baf5b24cb4c861ed74dcd9c556WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1b051a64372973c234b48c7daa457319WORD
      DB_PORT: "3306"
