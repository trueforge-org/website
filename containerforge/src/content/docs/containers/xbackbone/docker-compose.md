...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8fa90fe8dee472c91a0236fa692a3746WORD
      MARIADB_ROOT_PASSWORD: 4aef7a69cb6bc501bf3b1eb0985619f7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8fa90fe8dee472c91a0236fa692a3746WORD
      DB_PORT: "3306"
