...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e9d2c834fedbefbd5b054d7e160f72eWORD
      MARIADB_ROOT_PASSWORD: 009012137393cef650e353d6cc60f3b2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e9d2c834fedbefbd5b054d7e160f72eWORD
      DB_PORT: "3306"
