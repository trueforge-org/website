...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 57a3a8c012d83326c4e9fb52e1772c20WORD
      MARIADB_ROOT_PASSWORD: 7756f1c86f18654551b36a339aed49a1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 57a3a8c012d83326c4e9fb52e1772c20WORD
      DB_PORT: "3306"
