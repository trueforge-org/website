...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c928a8bebe976a58d8fd9dc0177f23a0WORD
      MARIADB_ROOT_PASSWORD: fcd8099c5c2d8b484a8b1210da822f9fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c928a8bebe976a58d8fd9dc0177f23a0WORD
      DB_PORT: "3306"
