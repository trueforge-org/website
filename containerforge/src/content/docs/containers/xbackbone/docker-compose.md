...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 132865d26eda33e930256c851c5ebdd8WORD
      MARIADB_ROOT_PASSWORD: cffb1f55ac0f4ccd8ae77e9e191efc5fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 132865d26eda33e930256c851c5ebdd8WORD
      DB_PORT: "3306"
