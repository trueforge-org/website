...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3bcf7cd201536613fc25d620b5c0d7dfWORD
      MARIADB_ROOT_PASSWORD: 0eddeccc4ae911ca8caa0fad8a0f0a40WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3bcf7cd201536613fc25d620b5c0d7dfWORD
      DB_PORT: "3306"
