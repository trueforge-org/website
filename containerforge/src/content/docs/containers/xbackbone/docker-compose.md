...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7644763f3eb838bc1460fc4a0f6f63c6WORD
      MARIADB_ROOT_PASSWORD: fabfbc42e2480fe6cce7dabb12f6ce14WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7644763f3eb838bc1460fc4a0f6f63c6WORD
      DB_PORT: "3306"
