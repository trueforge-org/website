...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: db7d27276b0458c01188aff2144afc34WORD
      MARIADB_ROOT_PASSWORD: e06d5ce85175cc76345d6b128496e3c2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: db7d27276b0458c01188aff2144afc34WORD
      DB_PORT: "3306"
