...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 580e022c98980cb275a803277f36d22bWORD
      MARIADB_ROOT_PASSWORD: 7bd097224e1acec9b9353f4c4aa118c0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 580e022c98980cb275a803277f36d22bWORD
      DB_PORT: "3306"
