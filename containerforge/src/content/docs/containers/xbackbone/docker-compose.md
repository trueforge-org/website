...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7da5ed2aacbc89c7925a4c3e5c90fbefWORD
      MARIADB_ROOT_PASSWORD: 450dd1b15a76a84b6231fe9974e8841fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7da5ed2aacbc89c7925a4c3e5c90fbefWORD
      DB_PORT: "3306"
