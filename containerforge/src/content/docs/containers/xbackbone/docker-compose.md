...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ad384789de84931031d7665424c5f439WORD
      MARIADB_ROOT_PASSWORD: 85ca2355c69e4f55898e3bf0d97b6e7eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ad384789de84931031d7665424c5f439WORD
      DB_PORT: "3306"
