...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7cd02ccbe030364536869ec267437952WORD
      MARIADB_ROOT_PASSWORD: a8b005f7055be3f787e06e6b51b018c4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7cd02ccbe030364536869ec267437952WORD
      DB_PORT: "3306"
