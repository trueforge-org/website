...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 71b794aaf82ec6fcbaeb8a8bcaf99898WORD
      MARIADB_ROOT_PASSWORD: 03de2ee9cfa2a6cf09d04e3a19f72b75WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 71b794aaf82ec6fcbaeb8a8bcaf99898WORD
      DB_PORT: "3306"
