...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9aed63499d9053ec081cd2b1789dc7d1WORD
      MARIADB_ROOT_PASSWORD: 6fab6ba4adaf27a4f9ee79b4ed9d6e55WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9aed63499d9053ec081cd2b1789dc7d1WORD
      DB_PORT: "3306"
