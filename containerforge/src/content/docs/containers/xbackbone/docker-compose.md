...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ad6efba98796114b1a82cf9960e070c3WORD
      MARIADB_ROOT_PASSWORD: 18756a02f6f79dd28513e3f750451f13WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ad6efba98796114b1a82cf9960e070c3WORD
      DB_PORT: "3306"
