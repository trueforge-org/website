...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5ebf635bc92db210e82f603fbe06dc06WORD
      MARIADB_ROOT_PASSWORD: 61f855dc052fbe99d81342db14766028WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5ebf635bc92db210e82f603fbe06dc06WORD
      DB_PORT: "3306"
