...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1a40a4253cfa1f5573cf261192cc3d44WORD
      MARIADB_ROOT_PASSWORD: 6399708afd8f51b612310f86a16f6c6dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1a40a4253cfa1f5573cf261192cc3d44WORD
      DB_PORT: "3306"
