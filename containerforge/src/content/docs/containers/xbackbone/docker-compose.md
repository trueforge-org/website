...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 803ea0f0ea1518db077961479af8a29cWORD
      MARIADB_ROOT_PASSWORD: f0bc830af8493af9a3c264c7fcd58a35WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 803ea0f0ea1518db077961479af8a29cWORD
      DB_PORT: "3306"
