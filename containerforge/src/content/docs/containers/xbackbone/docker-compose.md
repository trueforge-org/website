...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 56215669e94c34a3d179d92e95a34d20WORD
      MARIADB_ROOT_PASSWORD: ff7a75aae4993f86a0e0bd4d6703bfeeWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 56215669e94c34a3d179d92e95a34d20WORD
      DB_PORT: "3306"
