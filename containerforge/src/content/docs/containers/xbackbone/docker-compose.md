...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ce0c2316bb71c376c187557f3139f74bWORD
      MARIADB_ROOT_PASSWORD: 101c8dc49679adc339627c077a475881WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ce0c2316bb71c376c187557f3139f74bWORD
      DB_PORT: "3306"
