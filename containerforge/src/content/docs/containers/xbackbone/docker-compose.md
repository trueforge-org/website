...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b33aa7660a8aad3e436d903a8bc03be7WORD
      MARIADB_ROOT_PASSWORD: 5e503730ad45af7ce3a4d3e39c12f779WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b33aa7660a8aad3e436d903a8bc03be7WORD
      DB_PORT: "3306"
