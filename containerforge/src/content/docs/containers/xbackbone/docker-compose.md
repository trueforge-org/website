...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 903db6f99b0d2361e35010b926a40618WORD
      MARIADB_ROOT_PASSWORD: 5d5a88db6907bd74d31ccb2786f6cdf6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 903db6f99b0d2361e35010b926a40618WORD
      DB_PORT: "3306"
