...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ef78e1d1311450be957215da70b991f6WORD
      MARIADB_ROOT_PASSWORD: 54f385768badb72f4788d026e5a87e4bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ef78e1d1311450be957215da70b991f6WORD
      DB_PORT: "3306"
