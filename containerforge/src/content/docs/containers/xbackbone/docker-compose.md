...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d7c28e715d882b29efae5c6843d2d365WORD
      MARIADB_ROOT_PASSWORD: fb0775a80e16c1667fc92e5d324a80c2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d7c28e715d882b29efae5c6843d2d365WORD
      DB_PORT: "3306"
