...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 83e8c63d9ccdfd4441ddda90f5e52d9bWORD
      MARIADB_ROOT_PASSWORD: 222f63f7d4e293f83c9fb405a3e68273WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 83e8c63d9ccdfd4441ddda90f5e52d9bWORD
      DB_PORT: "3306"
