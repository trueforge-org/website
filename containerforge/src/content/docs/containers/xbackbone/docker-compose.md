...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cf1c58f1a753e6726e36d1e7d8b45717WORD
      MARIADB_ROOT_PASSWORD: 7f1fd79bef499af553a730d4b2fc5480WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cf1c58f1a753e6726e36d1e7d8b45717WORD
      DB_PORT: "3306"
