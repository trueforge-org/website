...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a32c3d8c605c2e8376aacaf7235cf7b9WORD
      MARIADB_ROOT_PASSWORD: 175ade7531b28dc89e2d97928b19226bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a32c3d8c605c2e8376aacaf7235cf7b9WORD
      DB_PORT: "3306"
