...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 03d55fafdb038281b930afa73c6d373bWORD
      MARIADB_ROOT_PASSWORD: c00ae4dbceb86e1693bab632ceb53c80WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 03d55fafdb038281b930afa73c6d373bWORD
      DB_PORT: "3306"
