...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6e4ec586ec347222ce3b841164fffc04WORD
      MARIADB_ROOT_PASSWORD: 0ed14bd891889e12acfbdc7069517b2aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6e4ec586ec347222ce3b841164fffc04WORD
      DB_PORT: "3306"
