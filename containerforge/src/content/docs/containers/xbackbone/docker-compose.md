...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 24df198b0782f4093b0752b7e90bb282WORD
      MARIADB_ROOT_PASSWORD: 26495453b63c7f509ee4908e67f6207eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 24df198b0782f4093b0752b7e90bb282WORD
      DB_PORT: "3306"
