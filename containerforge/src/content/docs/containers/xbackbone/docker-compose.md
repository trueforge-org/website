...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 507e06ca6c980e8350cbc88550bdbcb0WORD
      MARIADB_ROOT_PASSWORD: 9216b4116d560def05c1ed9cb700d7e8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 507e06ca6c980e8350cbc88550bdbcb0WORD
      DB_PORT: "3306"
