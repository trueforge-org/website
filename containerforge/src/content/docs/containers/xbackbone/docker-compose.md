...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b1ef624d650fb67829e8d3ed2128bda0WORD
      MARIADB_ROOT_PASSWORD: 708094bd774562964fb83b2bce6db1c0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b1ef624d650fb67829e8d3ed2128bda0WORD
      DB_PORT: "3306"
