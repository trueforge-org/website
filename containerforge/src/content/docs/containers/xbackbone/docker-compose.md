...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0a50bd9e6a31ed96c46a7752e6cd20d0WORD
      MARIADB_ROOT_PASSWORD: 309dcb8283a2b3f9fdfe1e95f2919143WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0a50bd9e6a31ed96c46a7752e6cd20d0WORD
      DB_PORT: "3306"
