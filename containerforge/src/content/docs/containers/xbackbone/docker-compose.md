...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f0722f6175a4dd0502ef89ab6284efadWORD
      MARIADB_ROOT_PASSWORD: dd380b8ae6660fd1c36062e4c82e379bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f0722f6175a4dd0502ef89ab6284efadWORD
      DB_PORT: "3306"
