...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c4d345d651e4ba1c264e6ed190777a6bWORD
      MARIADB_ROOT_PASSWORD: 86eb1a6c6b786b285c609eecd123173bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c4d345d651e4ba1c264e6ed190777a6bWORD
      DB_PORT: "3306"
