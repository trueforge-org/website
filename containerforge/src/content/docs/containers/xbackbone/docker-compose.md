...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: aecbee63e7b4ce4470f495978372010cWORD
      MARIADB_ROOT_PASSWORD: 8de9425a870ac306c73378aac4afcff0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: aecbee63e7b4ce4470f495978372010cWORD
      DB_PORT: "3306"
