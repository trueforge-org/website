...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 327e7771716c27589c75213a08a6983bWORD
      MARIADB_ROOT_PASSWORD: b17249100d17ca18e1690fb4f164364aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 327e7771716c27589c75213a08a6983bWORD
      DB_PORT: "3306"
