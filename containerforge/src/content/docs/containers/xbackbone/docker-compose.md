...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bf2f7d42f9b32b0a2ddcd50126a0a6c0WORD
      MARIADB_ROOT_PASSWORD: 1e5d04885f38d8b5bee721661a635e92WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bf2f7d42f9b32b0a2ddcd50126a0a6c0WORD
      DB_PORT: "3306"
