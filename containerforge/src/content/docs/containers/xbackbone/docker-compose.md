...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: af3769ec9a2b98edc7213554db3e6735WORD
      MARIADB_ROOT_PASSWORD: 8771b84e80db7072cf76ed6fc947cbf0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: af3769ec9a2b98edc7213554db3e6735WORD
      DB_PORT: "3306"
