...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f9e4aefdab51299e5d921027cc42b3f2WORD
      MARIADB_ROOT_PASSWORD: 0c53d2b60513d191dfb40fc3e6b304fdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f9e4aefdab51299e5d921027cc42b3f2WORD
      DB_PORT: "3306"
