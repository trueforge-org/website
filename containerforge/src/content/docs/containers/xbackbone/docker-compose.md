...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e43989a74b4d98bfcc0e5f5b1a2f39d8WORD
      MARIADB_ROOT_PASSWORD: d6d07721ee0f82351a7a7f1a4260af60WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e43989a74b4d98bfcc0e5f5b1a2f39d8WORD
      DB_PORT: "3306"
