...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a2d3cbc75bbf22b6b9d5c51d6b19b459WORD
      MARIADB_ROOT_PASSWORD: b5f93f82c7f87e878e75720dd13b4834WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a2d3cbc75bbf22b6b9d5c51d6b19b459WORD
      DB_PORT: "3306"
