...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e0626bc0b4b30d11bc07489d9784cbb7WORD
      MARIADB_ROOT_PASSWORD: fce1552388a65f106be425c00961893fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e0626bc0b4b30d11bc07489d9784cbb7WORD
      DB_PORT: "3306"
