...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 19c564c086a742969e69bedb582110b5WORD
      MARIADB_ROOT_PASSWORD: 7e83b694b2a8ea6e6cfb6a6de03b91c2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 19c564c086a742969e69bedb582110b5WORD
      DB_PORT: "3306"
