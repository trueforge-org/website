...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bfb58879e952ca4fe01956b3da162e80WORD
      MARIADB_ROOT_PASSWORD: f1ebac07ad4869b0d74e20cef7bfb0cdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bfb58879e952ca4fe01956b3da162e80WORD
      DB_PORT: "3306"
