...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3cb3d6bfcc9a45a9b620ce1ffe62e00bWORD
      MARIADB_ROOT_PASSWORD: b0298f2b2bfdc17727fa8e29b9c54d1aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3cb3d6bfcc9a45a9b620ce1ffe62e00bWORD
      DB_PORT: "3306"
