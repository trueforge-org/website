...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c86baa0190df4b10c1dfd805511308b4WORD
      MARIADB_ROOT_PASSWORD: d0cdad720b37ddf8184ee9f704de8d01WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c86baa0190df4b10c1dfd805511308b4WORD
      DB_PORT: "3306"
