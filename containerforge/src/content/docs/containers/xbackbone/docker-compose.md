...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c5b2b36167f920a9fd686cc5a2ac119cWORD
      MARIADB_ROOT_PASSWORD: 6d20ff45b011cef7a45bf466d6a365a5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c5b2b36167f920a9fd686cc5a2ac119cWORD
      DB_PORT: "3306"
