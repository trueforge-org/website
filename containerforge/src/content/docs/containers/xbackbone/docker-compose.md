...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a1ac303ab6ccaeaa684f407fc69f8014WORD
      MARIADB_ROOT_PASSWORD: 1bdce6febc4db1cb236f880f39dd384fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a1ac303ab6ccaeaa684f407fc69f8014WORD
      DB_PORT: "3306"
