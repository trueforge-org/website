...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d4aa19e90fef526105132f81db8259b9WORD
      MARIADB_ROOT_PASSWORD: 43a44c3ac39f4a35986feac6101fe4d6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d4aa19e90fef526105132f81db8259b9WORD
      DB_PORT: "3306"
