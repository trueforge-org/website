...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5df961e4762de34edc93666e85d8caffWORD
      MARIADB_ROOT_PASSWORD: 5c1fe7d1fb1f439d6819ea707695582eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5df961e4762de34edc93666e85d8caffWORD
      DB_PORT: "3306"
