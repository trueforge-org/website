...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ec7c08737133e8e33adca94a8d4491a4WORD
      MARIADB_ROOT_PASSWORD: 47cfcab540eff240e63d2f076d1665f3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ec7c08737133e8e33adca94a8d4491a4WORD
      DB_PORT: "3306"
