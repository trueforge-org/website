...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cc5f9175c67eb02c553f324e5260d716WORD
      MARIADB_ROOT_PASSWORD: 560f41e0e86b28b33afeef689c454d1cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cc5f9175c67eb02c553f324e5260d716WORD
      DB_PORT: "3306"
