...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4251aeca43ea760793fb15a3aa716e1cWORD
      MARIADB_ROOT_PASSWORD: 5b2eebbcff668fddad2e6e2079197525WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4251aeca43ea760793fb15a3aa716e1cWORD
      DB_PORT: "3306"
