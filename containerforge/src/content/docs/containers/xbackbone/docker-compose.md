...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d8242b91f7fc62815fce428f8b4e0784WORD
      MARIADB_ROOT_PASSWORD: 057902073bc4799626f340e1054109a5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d8242b91f7fc62815fce428f8b4e0784WORD
      DB_PORT: "3306"
