...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7826ff7fc1dc5e9857befe574e947a63WORD
      MARIADB_ROOT_PASSWORD: 797f1b67fd9db387bcc1d62d78fa8d78WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7826ff7fc1dc5e9857befe574e947a63WORD
      DB_PORT: "3306"
