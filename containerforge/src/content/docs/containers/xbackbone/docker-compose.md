...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 836c20e5e6fd2d182eafdd4b55e40790WORD
      MARIADB_ROOT_PASSWORD: bef6958f44d74e702c7f577574be611dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 836c20e5e6fd2d182eafdd4b55e40790WORD
      DB_PORT: "3306"
