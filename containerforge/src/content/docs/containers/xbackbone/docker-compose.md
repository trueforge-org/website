...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b85b338b1f4c21d7bfbcd13389784c98WORD
      MARIADB_ROOT_PASSWORD: c07654bfa60b31a55f739fc0733270f5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b85b338b1f4c21d7bfbcd13389784c98WORD
      DB_PORT: "3306"
