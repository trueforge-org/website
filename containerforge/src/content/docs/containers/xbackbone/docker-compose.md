...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9dc490eb3fb00c86ecebff69545e1e8bWORD
      MARIADB_ROOT_PASSWORD: e55656c65f202276dab10be2bfa171d9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9dc490eb3fb00c86ecebff69545e1e8bWORD
      DB_PORT: "3306"
