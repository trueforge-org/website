...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 987024aa4c0dab00acce0ecde323a167WORD
      MARIADB_ROOT_PASSWORD: 37b2aada3ecbab04f46c938aece35166WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 987024aa4c0dab00acce0ecde323a167WORD
      DB_PORT: "3306"
