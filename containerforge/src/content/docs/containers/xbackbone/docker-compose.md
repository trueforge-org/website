...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 709afcd471493265b6b7514d05039c63WORD
      MARIADB_ROOT_PASSWORD: 40b6c0e3a4a006df5cb55f021aecf882WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 709afcd471493265b6b7514d05039c63WORD
      DB_PORT: "3306"
