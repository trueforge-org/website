...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 46d46fb5554321d85ab313beb57155b2WORD
      MARIADB_ROOT_PASSWORD: 822d083146bf67672ee383397c3d1fafWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 46d46fb5554321d85ab313beb57155b2WORD
      DB_PORT: "3306"
