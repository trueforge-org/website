...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c501975c76da91365d06ab0db723d3bcWORD
      MARIADB_ROOT_PASSWORD: 293ae0386b4a4c82fa9ec35f511500c6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c501975c76da91365d06ab0db723d3bcWORD
      DB_PORT: "3306"
