...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e10f7c7e3cea77c08a8955160959c20WORD
      MARIADB_ROOT_PASSWORD: db7595245a50642f7059f06e0e733276WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e10f7c7e3cea77c08a8955160959c20WORD
      DB_PORT: "3306"
