...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9c02e4002013257e85a86f967646c9c2WORD
      MARIADB_ROOT_PASSWORD: 89d0b889efac303335b5fa730d358364WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9c02e4002013257e85a86f967646c9c2WORD
      DB_PORT: "3306"
