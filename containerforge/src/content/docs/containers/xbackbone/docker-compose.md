...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b5ce54b76fb433983aca2a114aad450cWORD
      MARIADB_ROOT_PASSWORD: a8da1824d46569b66792168dc61f1061WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b5ce54b76fb433983aca2a114aad450cWORD
      DB_PORT: "3306"
