...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f78ccdf21642d34455bfbb0c067ce6caWORD
      MARIADB_ROOT_PASSWORD: fa42b25be15bbbbd3e976d69e997c495WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f78ccdf21642d34455bfbb0c067ce6caWORD
      DB_PORT: "3306"
