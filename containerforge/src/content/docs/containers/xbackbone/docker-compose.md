...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8ce04fe0da311df5c4cfd3accf0146baWORD
      MARIADB_ROOT_PASSWORD: 17ddef24c3f2847396858bcde1707584WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8ce04fe0da311df5c4cfd3accf0146baWORD
      DB_PORT: "3306"
