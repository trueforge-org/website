...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8d0d4b8cbbdc1fde0955be8a7a98f418WORD
      MARIADB_ROOT_PASSWORD: de11dac6117c8494fa21cb75b64e0401WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8d0d4b8cbbdc1fde0955be8a7a98f418WORD
      DB_PORT: "3306"
