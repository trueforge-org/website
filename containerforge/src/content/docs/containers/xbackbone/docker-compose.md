...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9212af519d6d47d47081ab58378a8750WORD
      MARIADB_ROOT_PASSWORD: 63358a568597c57b6c8a1a01274f29b4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9212af519d6d47d47081ab58378a8750WORD
      DB_PORT: "3306"
