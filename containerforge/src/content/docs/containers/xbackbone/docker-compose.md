...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 19c14ac08dcd764011ae63f50af364c4WORD
      MARIADB_ROOT_PASSWORD: ea26308d079ca22fb84e15fc03f5afb2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 19c14ac08dcd764011ae63f50af364c4WORD
      DB_PORT: "3306"
