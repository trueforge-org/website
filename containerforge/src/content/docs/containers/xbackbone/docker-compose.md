...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8ea039f0f737bb58e59d9560486833b2WORD
      MARIADB_ROOT_PASSWORD: 2a7bab1de09af963525357561af08945WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8ea039f0f737bb58e59d9560486833b2WORD
      DB_PORT: "3306"
