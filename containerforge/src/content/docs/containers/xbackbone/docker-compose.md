...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9a00b364b72ecdc33141791089e78ac2WORD
      MARIADB_ROOT_PASSWORD: 8745443d1f25f714a2adfeae22c04fd3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9a00b364b72ecdc33141791089e78ac2WORD
      DB_PORT: "3306"
