...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9c71e766dfd0a1f2a62cab6da2d9a821WORD
      MARIADB_ROOT_PASSWORD: 1d43b716f44f7cde3224fb4d13e4c9c7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9c71e766dfd0a1f2a62cab6da2d9a821WORD
      DB_PORT: "3306"
