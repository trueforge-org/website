...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 42277ef47336efdb7ee8769033a8ce65WORD
      MARIADB_ROOT_PASSWORD: b152465c2bb229b24511da5a07123362WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 42277ef47336efdb7ee8769033a8ce65WORD
      DB_PORT: "3306"
