...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3b52daee86d4342c48b9c9ba32ac7ea0WORD
      MARIADB_ROOT_PASSWORD: bd4b336803516b9938d7a844537242daWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3b52daee86d4342c48b9c9ba32ac7ea0WORD
      DB_PORT: "3306"
