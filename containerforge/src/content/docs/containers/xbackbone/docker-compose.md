...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0284c4ca08580e73d079a9e1546679f5WORD
      MARIADB_ROOT_PASSWORD: 6d517acccac9ec524b3d32a341772053WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0284c4ca08580e73d079a9e1546679f5WORD
      DB_PORT: "3306"
