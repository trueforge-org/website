...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 25badf0a52009e6832070f59e85e102bWORD
      MARIADB_ROOT_PASSWORD: 46f265a3ace5dc9c6830966f39bbdb7eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 25badf0a52009e6832070f59e85e102bWORD
      DB_PORT: "3306"
