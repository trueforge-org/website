...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f340a7552afa8bb42bfe6f3fe4a7302bWORD
      MARIADB_ROOT_PASSWORD: d5f34029d62ff0a9253110578aacb5caWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f340a7552afa8bb42bfe6f3fe4a7302bWORD
      DB_PORT: "3306"
