...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 50427f8e054756924fe2662a6ef1eaf8WORD
      MARIADB_ROOT_PASSWORD: ae1fa004b69d6ec685cd4c012482cc4aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 50427f8e054756924fe2662a6ef1eaf8WORD
      DB_PORT: "3306"
