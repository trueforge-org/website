...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 620e4e0b36c2a68640eb8c271b333a35WORD
      MARIADB_ROOT_PASSWORD: c7112b3b32dfe45e26351f9df447fdd0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 620e4e0b36c2a68640eb8c271b333a35WORD
      DB_PORT: "3306"
