...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ece1448c2994afb5834171ea8b9437f2WORD
      MARIADB_ROOT_PASSWORD: 2f97d6d9fd079689786d4e38ad48fa3bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ece1448c2994afb5834171ea8b9437f2WORD
      DB_PORT: "3306"
