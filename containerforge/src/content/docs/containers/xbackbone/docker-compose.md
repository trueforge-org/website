...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ea16f1d4f362a8acaa49c222184863bdWORD
      MARIADB_ROOT_PASSWORD: 1e14965ce4a9e9ee41f6a813b70b8d91WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ea16f1d4f362a8acaa49c222184863bdWORD
      DB_PORT: "3306"
