...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 09ea34c9cb31443327141f6f8473a734WORD
      MARIADB_ROOT_PASSWORD: cbda2f01843ce3e57f061d14ef1df343WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 09ea34c9cb31443327141f6f8473a734WORD
      DB_PORT: "3306"
