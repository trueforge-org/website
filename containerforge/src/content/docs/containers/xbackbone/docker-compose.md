...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c64128df833f5f2244a9625f99723803WORD
      MARIADB_ROOT_PASSWORD: d6d9f1c5e2b54e0ddadd5b58a2771ae0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c64128df833f5f2244a9625f99723803WORD
      DB_PORT: "3306"
