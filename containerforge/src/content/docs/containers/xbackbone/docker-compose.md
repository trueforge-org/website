...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bd033b9764bd1fb13a0e98072aad17c6WORD
      MARIADB_ROOT_PASSWORD: 8b280f6f1073f6b19c0e8a334fd1ee61WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bd033b9764bd1fb13a0e98072aad17c6WORD
      DB_PORT: "3306"
