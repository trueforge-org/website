...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 777ae8e2b71bed1b14087dfc67706dbbWORD
      MARIADB_ROOT_PASSWORD: 5dd9798df8cb76ea7318aa25fe995e2bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 777ae8e2b71bed1b14087dfc67706dbbWORD
      DB_PORT: "3306"
