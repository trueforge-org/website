...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1b0a86b8b6c7cbbae729cc3d0bd5d421WORD
      MARIADB_ROOT_PASSWORD: 7844770c2f904e94b1bd2e3f06a05224WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1b0a86b8b6c7cbbae729cc3d0bd5d421WORD
      DB_PORT: "3306"
