...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1c36bb759baceff59bde0229b374dc52WORD
      MARIADB_ROOT_PASSWORD: 7d6b34174bd3f6db2b0718c5bed7af52WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1c36bb759baceff59bde0229b374dc52WORD
      DB_PORT: "3306"
