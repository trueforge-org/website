...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dc313c4c065cdbeaee165652900dd1a2WORD
      MARIADB_ROOT_PASSWORD: 2ce8901c4cf260b725956889cf1a6acbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dc313c4c065cdbeaee165652900dd1a2WORD
      DB_PORT: "3306"
