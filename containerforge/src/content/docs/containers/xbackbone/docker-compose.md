...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0215c655c2928311b92323049df63ecbWORD
      MARIADB_ROOT_PASSWORD: f91ad0fa86a0ff78c990b9c7147ee898WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0215c655c2928311b92323049df63ecbWORD
      DB_PORT: "3306"
