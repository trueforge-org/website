...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b81b6535f9066d239af963a284f5e62bWORD
      MARIADB_ROOT_PASSWORD: 316594e9fd8c3b050e9ead4507d18cf7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b81b6535f9066d239af963a284f5e62bWORD
      DB_PORT: "3306"
