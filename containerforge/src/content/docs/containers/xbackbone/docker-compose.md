...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3f6138a765ae840ffd8f38c367fe4fd1WORD
      MARIADB_ROOT_PASSWORD: 205a127f3cfd1ff2457075dfb355acceWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3f6138a765ae840ffd8f38c367fe4fd1WORD
      DB_PORT: "3306"
