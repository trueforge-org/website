...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9e24c698d1ec737b4c2081433b40bbb4WORD
      MARIADB_ROOT_PASSWORD: c749e707372edcde4648be5e2a3519a5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9e24c698d1ec737b4c2081433b40bbb4WORD
      DB_PORT: "3306"
