...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 936b9c4303fa22912dc829375dd8ea42WORD
      MARIADB_ROOT_PASSWORD: fadc3a8d2a454e954d8877c3c9474e0fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 936b9c4303fa22912dc829375dd8ea42WORD
      DB_PORT: "3306"
