...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 845ca94a02ece4f597d5603c0b64797aWORD
      MARIADB_ROOT_PASSWORD: 046ebcb8665f543b33ca0e3ef560142cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 845ca94a02ece4f597d5603c0b64797aWORD
      DB_PORT: "3306"
