...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ea7bcd0dc3f6fd6e8af5fe814e863ec6WORD
      MARIADB_ROOT_PASSWORD: fb75b439d6e3719f2db6c39c3236e68dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ea7bcd0dc3f6fd6e8af5fe814e863ec6WORD
      DB_PORT: "3306"
