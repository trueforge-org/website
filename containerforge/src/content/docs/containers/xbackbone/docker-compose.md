...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 87ab615913b86250e9a886024a622169WORD
      MARIADB_ROOT_PASSWORD: a0642da4b79e742d7e4404c94afece7aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 87ab615913b86250e9a886024a622169WORD
      DB_PORT: "3306"
