...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e2ef33285a144c68d5643059019990d0WORD
      MARIADB_ROOT_PASSWORD: 7790b3605ec6e827ea61f60da577a800WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e2ef33285a144c68d5643059019990d0WORD
      DB_PORT: "3306"
