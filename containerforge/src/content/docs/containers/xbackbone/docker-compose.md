...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bf0451814a51c0b87d143eac360bdc33WORD
      MARIADB_ROOT_PASSWORD: 6f7459d8ef74e1d9d2d687071a6f1841WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bf0451814a51c0b87d143eac360bdc33WORD
      DB_PORT: "3306"
