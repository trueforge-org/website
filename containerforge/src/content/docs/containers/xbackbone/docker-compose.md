...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2a39ea438bd5de93a83fc202b99c250cWORD
      MARIADB_ROOT_PASSWORD: 6deb7cdc669adc451cf5a9e58eb0ded6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2a39ea438bd5de93a83fc202b99c250cWORD
      DB_PORT: "3306"
