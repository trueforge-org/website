...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d13dafa8385c830598ca389a818081e0WORD
      MARIADB_ROOT_PASSWORD: ed97e1a30504a8d35cce30c9d77fa4a5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d13dafa8385c830598ca389a818081e0WORD
      DB_PORT: "3306"
