...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1d4d29d4e585b139b2c6a41fd9a0d538WORD
      MARIADB_ROOT_PASSWORD: 0824293aaeada38aad17ec58b085f4eeWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1d4d29d4e585b139b2c6a41fd9a0d538WORD
      DB_PORT: "3306"
