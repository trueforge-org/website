...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6db96bf9842c687d54875c44d2010109WORD
      MARIADB_ROOT_PASSWORD: a0a7f09b7061279264947c1637ef9522WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6db96bf9842c687d54875c44d2010109WORD
      DB_PORT: "3306"
