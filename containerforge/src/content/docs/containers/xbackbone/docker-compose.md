...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0019ad194d387351911dd7821fac7311WORD
      MARIADB_ROOT_PASSWORD: dd58154389a02a027c8ce92d6debf72bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0019ad194d387351911dd7821fac7311WORD
      DB_PORT: "3306"
