...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1e02811aef380d6a0ac2fa183b15021dWORD
      MARIADB_ROOT_PASSWORD: 5bdf9147f2d2e12bacaaf147161d3b62WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1e02811aef380d6a0ac2fa183b15021dWORD
      DB_PORT: "3306"
