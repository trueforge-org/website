...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8bcfa02ee0b51ff428c6ed2ecba77cdcWORD
      MARIADB_ROOT_PASSWORD: af60ffa42c96e62f02c8e4295c5a5560WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8bcfa02ee0b51ff428c6ed2ecba77cdcWORD
      DB_PORT: "3306"
