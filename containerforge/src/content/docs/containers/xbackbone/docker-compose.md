...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 89ca2a1c503f174d70369dfb9fd91cc0WORD
      MARIADB_ROOT_PASSWORD: d0aacc22209540061b4ad9c06d3f4c7fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 89ca2a1c503f174d70369dfb9fd91cc0WORD
      DB_PORT: "3306"
