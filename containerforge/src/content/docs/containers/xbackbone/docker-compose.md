...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8d6bfc1b94c5ddbaf72fc61c5ef9f736WORD
      MARIADB_ROOT_PASSWORD: 62fca4a6c7a0e40641f63eaf5901357dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8d6bfc1b94c5ddbaf72fc61c5ef9f736WORD
      DB_PORT: "3306"
