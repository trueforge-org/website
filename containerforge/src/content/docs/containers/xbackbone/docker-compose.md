...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 698ea5563daf164999f1f42ed8ae437cWORD
      MARIADB_ROOT_PASSWORD: d50e462c67d122176fcb4c3c43647ad6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 698ea5563daf164999f1f42ed8ae437cWORD
      DB_PORT: "3306"
