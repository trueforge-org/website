...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4d2326e1381216a050644c6e810ffadaWORD
      MARIADB_ROOT_PASSWORD: f044e183e27933e3803cb8f9345b1551WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4d2326e1381216a050644c6e810ffadaWORD
      DB_PORT: "3306"
