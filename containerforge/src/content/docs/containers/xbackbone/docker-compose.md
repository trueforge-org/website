...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e23837901438d180f807e91c617afde2WORD
      MARIADB_ROOT_PASSWORD: 192d62a0bf9b783dbd0984ce4bb91e09WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e23837901438d180f807e91c617afde2WORD
      DB_PORT: "3306"
