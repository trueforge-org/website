...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 166e93e06aac3f0de54c000b409127e3WORD
      MARIADB_ROOT_PASSWORD: b7260552bbcdce8ea96edb5359e0a01eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 166e93e06aac3f0de54c000b409127e3WORD
      DB_PORT: "3306"
