...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e49646e8fd7382390618c271a695edfdWORD
      MARIADB_ROOT_PASSWORD: 12c0335d4d78e77fb22c6df3fce5d7b9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e49646e8fd7382390618c271a695edfdWORD
      DB_PORT: "3306"
