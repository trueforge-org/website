...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ba1ebe00de6305c59adc2453ba96a1a8WORD
      MARIADB_ROOT_PASSWORD: 95ca199195cfa31c5455538078efeee3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ba1ebe00de6305c59adc2453ba96a1a8WORD
      DB_PORT: "3306"
