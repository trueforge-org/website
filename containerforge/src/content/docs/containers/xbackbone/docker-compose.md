...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bcef6fdababa9b93d5d8f283069ea531WORD
      MARIADB_ROOT_PASSWORD: ac3937eb689fd269a3d02be5c95d8714WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bcef6fdababa9b93d5d8f283069ea531WORD
      DB_PORT: "3306"
