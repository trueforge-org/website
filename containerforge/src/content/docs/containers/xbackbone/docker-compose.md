...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f12f352a71a3739e716356c4971a939aWORD
      MARIADB_ROOT_PASSWORD: 9b1b94832a3088dc069caaf47aedca47WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f12f352a71a3739e716356c4971a939aWORD
      DB_PORT: "3306"
