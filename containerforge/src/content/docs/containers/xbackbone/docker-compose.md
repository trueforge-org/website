...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a9f7ec99be6845c318a4eff1601428ceWORD
      MARIADB_ROOT_PASSWORD: ac099c1a846bdf56b0f9ef21dd319844WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a9f7ec99be6845c318a4eff1601428ceWORD
      DB_PORT: "3306"
