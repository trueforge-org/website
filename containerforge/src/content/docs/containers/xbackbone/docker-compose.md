...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d8a231af095ab97e37b209eef68374b1WORD
      MARIADB_ROOT_PASSWORD: 1e0824fc8610f5a5c6d19437ae42d889WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d8a231af095ab97e37b209eef68374b1WORD
      DB_PORT: "3306"
