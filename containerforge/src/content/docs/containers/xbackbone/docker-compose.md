...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d429b412bad33615585e1b6c35fc7070WORD
      MARIADB_ROOT_PASSWORD: 16e7071041afbfb15a86ea4c8543c9a3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d429b412bad33615585e1b6c35fc7070WORD
      DB_PORT: "3306"
