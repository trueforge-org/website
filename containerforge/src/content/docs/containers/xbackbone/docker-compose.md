...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4ab2ac7ee733125bb476118096ab30f0WORD
      MARIADB_ROOT_PASSWORD: 0cf40e1ae69fcde455c2b309af11ee4bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4ab2ac7ee733125bb476118096ab30f0WORD
      DB_PORT: "3306"
