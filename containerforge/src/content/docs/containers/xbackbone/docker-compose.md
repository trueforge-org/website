...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7f7c900611c1adaf9c8efec3732f1d56WORD
      MARIADB_ROOT_PASSWORD: b13a0cdbd2b8a4b2935944ff23967e28WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7f7c900611c1adaf9c8efec3732f1d56WORD
      DB_PORT: "3306"
