...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 445ee608ade7c2a581934f9a4920f7d1WORD
      MARIADB_ROOT_PASSWORD: fbf99599bd29ddfb17cc2bd66fb46beeWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 445ee608ade7c2a581934f9a4920f7d1WORD
      DB_PORT: "3306"
