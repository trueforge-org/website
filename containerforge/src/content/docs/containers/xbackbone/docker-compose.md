...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 145e24c88997fad1833ac3f38e5de7a9WORD
      MARIADB_ROOT_PASSWORD: 355e7e5c7f39d898a9f3d35af89f1b4eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 145e24c88997fad1833ac3f38e5de7a9WORD
      DB_PORT: "3306"
