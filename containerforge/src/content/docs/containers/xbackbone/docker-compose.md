...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6b2bf84664693f31b9f0b790d60a200bWORD
      MARIADB_ROOT_PASSWORD: 4530f79140c6bb56fbb79bfebf8419efWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6b2bf84664693f31b9f0b790d60a200bWORD
      DB_PORT: "3306"
