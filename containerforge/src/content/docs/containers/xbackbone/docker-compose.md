...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1526db8a4ebd2a9e01deb47e051b397cWORD
      MARIADB_ROOT_PASSWORD: 33b8b4f9883bf198c0c7850f4aa0be78WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1526db8a4ebd2a9e01deb47e051b397cWORD
      DB_PORT: "3306"
