...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cf8c56fbdebcf96854e99211cf815ddeWORD
      MARIADB_ROOT_PASSWORD: fae88cba29107555b69bb28ec2af2174WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cf8c56fbdebcf96854e99211cf815ddeWORD
      DB_PORT: "3306"
