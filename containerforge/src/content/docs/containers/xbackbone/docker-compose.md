...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3c414ebe0660b24049b98c353e6b67d1WORD
      MARIADB_ROOT_PASSWORD: 64006040619d61a97c7946c573084d92WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3c414ebe0660b24049b98c353e6b67d1WORD
      DB_PORT: "3306"
