...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 120893a5e336abfa4868f3a7a6fe21dbWORD
      MARIADB_ROOT_PASSWORD: 5cee330bd1f9903f49fa7049fe99ef7eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 120893a5e336abfa4868f3a7a6fe21dbWORD
      DB_PORT: "3306"
