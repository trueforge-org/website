...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 48912b76b49ad71e088a6d8d89a9a44bWORD
      MARIADB_ROOT_PASSWORD: fa609ccd9a1ba34df9a1fc47d6c16bc8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 48912b76b49ad71e088a6d8d89a9a44bWORD
      DB_PORT: "3306"
