...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4ecc31d265b14c946b0a97eaf487e96cWORD
      MARIADB_ROOT_PASSWORD: f307e532f89ad8ede65194e7e69e8506WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4ecc31d265b14c946b0a97eaf487e96cWORD
      DB_PORT: "3306"
