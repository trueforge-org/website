...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fa36bed70ad79e9e4748ec0bd3fb321bWORD
      MARIADB_ROOT_PASSWORD: a5594bfe98826720841ae6f9be7aed18WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fa36bed70ad79e9e4748ec0bd3fb321bWORD
      DB_PORT: "3306"
