...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6cf9bae0323c51ebeded13209819d4dfWORD
      MARIADB_ROOT_PASSWORD: a3f6aad84185a1613f2509d505a01e52WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6cf9bae0323c51ebeded13209819d4dfWORD
      DB_PORT: "3306"
