...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 62a660a8710cfa88f7f4f6ba70cf29dbWORD
      MARIADB_ROOT_PASSWORD: 390f15f8762e1a1b34f72c8b354f69a1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 62a660a8710cfa88f7f4f6ba70cf29dbWORD
      DB_PORT: "3306"
