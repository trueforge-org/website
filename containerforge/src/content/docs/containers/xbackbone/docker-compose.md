...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 67ea1eb8f8a8f25ad6715da157d6b861WORD
      MARIADB_ROOT_PASSWORD: 70a3cc0c10207c4c8373f411d778179aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 67ea1eb8f8a8f25ad6715da157d6b861WORD
      DB_PORT: "3306"
