...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08d2b342dcbfd1acc718612e3779ec35WORD
      MARIADB_ROOT_PASSWORD: f9319a4231c6574addb2cfc606786f40WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08d2b342dcbfd1acc718612e3779ec35WORD
      DB_PORT: "3306"
