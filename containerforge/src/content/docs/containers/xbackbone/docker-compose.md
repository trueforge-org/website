...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d072a092499b086794b9f16171f9569WORD
      MARIADB_ROOT_PASSWORD: 6e3c03799b121a6aab3dd751ce0eec48WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d072a092499b086794b9f16171f9569WORD
      DB_PORT: "3306"
