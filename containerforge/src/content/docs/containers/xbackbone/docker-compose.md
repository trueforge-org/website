...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6a0bb87fa1abd59dda0db2dfca5b7486WORD
      MARIADB_ROOT_PASSWORD: 4f07228ff06bc9fec6dc2f797200d7ceWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6a0bb87fa1abd59dda0db2dfca5b7486WORD
      DB_PORT: "3306"
