...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e7b5a21d312fdf14834e87a8affafeaeWORD
      MARIADB_ROOT_PASSWORD: 2c9feac198d3dd2368dcf8c591f4ff3cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e7b5a21d312fdf14834e87a8affafeaeWORD
      DB_PORT: "3306"
