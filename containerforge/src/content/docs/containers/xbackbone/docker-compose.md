...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cff679f6d919db9b136ea768bd61fd78WORD
      MARIADB_ROOT_PASSWORD: a9f6638fa10168965807a85d721b521aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cff679f6d919db9b136ea768bd61fd78WORD
      DB_PORT: "3306"
