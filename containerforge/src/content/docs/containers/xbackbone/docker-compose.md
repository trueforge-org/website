...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ef38e17a0cb106e6de4797ebf5cee3f7WORD
      MARIADB_ROOT_PASSWORD: 55e05f342a4c8135ee364d0878dd5038WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ef38e17a0cb106e6de4797ebf5cee3f7WORD
      DB_PORT: "3306"
