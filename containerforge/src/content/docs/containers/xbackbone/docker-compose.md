...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4d46c316b96308a16226634c053c3c3eWORD
      MARIADB_ROOT_PASSWORD: 2e632abd6040680dda17070de40dd15dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4d46c316b96308a16226634c053c3c3eWORD
      DB_PORT: "3306"
