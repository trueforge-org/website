...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 333d7f919d1b883021039280ae425b4eWORD
      MARIADB_ROOT_PASSWORD: 5ecccea2f820a1dc3c242028dd3b1f2dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 333d7f919d1b883021039280ae425b4eWORD
      DB_PORT: "3306"
