...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d25d311724e5d7a5accb729bcfba626fWORD
      MARIADB_ROOT_PASSWORD: acc50987a41577cd03c1729cbbad098cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d25d311724e5d7a5accb729bcfba626fWORD
      DB_PORT: "3306"
