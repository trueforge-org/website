...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 938cf58dd9ce1b1279cb71164a1c2512WORD
      MARIADB_ROOT_PASSWORD: 63b8f8959224163edaae25ff3de137bfWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 938cf58dd9ce1b1279cb71164a1c2512WORD
      DB_PORT: "3306"
