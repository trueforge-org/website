...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 787ebc8389d8491e49b51cb1ea93a8c1WORD
      MARIADB_ROOT_PASSWORD: ea23d68b535c908759c708aa43d14b9bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 787ebc8389d8491e49b51cb1ea93a8c1WORD
      DB_PORT: "3306"
