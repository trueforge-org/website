...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 30743efce5b53deb926557a24e4279baWORD
      MARIADB_ROOT_PASSWORD: 292698a612b56bdf2f49f9bdb1875b2aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 30743efce5b53deb926557a24e4279baWORD
      DB_PORT: "3306"
