...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8daade976ccacd6d3ff7eb928c1afa79WORD
      MARIADB_ROOT_PASSWORD: e844014ccb053a95bdbe3ddcfabeea4dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8daade976ccacd6d3ff7eb928c1afa79WORD
      DB_PORT: "3306"
