...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 594fcebe8be5eeef1c5320b4e58f87c3WORD
      MARIADB_ROOT_PASSWORD: 4876df766456de402d4a65ec17dbff06WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 594fcebe8be5eeef1c5320b4e58f87c3WORD
      DB_PORT: "3306"
