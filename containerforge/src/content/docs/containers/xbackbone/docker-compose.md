...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 750be383c4ff7c0fe554637a2f80ee48WORD
      MARIADB_ROOT_PASSWORD: 92a2e5602507aa44896155d9f61a54c2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 750be383c4ff7c0fe554637a2f80ee48WORD
      DB_PORT: "3306"
