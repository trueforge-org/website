...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a66a954d452627778e0076467e3feb08WORD
      MARIADB_ROOT_PASSWORD: ebf168cb9cdd5d2651e3a1f448d6dd4bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a66a954d452627778e0076467e3feb08WORD
      DB_PORT: "3306"
