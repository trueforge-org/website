...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5505a07f91b7e20e820f5ac91fd858dfWORD
      MARIADB_ROOT_PASSWORD: 7455000304d2495d3f4d52490a1ae281WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5505a07f91b7e20e820f5ac91fd858dfWORD
      DB_PORT: "3306"
