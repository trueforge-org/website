...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ec45d5ba4a2e9470179a5626922991edWORD
      MARIADB_ROOT_PASSWORD: 61751eb4c4bfef93229b588f29af0d30WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ec45d5ba4a2e9470179a5626922991edWORD
      DB_PORT: "3306"
