...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 868f527b36d4ffe6ef453d9f3b3e6ae6WORD
      MARIADB_ROOT_PASSWORD: c1158781b8f928b4732307ff5b895b6bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 868f527b36d4ffe6ef453d9f3b3e6ae6WORD
      DB_PORT: "3306"
