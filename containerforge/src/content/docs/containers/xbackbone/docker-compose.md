...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 53c951ba85ab54c9de5b7fe2763f04a7WORD
      MARIADB_ROOT_PASSWORD: b595faff622c36c22b62065c9fbf9b8bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 53c951ba85ab54c9de5b7fe2763f04a7WORD
      DB_PORT: "3306"
