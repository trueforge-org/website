...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e1af38dc683d92256b6daebd1bb3537fWORD
      MARIADB_ROOT_PASSWORD: f4fd9609c6d913673529409a2fe552d9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e1af38dc683d92256b6daebd1bb3537fWORD
      DB_PORT: "3306"
