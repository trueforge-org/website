...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6bca792ef8d42ee5a262f51591e9af7cWORD
      MARIADB_ROOT_PASSWORD: 93a68a69bb6a912ae073a5bd95975663WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6bca792ef8d42ee5a262f51591e9af7cWORD
      DB_PORT: "3306"
