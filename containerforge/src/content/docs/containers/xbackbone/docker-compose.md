...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 96c00d2af9987d156bcaf69c8d754c53WORD
      MARIADB_ROOT_PASSWORD: efdfc27b4b151af41754752e2f90c224WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 96c00d2af9987d156bcaf69c8d754c53WORD
      DB_PORT: "3306"
