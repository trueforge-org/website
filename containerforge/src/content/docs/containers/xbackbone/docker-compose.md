...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e8d0c9240a4371a690b4e5ecb6a635c0WORD
      MARIADB_ROOT_PASSWORD: 6d870e65638942786652ed1d983d839cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e8d0c9240a4371a690b4e5ecb6a635c0WORD
      DB_PORT: "3306"
