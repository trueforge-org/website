...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8af837cc837811071a26c996e484d158WORD
      MARIADB_ROOT_PASSWORD: 4b5eaa347d045830ca2cbdfda0e82f99WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8af837cc837811071a26c996e484d158WORD
      DB_PORT: "3306"
