...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a4a468582c062c558f309a726efd5f91WORD
      MARIADB_ROOT_PASSWORD: 3098037bda8a3d09ee50bf052a132c1aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a4a468582c062c558f309a726efd5f91WORD
      DB_PORT: "3306"
