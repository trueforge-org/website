...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 98f1b865a180bdd46cc6a153e063e2a2WORD
      MARIADB_ROOT_PASSWORD: 38602350d81563b9f8d209744ed83f79WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 98f1b865a180bdd46cc6a153e063e2a2WORD
      DB_PORT: "3306"
