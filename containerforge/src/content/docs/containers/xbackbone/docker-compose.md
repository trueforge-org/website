...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c6d2d6ad2a5e3091c5e33fb681d0f603WORD
      MARIADB_ROOT_PASSWORD: d8052b82e574fb62f49d1fa8051d564fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c6d2d6ad2a5e3091c5e33fb681d0f603WORD
      DB_PORT: "3306"
