...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 86636af0519d51a109ab8ca18aed4904WORD
      MARIADB_ROOT_PASSWORD: d03053d9862050f2e19e096286b2d63dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 86636af0519d51a109ab8ca18aed4904WORD
      DB_PORT: "3306"
