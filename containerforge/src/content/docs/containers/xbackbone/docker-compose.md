...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8d625f0761ed4af61fcf44d2518bdb2aWORD
      MARIADB_ROOT_PASSWORD: e0b9cd86bde88263e6a536219b16bf42WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8d625f0761ed4af61fcf44d2518bdb2aWORD
      DB_PORT: "3306"
