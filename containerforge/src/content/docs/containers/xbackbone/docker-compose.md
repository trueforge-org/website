...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1b5f978ae8b508499c682343df21c1f9WORD
      MARIADB_ROOT_PASSWORD: 641f72bf4713c0702ba871eacd6e7af3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1b5f978ae8b508499c682343df21c1f9WORD
      DB_PORT: "3306"
