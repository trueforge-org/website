...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 32a9c70112fa3c6f9b578791869a1adcWORD
      MARIADB_ROOT_PASSWORD: 8738da7d381c6f6d03f92164cd768a5bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 32a9c70112fa3c6f9b578791869a1adcWORD
      DB_PORT: "3306"
