...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6a066f4325de3b1b467e54238a59d320WORD
      MARIADB_ROOT_PASSWORD: ba54bb60cc2168c12480b74797238040WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6a066f4325de3b1b467e54238a59d320WORD
      DB_PORT: "3306"
