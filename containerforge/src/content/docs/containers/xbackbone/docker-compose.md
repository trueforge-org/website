...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a5a48c2f6c9079ca1d1ef87479b9b1e1WORD
      MARIADB_ROOT_PASSWORD: 9c49be3d933ba31dcecb15196e3904f6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a5a48c2f6c9079ca1d1ef87479b9b1e1WORD
      DB_PORT: "3306"
