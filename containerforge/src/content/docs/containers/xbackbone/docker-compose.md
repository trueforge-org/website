...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cdf0f0301eecc9da3629aba2e34d850aWORD
      MARIADB_ROOT_PASSWORD: 45716f729be9b819555545a9c5ef06a7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cdf0f0301eecc9da3629aba2e34d850aWORD
      DB_PORT: "3306"
