...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 56a380714eefe40880cc01a766aa2d98WORD
      MARIADB_ROOT_PASSWORD: 2c2244b36cae9a13b33e96042f0626e4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 56a380714eefe40880cc01a766aa2d98WORD
      DB_PORT: "3306"
