...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b3d1fd9cf7422848e5c75850eb0a9f50WORD
      MARIADB_ROOT_PASSWORD: 71baaab037ede23a67dbb156fa2449e2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b3d1fd9cf7422848e5c75850eb0a9f50WORD
      DB_PORT: "3306"
