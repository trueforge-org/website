...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2f036ca237f4889608cd34532729ad9eWORD
      MARIADB_ROOT_PASSWORD: 1d202a2422383c424df32be3f835cf03WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2f036ca237f4889608cd34532729ad9eWORD
      DB_PORT: "3306"
