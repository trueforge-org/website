...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a525b2ad59dcb487a5d11809c107b11bWORD
      MARIADB_ROOT_PASSWORD: 05fc99b3dad195d208d998703ea993dbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a525b2ad59dcb487a5d11809c107b11bWORD
      DB_PORT: "3306"
