...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5c791dac330212fefc19673440d47265WORD
      MARIADB_ROOT_PASSWORD: c62c934a71af14eb563ba55b5b41017bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5c791dac330212fefc19673440d47265WORD
      DB_PORT: "3306"
