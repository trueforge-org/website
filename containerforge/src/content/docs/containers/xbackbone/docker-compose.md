...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 94a699f8e7bd05204d74b461e8b5baa9WORD
      MARIADB_ROOT_PASSWORD: d5e3dd0486e3940407a88a818102cecdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 94a699f8e7bd05204d74b461e8b5baa9WORD
      DB_PORT: "3306"
