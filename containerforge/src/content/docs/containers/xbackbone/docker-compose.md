...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e6340f5756f1c844bdfb02e2b896e158WORD
      MARIADB_ROOT_PASSWORD: 615f04d4966fadcf2e0dba6818fd45a7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e6340f5756f1c844bdfb02e2b896e158WORD
      DB_PORT: "3306"
