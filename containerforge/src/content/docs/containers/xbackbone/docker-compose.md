...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c0df6583b518e2ad924bdfddc5d6d431WORD
      MARIADB_ROOT_PASSWORD: 2aca93cfed487514b0d4d7d06ad06aa3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c0df6583b518e2ad924bdfddc5d6d431WORD
      DB_PORT: "3306"
