...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e0b6505986ab8fe9bcfa1f5bb9329007WORD
      MARIADB_ROOT_PASSWORD: ed3b3f304f7efc7f654bae8429a71488WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e0b6505986ab8fe9bcfa1f5bb9329007WORD
      DB_PORT: "3306"
