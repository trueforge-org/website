...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a9d9b8db0ecc78f06aaffcb1716d6875WORD
      MARIADB_ROOT_PASSWORD: c2b055904d43f72837c5a4bd039b4005WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a9d9b8db0ecc78f06aaffcb1716d6875WORD
      DB_PORT: "3306"
