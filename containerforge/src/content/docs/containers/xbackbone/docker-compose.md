...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 06ee498e428654c46308916b3d17c200WORD
      MARIADB_ROOT_PASSWORD: 0419a7ebf7a2445461210ccde34327caWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 06ee498e428654c46308916b3d17c200WORD
      DB_PORT: "3306"
