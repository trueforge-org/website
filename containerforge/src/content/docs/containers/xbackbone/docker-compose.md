...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 42893b773318e33c082bdc0122833126WORD
      MARIADB_ROOT_PASSWORD: 0c77348ede4eab3667c981eeda1f260aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 42893b773318e33c082bdc0122833126WORD
      DB_PORT: "3306"
