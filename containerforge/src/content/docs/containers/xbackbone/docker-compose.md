...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4310ffa15b1df053d5c36eb436861bf3WORD
      MARIADB_ROOT_PASSWORD: 95a50fe801bcc45c2c079db1b54a0d60WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4310ffa15b1df053d5c36eb436861bf3WORD
      DB_PORT: "3306"
