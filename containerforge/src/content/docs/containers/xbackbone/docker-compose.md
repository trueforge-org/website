...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 88bd8114a2335dd653190607fefd4317WORD
      MARIADB_ROOT_PASSWORD: 5d6ab7c9413fe0fd9f6c9fa4954beef6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 88bd8114a2335dd653190607fefd4317WORD
      DB_PORT: "3306"
