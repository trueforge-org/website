...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 125bcaa7f9dd5d4244b3304cc8bdcbacWORD
      MARIADB_ROOT_PASSWORD: 17354fe531e3099b6d0299711f000767WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 125bcaa7f9dd5d4244b3304cc8bdcbacWORD
      DB_PORT: "3306"
