...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 96fd1a27b788dfeb926eaed3cc120e93WORD
      MARIADB_ROOT_PASSWORD: 5937c63abbb816e22a1f303d5299f95aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 96fd1a27b788dfeb926eaed3cc120e93WORD
      DB_PORT: "3306"
