...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bdffa93ffd66dead4d50a038939a45c1WORD
      MARIADB_ROOT_PASSWORD: 96cf6880804da9937a7cb1fcfe6f1a94WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bdffa93ffd66dead4d50a038939a45c1WORD
      DB_PORT: "3306"
