...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5c4d99f09b6e080c1a0aa5426ccb6af2WORD
      MARIADB_ROOT_PASSWORD: 39560a009b6d4895a24c863c14f4cc4cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5c4d99f09b6e080c1a0aa5426ccb6af2WORD
      DB_PORT: "3306"
