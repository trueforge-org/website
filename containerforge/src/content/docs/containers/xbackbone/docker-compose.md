...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b332c621e307af1c9b92b07e0bffd8c4WORD
      MARIADB_ROOT_PASSWORD: 874f4b7bde1d1260514c4b02ab8b5007WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b332c621e307af1c9b92b07e0bffd8c4WORD
      DB_PORT: "3306"
