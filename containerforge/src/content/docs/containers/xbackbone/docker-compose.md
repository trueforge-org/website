...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 17e2042a3a946065fd7c38c932492b81WORD
      MARIADB_ROOT_PASSWORD: 477d86dbea8683d50ac90b433abf9faeWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 17e2042a3a946065fd7c38c932492b81WORD
      DB_PORT: "3306"
