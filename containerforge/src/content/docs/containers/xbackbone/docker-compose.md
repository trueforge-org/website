...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ad68b0ac7be883194ca8a7fac8480983WORD
      MARIADB_ROOT_PASSWORD: 78933d10ce3a147079a6aeee6993744aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ad68b0ac7be883194ca8a7fac8480983WORD
      DB_PORT: "3306"
