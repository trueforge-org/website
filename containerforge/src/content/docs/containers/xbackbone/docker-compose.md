...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2498b8f00d4c1fd79715490466861a67WORD
      MARIADB_ROOT_PASSWORD: ea67b377bd60f852e994bc86718d1243WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2498b8f00d4c1fd79715490466861a67WORD
      DB_PORT: "3306"
