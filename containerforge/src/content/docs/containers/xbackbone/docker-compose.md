...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4fa449b8090c03dcddf59eba2adf03faWORD
      MARIADB_ROOT_PASSWORD: 3b2e22226996633087497b79ffbafb2bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4fa449b8090c03dcddf59eba2adf03faWORD
      DB_PORT: "3306"
