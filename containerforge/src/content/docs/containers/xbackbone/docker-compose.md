...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 073cbb2c68fd6fd30c3b25ec53306152WORD
      MARIADB_ROOT_PASSWORD: eac0bbcb546883f25d8b32b5045f4996WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 073cbb2c68fd6fd30c3b25ec53306152WORD
      DB_PORT: "3306"
