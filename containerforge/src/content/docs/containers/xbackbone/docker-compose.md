...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 29e1aade3e0737e650500f191fcce239WORD
      MARIADB_ROOT_PASSWORD: f2696f3e2d8fa48a309119de6306f13cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 29e1aade3e0737e650500f191fcce239WORD
      DB_PORT: "3306"
