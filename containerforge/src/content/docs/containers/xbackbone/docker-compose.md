...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5b144f9c83a659d327c2bd6485096d46WORD
      MARIADB_ROOT_PASSWORD: 1c338767f117ff5d7342746345d0ee2fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5b144f9c83a659d327c2bd6485096d46WORD
      DB_PORT: "3306"
