...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: daeee61b986531fa1fdc2f49d760903eWORD
      MARIADB_ROOT_PASSWORD: 15447fc7af4c52bfa82f497b9f3518cfWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: daeee61b986531fa1fdc2f49d760903eWORD
      DB_PORT: "3306"
