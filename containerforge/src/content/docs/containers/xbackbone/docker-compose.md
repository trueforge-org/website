...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3447e0f135434662db39b490fccaf31cWORD
      MARIADB_ROOT_PASSWORD: c089364a648457a146c7d69c94f203e9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3447e0f135434662db39b490fccaf31cWORD
      DB_PORT: "3306"
