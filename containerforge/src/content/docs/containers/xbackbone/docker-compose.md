...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a05614685137de2e209e715eb830625bWORD
      MARIADB_ROOT_PASSWORD: ce3d55714ab796097677a771b55ce91aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a05614685137de2e209e715eb830625bWORD
      DB_PORT: "3306"
