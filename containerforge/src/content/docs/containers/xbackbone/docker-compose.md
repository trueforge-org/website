...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b1d9e231f087e637c6690726c4a9584WORD
      MARIADB_ROOT_PASSWORD: dc1871e19fd4fcc893b95eae3d8097a4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b1d9e231f087e637c6690726c4a9584WORD
      DB_PORT: "3306"
