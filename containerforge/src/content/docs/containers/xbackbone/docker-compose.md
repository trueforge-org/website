...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3c6bbe6767a4dd5f1992b5d33364343dWORD
      MARIADB_ROOT_PASSWORD: 37fe8bdd5d666f3efb9554a1cba6f437WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3c6bbe6767a4dd5f1992b5d33364343dWORD
      DB_PORT: "3306"
