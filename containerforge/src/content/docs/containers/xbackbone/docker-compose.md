...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e848bea202f7e7994eab3901eda88883WORD
      MARIADB_ROOT_PASSWORD: 62f42797fe56bfe6c8a3cf7d66068d48WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e848bea202f7e7994eab3901eda88883WORD
      DB_PORT: "3306"
