...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 36afb92c1ac30a63649664d5ad057044WORD
      MARIADB_ROOT_PASSWORD: 51ffd1efeafafe13f7353cb96c5f75c9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 36afb92c1ac30a63649664d5ad057044WORD
      DB_PORT: "3306"
