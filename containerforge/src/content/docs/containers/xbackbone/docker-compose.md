...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2a72fdf105804140ba12cb382952abb9WORD
      MARIADB_ROOT_PASSWORD: 07d9449b61509aa223c4f89ff2536e17WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2a72fdf105804140ba12cb382952abb9WORD
      DB_PORT: "3306"
