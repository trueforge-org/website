...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ebdafaba55762391b7433ec2eddb5292WORD
      MARIADB_ROOT_PASSWORD: bd20d49a728b9ed96167e74b722a267eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ebdafaba55762391b7433ec2eddb5292WORD
      DB_PORT: "3306"
