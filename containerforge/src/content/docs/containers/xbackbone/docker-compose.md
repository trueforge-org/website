...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 36905a28d8679d557688aede02ffd954WORD
      MARIADB_ROOT_PASSWORD: 7aaa4fecb7a38a7948ab3263f7380b7aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 36905a28d8679d557688aede02ffd954WORD
      DB_PORT: "3306"
