...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2cc7539cb2f79e2d270bc783c0e8f800WORD
      MARIADB_ROOT_PASSWORD: 64e4f931a290f65e0aed307f7daa4644WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2cc7539cb2f79e2d270bc783c0e8f800WORD
      DB_PORT: "3306"
