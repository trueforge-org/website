...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 33522bea244a874e133fbcd2d76b7224WORD
      MARIADB_ROOT_PASSWORD: 1889cb4682b46e1c8340834a32594c24WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 33522bea244a874e133fbcd2d76b7224WORD
      DB_PORT: "3306"
