...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ea030978c66ed6a224eeb17ffb754006WORD
      MARIADB_ROOT_PASSWORD: 2fd91d1fba6039cb97cc43c6cd35df23WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ea030978c66ed6a224eeb17ffb754006WORD
      DB_PORT: "3306"
