...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 62cbec04f2705c65be139c9e136436a1WORD
      MARIADB_ROOT_PASSWORD: 76811434926cb28f8145249bca69213eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 62cbec04f2705c65be139c9e136436a1WORD
      DB_PORT: "3306"
