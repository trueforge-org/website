...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 18d897eb4e977c0547afa6fa0f554361WORD
      MARIADB_ROOT_PASSWORD: d8034d5136ac2cd0c6b5fdb979c6e656WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 18d897eb4e977c0547afa6fa0f554361WORD
      DB_PORT: "3306"
