...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f867f1dd560558ab623702b7b24356b8WORD
      MARIADB_ROOT_PASSWORD: 5c81c511995955703575a5a6e1de62c6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f867f1dd560558ab623702b7b24356b8WORD
      DB_PORT: "3306"
