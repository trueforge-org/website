...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7ed641a7c6ba3a2f6819fcb6063ec66dWORD
      MARIADB_ROOT_PASSWORD: a0e0b58f9d7edda83846766923ffa87bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7ed641a7c6ba3a2f6819fcb6063ec66dWORD
      DB_PORT: "3306"
