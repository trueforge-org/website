...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5761ffadc18f297f08b9adae7e987f76WORD
      MARIADB_ROOT_PASSWORD: 4199a542d477c19d4197f08e0f614971WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5761ffadc18f297f08b9adae7e987f76WORD
      DB_PORT: "3306"
