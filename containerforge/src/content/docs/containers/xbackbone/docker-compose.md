...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f0ec2e24a21b6e7c9b97676d973909e6WORD
      MARIADB_ROOT_PASSWORD: 3573297b4c3e31d804fe241d4b32a5efWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f0ec2e24a21b6e7c9b97676d973909e6WORD
      DB_PORT: "3306"
