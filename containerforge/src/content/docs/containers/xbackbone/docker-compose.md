...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0a6ab147e5e6d27ff264d7aaa591a0c4WORD
      MARIADB_ROOT_PASSWORD: 3e19499b908436623fcc03df16350030WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0a6ab147e5e6d27ff264d7aaa591a0c4WORD
      DB_PORT: "3306"
