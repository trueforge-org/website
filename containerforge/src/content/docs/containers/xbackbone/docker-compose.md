...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 56b4826688247eeb55b2263ab4717dfbWORD
      MARIADB_ROOT_PASSWORD: f89ccdc7e600e6d709e1501470eaf6b9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 56b4826688247eeb55b2263ab4717dfbWORD
      DB_PORT: "3306"
