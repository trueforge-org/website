...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4edbaf6da2b3c6f301cadbdacea1ead0WORD
      MARIADB_ROOT_PASSWORD: 0c31ad15c549da830dcd4e6f6d32510aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4edbaf6da2b3c6f301cadbdacea1ead0WORD
      DB_PORT: "3306"
