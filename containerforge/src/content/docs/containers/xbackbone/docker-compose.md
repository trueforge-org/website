...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ccbaf85f2ae79d257954f4d397e128cdWORD
      MARIADB_ROOT_PASSWORD: bc704ec5d85b8b6153fde11cd94632eaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ccbaf85f2ae79d257954f4d397e128cdWORD
      DB_PORT: "3306"
