...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 11e717b064149bdbb952745d0daf8680WORD
      MARIADB_ROOT_PASSWORD: 6d1a7ec053ad45253263bc4c1159ba9bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 11e717b064149bdbb952745d0daf8680WORD
      DB_PORT: "3306"
