...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b520a1a741d0404c91ff0dd152bd300WORD
      MARIADB_ROOT_PASSWORD: 95a335e940df32830497a440ee129094WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b520a1a741d0404c91ff0dd152bd300WORD
      DB_PORT: "3306"
