...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ed0186c6037c2ff5e4da2baf0a70b78fWORD
      MARIADB_ROOT_PASSWORD: 424aabbde05969d29d97cd94c0caf7dfWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ed0186c6037c2ff5e4da2baf0a70b78fWORD
      DB_PORT: "3306"
