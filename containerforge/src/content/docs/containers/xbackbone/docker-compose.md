...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4571ec6b3a7e8944de22a85060e62619WORD
      MARIADB_ROOT_PASSWORD: 46183d3bda3a6b73a456a7395b0a61f1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4571ec6b3a7e8944de22a85060e62619WORD
      DB_PORT: "3306"
