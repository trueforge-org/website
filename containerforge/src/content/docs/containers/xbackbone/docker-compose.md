...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d92b6d1983bb904aa2ee29ae6054126WORD
      MARIADB_ROOT_PASSWORD: 132575137ed8ba34948dae47d2bedd75WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d92b6d1983bb904aa2ee29ae6054126WORD
      DB_PORT: "3306"
