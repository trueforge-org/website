...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d842fa2aa60a0beb31059662be301e9cWORD
      MARIADB_ROOT_PASSWORD: ce32ff91b2f2ace01cc954bd01ea1234WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d842fa2aa60a0beb31059662be301e9cWORD
      DB_PORT: "3306"
