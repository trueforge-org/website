...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a0b4a5b4b5388e4c91de4af0c7a121e4WORD
      MARIADB_ROOT_PASSWORD: 9e655c554c461a004cddcaa5900fdda0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a0b4a5b4b5388e4c91de4af0c7a121e4WORD
      DB_PORT: "3306"
