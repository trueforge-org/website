...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08d9ffdbd7c8488175e258001a342617WORD
      MARIADB_ROOT_PASSWORD: e9e5937af22fc64f3d13c3e5a3230a94WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08d9ffdbd7c8488175e258001a342617WORD
      DB_PORT: "3306"
