...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4ed0536eac1449c3c4b865c2d856e80eWORD
      MARIADB_ROOT_PASSWORD: a7e4643cd73c66645fb3d467c111b37fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4ed0536eac1449c3c4b865c2d856e80eWORD
      DB_PORT: "3306"
