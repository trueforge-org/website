...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b8b4173359dc0b0d0ba31f7ded256e76WORD
      MARIADB_ROOT_PASSWORD: 2d3898eadea078b313064cf03a4325efWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b8b4173359dc0b0d0ba31f7ded256e76WORD
      DB_PORT: "3306"
