...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e8675f611c40fd7a455323f424df19eWORD
      MARIADB_ROOT_PASSWORD: a94957746281049ff4dd018ceeecd48fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e8675f611c40fd7a455323f424df19eWORD
      DB_PORT: "3306"
