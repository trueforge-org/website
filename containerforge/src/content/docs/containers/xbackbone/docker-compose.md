...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 37e860e1ca704e5c56d970021e614935WORD
      MARIADB_ROOT_PASSWORD: c2a27e7eba7712fc348ca1ba3396c84fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 37e860e1ca704e5c56d970021e614935WORD
      DB_PORT: "3306"
