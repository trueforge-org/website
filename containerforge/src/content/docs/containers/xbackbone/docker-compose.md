...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 91382eadbac6799b2dbb1d5269114cb9WORD
      MARIADB_ROOT_PASSWORD: a12d053069c5ff3fdb76e25da13a5e1dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 91382eadbac6799b2dbb1d5269114cb9WORD
      DB_PORT: "3306"
