...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d314c31b469c11b7cc0aafe7348e5321WORD
      MARIADB_ROOT_PASSWORD: 50f86cceda7d9551b19925cca9e26085WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d314c31b469c11b7cc0aafe7348e5321WORD
      DB_PORT: "3306"
