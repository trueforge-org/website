...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: db9d52d1821f8b494158bdd842c8e65bWORD
      MARIADB_ROOT_PASSWORD: 8d1a14dfcf11fb920ab309660980a40aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: db9d52d1821f8b494158bdd842c8e65bWORD
      DB_PORT: "3306"
