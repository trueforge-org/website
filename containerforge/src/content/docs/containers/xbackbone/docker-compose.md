...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a54907d1771a0c0e7a917f3561a6b501WORD
      MARIADB_ROOT_PASSWORD: afe5c25b5f27b25484cddd88105473e3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a54907d1771a0c0e7a917f3561a6b501WORD
      DB_PORT: "3306"
