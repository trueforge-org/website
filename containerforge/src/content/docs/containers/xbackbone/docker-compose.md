...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 341ded1d6e2895f951a46baf2c2a012cWORD
      MARIADB_ROOT_PASSWORD: c0d4763f9f14901392a308be14325395WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 341ded1d6e2895f951a46baf2c2a012cWORD
      DB_PORT: "3306"
