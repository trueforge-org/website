...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b2219ddc1b32cfd1938be0c58e438ed9WORD
      MARIADB_ROOT_PASSWORD: f00aff13451f8a715dd6450d9b68f612WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b2219ddc1b32cfd1938be0c58e438ed9WORD
      DB_PORT: "3306"
