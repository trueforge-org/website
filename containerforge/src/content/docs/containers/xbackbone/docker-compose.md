...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b1c50a6c7a31731a498564db4ea8e99cWORD
      MARIADB_ROOT_PASSWORD: 7989f244d930c982531dec98b21c5053WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b1c50a6c7a31731a498564db4ea8e99cWORD
      DB_PORT: "3306"
