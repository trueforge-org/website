...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0e8b24a71bfd229449cebe8025dc4628WORD
      MARIADB_ROOT_PASSWORD: 707ecb68d018797f2f5cff47f9eca81eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0e8b24a71bfd229449cebe8025dc4628WORD
      DB_PORT: "3306"
