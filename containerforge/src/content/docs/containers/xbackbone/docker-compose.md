...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5d738e9f9a60c33bb1312734d636b428WORD
      MARIADB_ROOT_PASSWORD: 93206f13ce8699e8debc70aace2da974WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5d738e9f9a60c33bb1312734d636b428WORD
      DB_PORT: "3306"
