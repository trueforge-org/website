...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 503ccc4be6542fc9ddb1e07a86d97e34WORD
      MARIADB_ROOT_PASSWORD: 68671e8101f248b4a058ee36b6411488WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 503ccc4be6542fc9ddb1e07a86d97e34WORD
      DB_PORT: "3306"
