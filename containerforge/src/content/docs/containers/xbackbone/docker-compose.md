...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f355ebb2fde91a2c1caaf742f1550753WORD
      MARIADB_ROOT_PASSWORD: 3087003459eeca40e73d63a9707a7e3bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f355ebb2fde91a2c1caaf742f1550753WORD
      DB_PORT: "3306"
