...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bebc77816f3b1428aca8bfbd76fa982bWORD
      MARIADB_ROOT_PASSWORD: 92805717ef07caeab6d4c47b58ef1355WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bebc77816f3b1428aca8bfbd76fa982bWORD
      DB_PORT: "3306"
