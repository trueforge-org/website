...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a5481ec73a2bf4db791a8554701b47beWORD
      MARIADB_ROOT_PASSWORD: 14095148cff81999d388710b2cc42bdcWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a5481ec73a2bf4db791a8554701b47beWORD
      DB_PORT: "3306"
