...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 481f48544fb63a34ba7a3321f51239edWORD
      MARIADB_ROOT_PASSWORD: a55bd38a0c5c5afbecfd46724c04e055WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 481f48544fb63a34ba7a3321f51239edWORD
      DB_PORT: "3306"
