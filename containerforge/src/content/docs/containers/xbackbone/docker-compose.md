...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cc8740950c5b72e020d4417b8362db94WORD
      MARIADB_ROOT_PASSWORD: 7ebf4429074130a3896e880e19eaae5cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cc8740950c5b72e020d4417b8362db94WORD
      DB_PORT: "3306"
