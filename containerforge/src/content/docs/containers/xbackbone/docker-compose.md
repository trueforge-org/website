...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7f5a88880573f4a947e6691d1857fe31WORD
      MARIADB_ROOT_PASSWORD: 8ae0831e7132d1b3f1634bb16b3512e7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7f5a88880573f4a947e6691d1857fe31WORD
      DB_PORT: "3306"
