...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3a04a042be0a8f0323549e1b9ca33aaeWORD
      MARIADB_ROOT_PASSWORD: e6e7fcfd59084e9869ace9af99c4b957WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3a04a042be0a8f0323549e1b9ca33aaeWORD
      DB_PORT: "3306"
