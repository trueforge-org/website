...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0bb07fa843dfd59837e73993fbbde7b3WORD
      MARIADB_ROOT_PASSWORD: f22b6cf3a4546d7fe669d606f3335b0aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0bb07fa843dfd59837e73993fbbde7b3WORD
      DB_PORT: "3306"
