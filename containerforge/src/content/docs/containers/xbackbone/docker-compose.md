...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4182ad19b24dea59adc6d4f111776acdWORD
      MARIADB_ROOT_PASSWORD: 6d91d22cead9e2f98c37110956a2c597WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4182ad19b24dea59adc6d4f111776acdWORD
      DB_PORT: "3306"
