...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 984cc518d9cd40a71cd94c9d43926d94WORD
      MARIADB_ROOT_PASSWORD: 75c2cc90000bb5f496ab301aab48d7b3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 984cc518d9cd40a71cd94c9d43926d94WORD
      DB_PORT: "3306"
