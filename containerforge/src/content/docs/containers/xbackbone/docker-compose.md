...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 236b2b20cb50645bb1d89d060b203b5cWORD
      MARIADB_ROOT_PASSWORD: e10cee9e84dbe9ac5a55fbe72d6d8307WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 236b2b20cb50645bb1d89d060b203b5cWORD
      DB_PORT: "3306"
