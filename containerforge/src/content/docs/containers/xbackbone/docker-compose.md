...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6f8b136c9cca27e913afc78671660162WORD
      MARIADB_ROOT_PASSWORD: cc17482fd4448f1c6a3052a1c369995aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6f8b136c9cca27e913afc78671660162WORD
      DB_PORT: "3306"
