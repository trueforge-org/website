...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9da2a7f47ec7e059d2d5c3e81abf2b8eWORD
      MARIADB_ROOT_PASSWORD: 9bb9be8700f226ebebcf93277de25ce6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9da2a7f47ec7e059d2d5c3e81abf2b8eWORD
      DB_PORT: "3306"
