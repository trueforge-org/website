...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 54f79f7fa1425aea9b0256bcdfa68121WORD
      MARIADB_ROOT_PASSWORD: 9ed7fcdd892d6c5d2c576e474afed7dcWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 54f79f7fa1425aea9b0256bcdfa68121WORD
      DB_PORT: "3306"
