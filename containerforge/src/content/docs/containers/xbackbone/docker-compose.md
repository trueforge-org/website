...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f6ef2c15c53dd4fcb881e3df19fc55b0WORD
      MARIADB_ROOT_PASSWORD: f25b5b3d42450bb6205a2a5f4d420619WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f6ef2c15c53dd4fcb881e3df19fc55b0WORD
      DB_PORT: "3306"
