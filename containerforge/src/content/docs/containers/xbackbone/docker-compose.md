...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5dcd172e9c9d9619150c1aebaac381e4WORD
      MARIADB_ROOT_PASSWORD: 19d9cf81d0231bf08521664f49e4fb4eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5dcd172e9c9d9619150c1aebaac381e4WORD
      DB_PORT: "3306"
