...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0567926e466cd273b2a49d054692fa4cWORD
      MARIADB_ROOT_PASSWORD: 88fec4ff9525f74b5fd3462ddefb2cc5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0567926e466cd273b2a49d054692fa4cWORD
      DB_PORT: "3306"
