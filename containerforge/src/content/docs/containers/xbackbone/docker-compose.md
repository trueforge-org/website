...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9e1ef34afdb4a45ea6db5c69854aebc2WORD
      MARIADB_ROOT_PASSWORD: 5d6787be4a987d424cb6fa048a3d1c63WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9e1ef34afdb4a45ea6db5c69854aebc2WORD
      DB_PORT: "3306"
