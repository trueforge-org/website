...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 34771025cf3e2e2387ed99d2872584dbWORD
      MARIADB_ROOT_PASSWORD: 9503043f08de54a24ce20c78511e1632WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 34771025cf3e2e2387ed99d2872584dbWORD
      DB_PORT: "3306"
