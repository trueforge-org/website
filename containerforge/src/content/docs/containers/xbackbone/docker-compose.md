...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8f7cbaf415b804c882a330f171824715WORD
      MARIADB_ROOT_PASSWORD: 6a9ffe550ace470458c9344e142be701WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8f7cbaf415b804c882a330f171824715WORD
      DB_PORT: "3306"
