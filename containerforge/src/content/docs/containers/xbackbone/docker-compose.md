...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 447b39fe19910db256094d6a7a3d59eeWORD
      MARIADB_ROOT_PASSWORD: 39d806fb029be2ec784354de52a870bbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 447b39fe19910db256094d6a7a3d59eeWORD
      DB_PORT: "3306"
