...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4cca0531629f9ee12cdc41dd70c7b86fWORD
      MARIADB_ROOT_PASSWORD: 01b2ab8273ac18cf8a60f2ae7f6b7b50WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4cca0531629f9ee12cdc41dd70c7b86fWORD
      DB_PORT: "3306"
