...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fcbad4bf3d30c0dfba0a72323b2a71c9WORD
      MARIADB_ROOT_PASSWORD: 995bc29e817d08aef871e87d027c45c7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fcbad4bf3d30c0dfba0a72323b2a71c9WORD
      DB_PORT: "3306"
