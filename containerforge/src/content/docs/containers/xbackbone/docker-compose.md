...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: de1b176215bc49139d2767e2d817ddeaWORD
      MARIADB_ROOT_PASSWORD: 92929c98072ee89bfbf7190429baa469WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: de1b176215bc49139d2767e2d817ddeaWORD
      DB_PORT: "3306"
