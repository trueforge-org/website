...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e6aa831c764f1a1af5e4083396e14961WORD
      MARIADB_ROOT_PASSWORD: 25843e03e22ed77fe703ecbb902ae99bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e6aa831c764f1a1af5e4083396e14961WORD
      DB_PORT: "3306"
