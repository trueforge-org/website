...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2ad9b6967211dabdd9de0117481c66eeWORD
      MARIADB_ROOT_PASSWORD: 6537a2f1e5c40a616bead75bbd41c9e7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2ad9b6967211dabdd9de0117481c66eeWORD
      DB_PORT: "3306"
