...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1c291c1d454dbc9441a5ce4b019fec44WORD
      MARIADB_ROOT_PASSWORD: f5d1a6fa351edb3a78f8e0d078d52fcbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1c291c1d454dbc9441a5ce4b019fec44WORD
      DB_PORT: "3306"
