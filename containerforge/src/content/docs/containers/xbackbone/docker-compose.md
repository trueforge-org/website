...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4e67e5014107b8afd9ecfc48f146a8dfWORD
      MARIADB_ROOT_PASSWORD: dca45eaf3681b6eb115b4a7e9aac871bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4e67e5014107b8afd9ecfc48f146a8dfWORD
      DB_PORT: "3306"
