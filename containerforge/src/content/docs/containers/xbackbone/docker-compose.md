...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 097ba3c6ad317c9cb9d4ec90da34c697WORD
      MARIADB_ROOT_PASSWORD: 1b8753c1f74b80d0575e3a53f3c7110bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 097ba3c6ad317c9cb9d4ec90da34c697WORD
      DB_PORT: "3306"
