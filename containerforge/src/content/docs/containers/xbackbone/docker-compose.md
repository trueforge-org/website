...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e2f468c43649786555a705f79fa19d61WORD
      MARIADB_ROOT_PASSWORD: 96258c76950e5d0c5fcf532d6fccc4e3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e2f468c43649786555a705f79fa19d61WORD
      DB_PORT: "3306"
