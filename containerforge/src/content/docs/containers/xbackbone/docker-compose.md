...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: af41c8558d362d7a465a24f58848bc24WORD
      MARIADB_ROOT_PASSWORD: 515942594a4b75cdb0c7265b383b92cdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: af41c8558d362d7a465a24f58848bc24WORD
      DB_PORT: "3306"
