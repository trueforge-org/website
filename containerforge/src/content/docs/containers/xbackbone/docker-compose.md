...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c2b0fb6d6d263123f773bb61c0be118cWORD
      MARIADB_ROOT_PASSWORD: 6dd97b7f97b5d4b8b1ed464110ea1283WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c2b0fb6d6d263123f773bb61c0be118cWORD
      DB_PORT: "3306"
