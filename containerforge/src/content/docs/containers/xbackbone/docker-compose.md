...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0b6250c085ba95479d2b3466bf4e52c3WORD
      MARIADB_ROOT_PASSWORD: 409246c7c59708a4246be0b36129d690WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0b6250c085ba95479d2b3466bf4e52c3WORD
      DB_PORT: "3306"
