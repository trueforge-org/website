...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 79bc1a26f046ef9aca0f264d50173c8eWORD
      MARIADB_ROOT_PASSWORD: a0f650bbb2d56838b48f707071d5f0bdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 79bc1a26f046ef9aca0f264d50173c8eWORD
      DB_PORT: "3306"
