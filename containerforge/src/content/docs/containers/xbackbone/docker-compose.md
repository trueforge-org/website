...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 21eba77e5caf6243ba266be8e19070c8WORD
      MARIADB_ROOT_PASSWORD: abfadd61b788114d38a42425c49f6b91WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 21eba77e5caf6243ba266be8e19070c8WORD
      DB_PORT: "3306"
