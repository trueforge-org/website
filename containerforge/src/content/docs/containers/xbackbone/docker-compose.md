...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f229c1f58da94dbb1a3dfdd4df76738aWORD
      MARIADB_ROOT_PASSWORD: 41ca2e652aa8f1d44fe41c726ec3fd64WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f229c1f58da94dbb1a3dfdd4df76738aWORD
      DB_PORT: "3306"
