...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f3d6937abc1a63e0596f51aa9dc8f18aWORD
      MARIADB_ROOT_PASSWORD: 464a727dd82c4b8c865ec8ff701359a6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f3d6937abc1a63e0596f51aa9dc8f18aWORD
      DB_PORT: "3306"
