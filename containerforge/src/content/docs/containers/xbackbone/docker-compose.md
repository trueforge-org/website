...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 25e2a29abe7f5827d6fc5473bf345861WORD
      MARIADB_ROOT_PASSWORD: b3e9cbec52eff90ed8aad7f476465f21WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 25e2a29abe7f5827d6fc5473bf345861WORD
      DB_PORT: "3306"
