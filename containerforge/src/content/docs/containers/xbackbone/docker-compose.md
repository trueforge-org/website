...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7af498bad33a62a74d6a02e8699f228cWORD
      MARIADB_ROOT_PASSWORD: a0ca3123334f84e6b05e31244022b39aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7af498bad33a62a74d6a02e8699f228cWORD
      DB_PORT: "3306"
