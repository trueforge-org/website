...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3f2b74a7a4eb0f6c76e0314fb492a693WORD
      MARIADB_ROOT_PASSWORD: 4e7b2b9bb32c600e9d0ba6609af780eaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3f2b74a7a4eb0f6c76e0314fb492a693WORD
      DB_PORT: "3306"
