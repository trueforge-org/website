...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b25511e01dd69fcb9d1868a4107a63f7WORD
      MARIADB_ROOT_PASSWORD: 3314875702ae09f719cac438227cc406WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b25511e01dd69fcb9d1868a4107a63f7WORD
      DB_PORT: "3306"
