...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4c662d8c3b805bbec7ffacacec547ac5WORD
      MARIADB_ROOT_PASSWORD: eac6418e6e3b80d30576fca8c03e347aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4c662d8c3b805bbec7ffacacec547ac5WORD
      DB_PORT: "3306"
