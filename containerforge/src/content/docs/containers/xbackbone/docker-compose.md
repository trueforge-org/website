...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3394b030002e81f02abe3a830f2d9ac9WORD
      MARIADB_ROOT_PASSWORD: 783af5f30662cde3b2b912a93daadb89WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3394b030002e81f02abe3a830f2d9ac9WORD
      DB_PORT: "3306"
