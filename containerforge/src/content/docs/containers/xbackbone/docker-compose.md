...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 64ac793488651cbdf2f6e8334192d597WORD
      MARIADB_ROOT_PASSWORD: 866cfcfd692aeae576c9272bf77fa13bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 64ac793488651cbdf2f6e8334192d597WORD
      DB_PORT: "3306"
