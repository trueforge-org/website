...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f82d8b58a18ad76156a3af04a47148ddWORD
      MARIADB_ROOT_PASSWORD: b4265d10493322d1730f4c4dc404f93eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f82d8b58a18ad76156a3af04a47148ddWORD
      DB_PORT: "3306"
