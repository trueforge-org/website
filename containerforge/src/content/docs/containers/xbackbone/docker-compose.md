...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b736a05255f48ce11308929997ca7b8cWORD
      MARIADB_ROOT_PASSWORD: f4feeedd449d93ffee98eea51b546bfaWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b736a05255f48ce11308929997ca7b8cWORD
      DB_PORT: "3306"
