...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 16ff650e97c6446e7eadea7e5852ded8WORD
      MARIADB_ROOT_PASSWORD: c0a648e264ace14d1612b393b2597611WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 16ff650e97c6446e7eadea7e5852ded8WORD
      DB_PORT: "3306"
