...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 524fa92b5347e8be5dc7bd17d6be0fcdWORD
      MARIADB_ROOT_PASSWORD: d70f6c60bfb871b2803e4ffab0a3ce55WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 524fa92b5347e8be5dc7bd17d6be0fcdWORD
      DB_PORT: "3306"
