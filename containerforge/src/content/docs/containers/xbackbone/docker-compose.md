...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f8e04d9013d2ec84908ad9ba34443022WORD
      MARIADB_ROOT_PASSWORD: 1f156bfb3891161ed4c29c61dce4b509WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f8e04d9013d2ec84908ad9ba34443022WORD
      DB_PORT: "3306"
