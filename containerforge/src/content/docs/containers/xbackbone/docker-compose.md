...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 58ede9f3da880b99b8745db5bd596338WORD
      MARIADB_ROOT_PASSWORD: f8063f9d3fa45c4350b14c59c1650594WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 58ede9f3da880b99b8745db5bd596338WORD
      DB_PORT: "3306"
