...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dde11e206daf1e103050336c78b851c0WORD
      MARIADB_ROOT_PASSWORD: 252fd248d6aa16d444461683d1cb45e7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dde11e206daf1e103050336c78b851c0WORD
      DB_PORT: "3306"
