...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8c68713109b3a4653a1b1b6a3ff5b243WORD
      MARIADB_ROOT_PASSWORD: 40e47cb0a5107c1396cf4f101663de42WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8c68713109b3a4653a1b1b6a3ff5b243WORD
      DB_PORT: "3306"
