...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 608e2dca439da3857132cbbee25e4ef2WORD
      MARIADB_ROOT_PASSWORD: 1ece7e244625dd0982e93e9ae8b5e0b7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 608e2dca439da3857132cbbee25e4ef2WORD
      DB_PORT: "3306"
