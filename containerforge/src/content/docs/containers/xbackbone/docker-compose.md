...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eec17afee81525d764df95dc0de9ce2eWORD
      MARIADB_ROOT_PASSWORD: fc69991c33f782b51d7efc36787fee9dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eec17afee81525d764df95dc0de9ce2eWORD
      DB_PORT: "3306"
