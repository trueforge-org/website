...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4226843fed0104e65346892ef319da80WORD
      MARIADB_ROOT_PASSWORD: 8033a94038494f00f830d95ef6adc6acWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4226843fed0104e65346892ef319da80WORD
      DB_PORT: "3306"
