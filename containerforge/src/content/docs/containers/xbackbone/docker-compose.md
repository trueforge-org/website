...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e787a80a4f90f6f77c93e79a3ed9a22cWORD
      MARIADB_ROOT_PASSWORD: 2c08f683ad8f85f2e6d6cf390659dcafWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e787a80a4f90f6f77c93e79a3ed9a22cWORD
      DB_PORT: "3306"
