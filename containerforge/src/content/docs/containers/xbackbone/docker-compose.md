...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 28fa29d93a3bec3d5fb68a4a61383fbcWORD
      MARIADB_ROOT_PASSWORD: 27ec81f2fd39f6c4b5b3a9b29ebaa5dbWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 28fa29d93a3bec3d5fb68a4a61383fbcWORD
      DB_PORT: "3306"
