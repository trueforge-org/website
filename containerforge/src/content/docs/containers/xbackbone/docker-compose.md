...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 973763b770641cae3a46a6cf1437cebfWORD
      MARIADB_ROOT_PASSWORD: 80453fa98b42669bee2f3a6a015deb67WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 973763b770641cae3a46a6cf1437cebfWORD
      DB_PORT: "3306"
