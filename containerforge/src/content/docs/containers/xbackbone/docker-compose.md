...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ec64d45ddacda0eb07a26c485ade6f17WORD
      MARIADB_ROOT_PASSWORD: 661da8cd8eb85de18c3ff095429cebceWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ec64d45ddacda0eb07a26c485ade6f17WORD
      DB_PORT: "3306"
