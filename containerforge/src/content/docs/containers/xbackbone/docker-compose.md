...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c56ef0b915ce6dc907c3e0a345981adbWORD
      MARIADB_ROOT_PASSWORD: cc9ff0594e584f7d8734983483c7fdddWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c56ef0b915ce6dc907c3e0a345981adbWORD
      DB_PORT: "3306"
