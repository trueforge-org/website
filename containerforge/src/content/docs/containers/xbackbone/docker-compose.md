...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 00fa1093e977edb4d73c5abf324d8a05WORD
      MARIADB_ROOT_PASSWORD: 5ed4eb4675770850483bcc04816e63a9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 00fa1093e977edb4d73c5abf324d8a05WORD
      DB_PORT: "3306"
