...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5bfedf9dd5090bdf2f501756ac861464WORD
      MARIADB_ROOT_PASSWORD: f6e9920c3ef250aa4148b6e23d1e241bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5bfedf9dd5090bdf2f501756ac861464WORD
      DB_PORT: "3306"
