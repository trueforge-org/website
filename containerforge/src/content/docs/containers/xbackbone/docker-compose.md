...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b70450cbb2f94b79371445b2ddb691b0WORD
      MARIADB_ROOT_PASSWORD: 1cacf64d9a206e5caf222fa690968542WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b70450cbb2f94b79371445b2ddb691b0WORD
      DB_PORT: "3306"
