...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f84e8846227b0b10599a06b4201b4251WORD
      MARIADB_ROOT_PASSWORD: e68e7893d6d1a694b90294b66cbacbc7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f84e8846227b0b10599a06b4201b4251WORD
      DB_PORT: "3306"
