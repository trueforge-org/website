...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a8cff3bb625bc33c82bd3dabb92d297aWORD
      MARIADB_ROOT_PASSWORD: 6ec8b5d5062abffa3c282cb9e33e6cceWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a8cff3bb625bc33c82bd3dabb92d297aWORD
      DB_PORT: "3306"
