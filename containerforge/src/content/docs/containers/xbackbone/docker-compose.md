...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 396cf21f395005e46cb008d7d2b1dbfcWORD
      MARIADB_ROOT_PASSWORD: af27ae22dd877fe8b505b0364ee23bf6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 396cf21f395005e46cb008d7d2b1dbfcWORD
      DB_PORT: "3306"
