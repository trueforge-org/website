...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a4c64938a7777a2b6d05c1acc6569a7fWORD
      MARIADB_ROOT_PASSWORD: 764c67d9e6d54b8ab6618f1c86a00e21WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a4c64938a7777a2b6d05c1acc6569a7fWORD
      DB_PORT: "3306"
