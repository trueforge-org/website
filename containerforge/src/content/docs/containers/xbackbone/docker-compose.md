...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 39a91d43cdf3a1cb671036e89a13eef7WORD
      MARIADB_ROOT_PASSWORD: f70b5cb467f251253841515f1978308bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 39a91d43cdf3a1cb671036e89a13eef7WORD
      DB_PORT: "3306"
