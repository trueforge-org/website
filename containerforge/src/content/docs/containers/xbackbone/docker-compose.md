...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a6a688aa58be7a30ec1902b175086a8bWORD
      MARIADB_ROOT_PASSWORD: b3cb620eefaf32dd8587e39c53db0de7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a6a688aa58be7a30ec1902b175086a8bWORD
      DB_PORT: "3306"
