...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 54f37ea6d6e11f4202e44702704822a6WORD
      MARIADB_ROOT_PASSWORD: 70e7257911c062c66933aa4a7a8fa3a3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 54f37ea6d6e11f4202e44702704822a6WORD
      DB_PORT: "3306"
