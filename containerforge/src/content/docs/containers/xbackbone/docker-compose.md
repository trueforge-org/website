...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 11a6e6f7947472a7a2f908070612e220WORD
      MARIADB_ROOT_PASSWORD: 0a3d78e6c20b9ab4452ed99442175979WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 11a6e6f7947472a7a2f908070612e220WORD
      DB_PORT: "3306"
