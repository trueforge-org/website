...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 53fe679b060803f9e44a2c23dbd97059WORD
      MARIADB_ROOT_PASSWORD: cfa135eabae4042f8e56f9ad51442a95WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 53fe679b060803f9e44a2c23dbd97059WORD
      DB_PORT: "3306"
