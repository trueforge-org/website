...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 62088a08bdad4bee332251f41a32dfb1WORD
      MARIADB_ROOT_PASSWORD: 44aeb0272662dacc02979bda422c661dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 62088a08bdad4bee332251f41a32dfb1WORD
      DB_PORT: "3306"
