...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cff00e513c6312c654d03b29b2ad8e6cWORD
      MARIADB_ROOT_PASSWORD: 0a1ee11c06be7961cb5ec4fb277d071bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cff00e513c6312c654d03b29b2ad8e6cWORD
      DB_PORT: "3306"
