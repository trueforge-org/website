...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1f75f677b760335ac689471a777598a4WORD
      MARIADB_ROOT_PASSWORD: 4a0cb6844c25bbf6a6f6aa1f3aaf3924WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1f75f677b760335ac689471a777598a4WORD
      DB_PORT: "3306"
