...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 777fe1b6d4f86d687ed809b5185416a1WORD
      MARIADB_ROOT_PASSWORD: f3f465d09300d19a53fe81fa16ccc810WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 777fe1b6d4f86d687ed809b5185416a1WORD
      DB_PORT: "3306"
