...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d4cff9cf9a43a92f459acb4c655f8502WORD
      MARIADB_ROOT_PASSWORD: ea857b7ac2f4664847bd25b5ec94bb97WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d4cff9cf9a43a92f459acb4c655f8502WORD
      DB_PORT: "3306"
