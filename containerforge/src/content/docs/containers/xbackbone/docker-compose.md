...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1bfecdcf0c1e16585fe173e7c6b42142WORD
      MARIADB_ROOT_PASSWORD: 94270ae7b7ab7faabb30cd2dd1859c4dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1bfecdcf0c1e16585fe173e7c6b42142WORD
      DB_PORT: "3306"
