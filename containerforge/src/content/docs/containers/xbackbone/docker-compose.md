...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b8e27505bc2062275b670f45f3612c08WORD
      MARIADB_ROOT_PASSWORD: 309dafdc5d65de0314e6a3604aec576fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b8e27505bc2062275b670f45f3612c08WORD
      DB_PORT: "3306"
