...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 982f7381d04f1faa392d038eed455036WORD
      MARIADB_ROOT_PASSWORD: 899113cc02005cae422e439d02a3e8d9WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 982f7381d04f1faa392d038eed455036WORD
      DB_PORT: "3306"
