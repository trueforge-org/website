...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 96b84f347ee84baf2eb3d29d5a8d79f3WORD
      MARIADB_ROOT_PASSWORD: 371b35c7e72c304f094beb6b31b256a6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 96b84f347ee84baf2eb3d29d5a8d79f3WORD
      DB_PORT: "3306"
