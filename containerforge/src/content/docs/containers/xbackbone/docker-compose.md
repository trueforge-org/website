...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fe91b2eea2e265f4fd059d31f9574887WORD
      MARIADB_ROOT_PASSWORD: 750b9d87a41cee750eefa46e7ed8dacdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fe91b2eea2e265f4fd059d31f9574887WORD
      DB_PORT: "3306"
