...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9635a1e9a67e2cf8c676ae64505d179dWORD
      MARIADB_ROOT_PASSWORD: 53ceb03347dc3307acfd97c6526722d1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9635a1e9a67e2cf8c676ae64505d179dWORD
      DB_PORT: "3306"
