...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08dce6d2b84f73f786d71a970133457dWORD
      MARIADB_ROOT_PASSWORD: aa10cc07becd20bbceb2a8db052e07b6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08dce6d2b84f73f786d71a970133457dWORD
      DB_PORT: "3306"
