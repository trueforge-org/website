...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9c33c23d6d37372ed4e55d91cea0bf88WORD
      MARIADB_ROOT_PASSWORD: ca71254d56923fe56b0f681f0862e90aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9c33c23d6d37372ed4e55d91cea0bf88WORD
      DB_PORT: "3306"
