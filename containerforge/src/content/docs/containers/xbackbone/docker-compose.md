...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ff31cb747ef83dad334d13a0fd0212c3WORD
      MARIADB_ROOT_PASSWORD: 968898331b6dbcffbf3e48c2d7dd46b5WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ff31cb747ef83dad334d13a0fd0212c3WORD
      DB_PORT: "3306"
