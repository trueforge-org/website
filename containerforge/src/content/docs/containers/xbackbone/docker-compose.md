...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 469fa496e7aabc06b577b033b8812d99WORD
      MARIADB_ROOT_PASSWORD: 0a90ee0b1e31d01d6f2ab9414aebeaabWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 469fa496e7aabc06b577b033b8812d99WORD
      DB_PORT: "3306"
