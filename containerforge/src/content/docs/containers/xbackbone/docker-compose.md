...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c37f37c2db3e8971cd64fef5d9a86f93WORD
      MARIADB_ROOT_PASSWORD: a763ba28def788b9e5df87503a3363fdWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c37f37c2db3e8971cd64fef5d9a86f93WORD
      DB_PORT: "3306"
