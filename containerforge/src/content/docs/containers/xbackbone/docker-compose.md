...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2f0ca50d088e9608b89f32cbcb64cc65WORD
      MARIADB_ROOT_PASSWORD: 5e030ac70690ff042368caabc72139edWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2f0ca50d088e9608b89f32cbcb64cc65WORD
      DB_PORT: "3306"
