...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 684989666a8d6826404a99d68ce83678WORD
      MARIADB_ROOT_PASSWORD: a77b328987c29088718a38b9a22427c4WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 684989666a8d6826404a99d68ce83678WORD
      DB_PORT: "3306"
