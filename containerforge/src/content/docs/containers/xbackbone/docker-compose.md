...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08315e5c226c7388561d769cbd572976WORD
      MARIADB_ROOT_PASSWORD: 372e39dd84c2cedcd529286eed243c56WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08315e5c226c7388561d769cbd572976WORD
      DB_PORT: "3306"
