...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: df848987f7c179a37c96440b8fcadc8fWORD
      MARIADB_ROOT_PASSWORD: 81b7212cac95c57378f15ea6b038fc63WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: df848987f7c179a37c96440b8fcadc8fWORD
      DB_PORT: "3306"
