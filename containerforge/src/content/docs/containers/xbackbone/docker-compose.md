...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 287c0dbd890b6d273480dcf7a73d4af5WORD
      MARIADB_ROOT_PASSWORD: dcf15b4f58da977572949bd24a36551aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 287c0dbd890b6d273480dcf7a73d4af5WORD
      DB_PORT: "3306"
