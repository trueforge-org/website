...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b8a8b1d90a88a8d1bb7446126931dfd4WORD
      MARIADB_ROOT_PASSWORD: 562dc7697f2eb0aa29b8491d668fd0c8WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b8a8b1d90a88a8d1bb7446126931dfd4WORD
      DB_PORT: "3306"
