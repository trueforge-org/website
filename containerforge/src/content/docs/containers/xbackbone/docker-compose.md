...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eedb1d321066f902aeed537fa135f750WORD
      MARIADB_ROOT_PASSWORD: d6b0dbb9441dc1448afb3cdfc0be1ae7WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eedb1d321066f902aeed537fa135f750WORD
      DB_PORT: "3306"
