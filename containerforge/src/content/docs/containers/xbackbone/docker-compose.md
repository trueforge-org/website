...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1a560c363d70c0228de2b0eee31ff39eWORD
      MARIADB_ROOT_PASSWORD: 2c2e85e358682c63210285a7b998944eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1a560c363d70c0228de2b0eee31ff39eWORD
      DB_PORT: "3306"
