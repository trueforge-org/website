...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9113e7da51fba0f27956419bb9042983WORD
      MARIADB_ROOT_PASSWORD: 9b158570cad5aa7ced5379902016eb3fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9113e7da51fba0f27956419bb9042983WORD
      DB_PORT: "3306"
