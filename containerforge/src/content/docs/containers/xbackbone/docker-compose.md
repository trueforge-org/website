...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c16cbbf86ec2e49eb92a391b3df87044WORD
      MARIADB_ROOT_PASSWORD: 9addec238f65d107654e91f5959f3f90WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c16cbbf86ec2e49eb92a391b3df87044WORD
      DB_PORT: "3306"
