...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 24de243b8d4358dfae7265c4195e2ed3WORD
      MARIADB_ROOT_PASSWORD: 793cff21c578a6461744866076510f76WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 24de243b8d4358dfae7265c4195e2ed3WORD
      DB_PORT: "3306"
