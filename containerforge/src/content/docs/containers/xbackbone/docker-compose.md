...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9442d5ed9b75a9b1cb964c0527218364WORD
      MARIADB_ROOT_PASSWORD: b33170495f643bd0adfb87187b2695deWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9442d5ed9b75a9b1cb964c0527218364WORD
      DB_PORT: "3306"
