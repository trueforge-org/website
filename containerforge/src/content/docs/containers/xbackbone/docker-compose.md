...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 599832cb6aae57ef0c7a0f91a4ce67d3WORD
      MARIADB_ROOT_PASSWORD: 59d139d65d5fd7798a5918c0627a5e21WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 599832cb6aae57ef0c7a0f91a4ce67d3WORD
      DB_PORT: "3306"
