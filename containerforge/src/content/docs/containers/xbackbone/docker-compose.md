...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1b906b217b87af03265a2f02fb3fedf8WORD
      MARIADB_ROOT_PASSWORD: 310716ded71ac376a98160297654c90fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1b906b217b87af03265a2f02fb3fedf8WORD
      DB_PORT: "3306"
