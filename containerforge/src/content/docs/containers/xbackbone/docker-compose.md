...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0e3750b4061caf0bc039b0a6326ffef1WORD
      MARIADB_ROOT_PASSWORD: a1097249cf4f1517ea4f6da5dfb4a515WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0e3750b4061caf0bc039b0a6326ffef1WORD
      DB_PORT: "3306"
