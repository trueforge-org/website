...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fb77bdf41f945f4fb231589b1f3aa62bWORD
      MARIADB_ROOT_PASSWORD: 376fe574cf33eca628a3d6d43cf81987WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fb77bdf41f945f4fb231589b1f3aa62bWORD
      DB_PORT: "3306"
