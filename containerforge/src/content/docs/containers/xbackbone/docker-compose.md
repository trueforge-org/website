...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d8f54f3a366513209d506e14a7e42495WORD
      MARIADB_ROOT_PASSWORD: 3450b14aa3bd7fd30e4f7f67e93b32adWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d8f54f3a366513209d506e14a7e42495WORD
      DB_PORT: "3306"
