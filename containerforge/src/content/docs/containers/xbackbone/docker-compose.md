...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0ba321cf7fc4eac2576753279b45096cWORD
      MARIADB_ROOT_PASSWORD: 8652f873d813ae4ece65417cebf74706WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0ba321cf7fc4eac2576753279b45096cWORD
      DB_PORT: "3306"
