...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0481768d2b860d2789e3b05f0659870fWORD
      MARIADB_ROOT_PASSWORD: 3694ff6a3655786fc589786f3dacb980WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0481768d2b860d2789e3b05f0659870fWORD
      DB_PORT: "3306"
