...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 22c537f9df1272eb69f9768c8d38659cWORD
      MARIADB_ROOT_PASSWORD: 88faf00a1414680ed6e415e1c359d0a6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 22c537f9df1272eb69f9768c8d38659cWORD
      DB_PORT: "3306"
