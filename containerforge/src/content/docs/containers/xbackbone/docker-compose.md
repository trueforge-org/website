...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 329a4cb357b96c4e918beba3c63da793WORD
      MARIADB_ROOT_PASSWORD: 54a76cf3617157a075e830298f0b3d7bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 329a4cb357b96c4e918beba3c63da793WORD
      DB_PORT: "3306"
