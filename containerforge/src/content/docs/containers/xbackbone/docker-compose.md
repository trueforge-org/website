...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3ac1a49616c74f39bcc14bca36201c98WORD
      MARIADB_ROOT_PASSWORD: 1d12c0c2237cdceb1b3d6729ac69a27fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3ac1a49616c74f39bcc14bca36201c98WORD
      DB_PORT: "3306"
