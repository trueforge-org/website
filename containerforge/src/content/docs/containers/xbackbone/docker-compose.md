...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 451422412f7914789169cf7bff73a013WORD
      MARIADB_ROOT_PASSWORD: 07a8437b071e5f57001f14d0f0646a02WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 451422412f7914789169cf7bff73a013WORD
      DB_PORT: "3306"
