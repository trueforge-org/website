...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3c0b2944a31ef40d9f95fcfd5a3e1545WORD
      MARIADB_ROOT_PASSWORD: ab0dbcbeb2f644e27daf53279e13a87cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3c0b2944a31ef40d9f95fcfd5a3e1545WORD
      DB_PORT: "3306"
