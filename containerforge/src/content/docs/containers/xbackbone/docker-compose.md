...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 366bcf92095fe1da62a472c71d045797WORD
      MARIADB_ROOT_PASSWORD: aa68c957d1fa5ebc7e00bbeb310f0ff2WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 366bcf92095fe1da62a472c71d045797WORD
      DB_PORT: "3306"
