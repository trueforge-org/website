...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f9c571b413c15f308744573b00dcd539WORD
      MARIADB_ROOT_PASSWORD: f2217ea3a904c4619d82fb5a2a6dfa57WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f9c571b413c15f308744573b00dcd539WORD
      DB_PORT: "3306"
