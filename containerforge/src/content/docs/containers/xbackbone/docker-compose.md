...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fda46d5fc141e017a4b2eef2b78ca99dWORD
      MARIADB_ROOT_PASSWORD: c0926b73cdd745f0e0208bcc1a29fa43WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fda46d5fc141e017a4b2eef2b78ca99dWORD
      DB_PORT: "3306"
