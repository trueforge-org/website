...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f66a6835223349056397f61ebf83edb3WORD
      MARIADB_ROOT_PASSWORD: 93159d890b08a9b96dab2e62a1fbe203WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f66a6835223349056397f61ebf83edb3WORD
      DB_PORT: "3306"
