...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: be3eaed7bfbb4c40c8eb536237e07d39WORD
      MARIADB_ROOT_PASSWORD: 34684a73950b566330bb411921bf1619WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: be3eaed7bfbb4c40c8eb536237e07d39WORD
      DB_PORT: "3306"
