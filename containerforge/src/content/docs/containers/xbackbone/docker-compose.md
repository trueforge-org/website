...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 174d96de5c03b389a52903021def0ed9WORD
      MARIADB_ROOT_PASSWORD: 99e772b909fd3f3be70f8ab0bbb15340WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 174d96de5c03b389a52903021def0ed9WORD
      DB_PORT: "3306"
