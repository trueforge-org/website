...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 175cf70709eb443ab490cee6314ef421WORD
      MARIADB_ROOT_PASSWORD: e1ba65613c7ed745e2c5fcd63d85c885WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 175cf70709eb443ab490cee6314ef421WORD
      DB_PORT: "3306"
