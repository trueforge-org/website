...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4a53ad2aad5fb24d11bff91ce9103c50WORD
      MARIADB_ROOT_PASSWORD: 990c4dda433c55787beaeb1768e74b09WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4a53ad2aad5fb24d11bff91ce9103c50WORD
      DB_PORT: "3306"
