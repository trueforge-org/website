...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1e5f9d4884f660a3cacac2ce394a96afWORD
      MARIADB_ROOT_PASSWORD: 89c41870f2b28ef1fe00f77f70eb9ec1WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1e5f9d4884f660a3cacac2ce394a96afWORD
      DB_PORT: "3306"
