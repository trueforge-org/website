...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c03e20a0e7c1ff8ac1a51bae3463ec2bWORD
      MARIADB_ROOT_PASSWORD: 66818a7198c848419069dfbf24ca2b8fWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c03e20a0e7c1ff8ac1a51bae3463ec2bWORD
      DB_PORT: "3306"
