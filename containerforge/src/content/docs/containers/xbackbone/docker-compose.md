...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b4f37bd1eaf3c40ad328da23b2ecafd9WORD
      MARIADB_ROOT_PASSWORD: b6324f203c58a336f3e3455c9673092dWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b4f37bd1eaf3c40ad328da23b2ecafd9WORD
      DB_PORT: "3306"
