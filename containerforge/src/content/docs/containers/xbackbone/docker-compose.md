...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 96f893ddebc8fc81995f769610325035WORD
      MARIADB_ROOT_PASSWORD: d06fc1bc5f85efb92415672ea39e1cf0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 96f893ddebc8fc81995f769610325035WORD
      DB_PORT: "3306"
