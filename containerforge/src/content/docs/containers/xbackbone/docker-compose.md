...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b4dfedc62090a2275e1a2ab6c8850f68WORD
      MARIADB_ROOT_PASSWORD: 6c8b70060a28d5ef15fd8b80326166c3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b4dfedc62090a2275e1a2ab6c8850f68WORD
      DB_PORT: "3306"
