...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 69a5ebb372b3dbcfa7838ff70241dec3WORD
      MARIADB_ROOT_PASSWORD: 42a8d976ddac8351649986647e92ffabWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 69a5ebb372b3dbcfa7838ff70241dec3WORD
      DB_PORT: "3306"
