...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b8bdf9e4d53be6e0cf2c19be02c6a6c9WORD
      MARIADB_ROOT_PASSWORD: d9525082817abe7540ab3fe8ad8e16c0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b8bdf9e4d53be6e0cf2c19be02c6a6c9WORD
      DB_PORT: "3306"
