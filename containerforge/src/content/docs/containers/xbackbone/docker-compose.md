...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 76cbb4814f0e2903f16dafa740183eb9WORD
      MARIADB_ROOT_PASSWORD: da6ba58c3d39a7d6313331f6c86d6b2bWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 76cbb4814f0e2903f16dafa740183eb9WORD
      DB_PORT: "3306"
