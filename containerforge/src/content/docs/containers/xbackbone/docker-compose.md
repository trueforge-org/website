...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a415b40099ebce9a50c6236116ce8eb8WORD
      MARIADB_ROOT_PASSWORD: c144f11ae769fb5dca3daa378b86b86cWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a415b40099ebce9a50c6236116ce8eb8WORD
      DB_PORT: "3306"
