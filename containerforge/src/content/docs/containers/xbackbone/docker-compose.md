...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 51a3f6057822a69a186e69464b223694WORD
      MARIADB_ROOT_PASSWORD: 6ff495dc82363c3f94f647bfe4a6c170WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 51a3f6057822a69a186e69464b223694WORD
      DB_PORT: "3306"
