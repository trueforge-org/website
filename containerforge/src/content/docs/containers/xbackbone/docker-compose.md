...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c202d287d009a74ef14e45c68af382ecWORD
      MARIADB_ROOT_PASSWORD: 447a93a42407226597ac067c2a2eb458WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c202d287d009a74ef14e45c68af382ecWORD
      DB_PORT: "3306"
