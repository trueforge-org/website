...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2555aa8c063c909503693129a5549e82WORD
      MARIADB_ROOT_PASSWORD: 4d654bcab549df2a76686b4887b60dc6WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2555aa8c063c909503693129a5549e82WORD
      DB_PORT: "3306"
