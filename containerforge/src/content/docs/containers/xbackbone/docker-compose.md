...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 73c9f7481aa6cdb8bd20b4ab699d1375WORD
      MARIADB_ROOT_PASSWORD: 8ddb95ffbe2ba1c2deec43f9c0a6050aWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 73c9f7481aa6cdb8bd20b4ab699d1375WORD
      DB_PORT: "3306"
