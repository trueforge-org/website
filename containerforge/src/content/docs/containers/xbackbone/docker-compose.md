...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d0fdfd10e536ba0411cda05b76817b43WORD
      MARIADB_ROOT_PASSWORD: b42e4104692c0e30265df47c43329a31WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d0fdfd10e536ba0411cda05b76817b43WORD
      DB_PORT: "3306"
