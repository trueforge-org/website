...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2d5a31f58308acef07ba428e82f3d736WORD
      MARIADB_ROOT_PASSWORD: bdcb83678ada055263b4bd6368a0dab3WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2d5a31f58308acef07ba428e82f3d736WORD
      DB_PORT: "3306"
