...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 017a7a665b6914c165fa1e9bae1e997bWORD
      MARIADB_ROOT_PASSWORD: b113b9906ba60aea4fb6b840781cf60eWORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 017a7a665b6914c165fa1e9bae1e997bWORD
      DB_PORT: "3306"
