...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 542f9135e9ef4b7e5d0e4271c6b17304WORD
      MARIADB_ROOT_PASSWORD: 32ee15239705643e2c5f2e56c69e3fa0WORD
  ...
  xbackbone:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 542f9135e9ef4b7e5d0e4271c6b17304WORD
      DB_PORT: "3306"
