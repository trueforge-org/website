...
services:
  nextcloud-fpm:
    ...
    environment:
      ...
      NX_POSTGRES_PASSWORD: dabdb015b5f3f1c474c53f9fdbfef709WORD
      NX_POSTGRES_PORT: "5432"
      NX_POSTGRES_USER: nextcloud-notify-push
      NX_REDIS_HOST: valkey
      NX_REDIS_PASS: 6c58477c2a785e1999844d48fc4b9409WORD
      NX_REDIS_PORT: "6379"
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  nextcloud-notify-push:
    ...
    group_add:
      - "568"
    image: ghcr.io/trueforge-org/nextcloud-notify-push:1.3.4
    restart: unless-stopped
    shm_size: 256M
    volumes:
      - type: bind
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: dabdb015b5f3f1c474c53f9fdbfef709WORD
  ...
  valkey:
    ...
    environment:
      TZ: Etc/UTC
      VALKEY_PASSWORD: 6c58477c2a785e1999844d48fc4b9409WORD
    group_add:
      - "568"
