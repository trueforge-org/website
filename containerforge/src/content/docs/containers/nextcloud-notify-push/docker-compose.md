...
services:
  nextcloud-fpm:
    ...
    environment:
      ...
      NX_POSTGRES_PASSWORD: 367af7d9e42485b71d89da495c8c4a5eWORD
      NX_POSTGRES_PORT: "5432"
      NX_POSTGRES_USER: nextcloud-notify-push
      NX_REDIS_HOST: valkey
      NX_REDIS_PASS: b658ea44fd5fa0feceeabc8ff5b436b6WORD
      NX_REDIS_PORT: "6379"
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  nextcloud-notify-push:
    ...
    group_add:
      - "568"
    image: ghcr.io/trueforge-org/nextcloud-notify-push:1.3.2
    restart: unless-stopped
    shm_size: 256M
    volumes:
      - type: bind
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 367af7d9e42485b71d89da495c8c4a5eWORD
  ...
  valkey:
    ...
    environment:
      TZ: Etc/UTC
      VALKEY_PASSWORD: b658ea44fd5fa0feceeabc8ff5b436b6WORD
    group_add:
      - "568"
