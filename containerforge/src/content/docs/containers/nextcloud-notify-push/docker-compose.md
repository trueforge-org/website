...
services:
  nextcloud-fpm:
    ...
    environment:
      ...
      NX_POSTGRES_PASSWORD: 3fdc12f905f348ca38a4129026ad0b9bWORD
      NX_POSTGRES_PORT: "5432"
      NX_POSTGRES_USER: nextcloud-notify-push
      NX_REDIS_HOST: valkey
      NX_REDIS_PASS: d24aa815934e53c75d60b9ba68decb90WORD
      NX_REDIS_PORT: "6379"
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  nextcloud-notify-push:
    ...
    group_add:
      - "568"
    image: ghcr.io/trueforge-org/nextcloud-notify-push:1.3.3
    restart: unless-stopped
    shm_size: 256M
    volumes:
      - type: bind
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 3fdc12f905f348ca38a4129026ad0b9bWORD
  ...
  valkey:
    ...
    environment:
      TZ: Etc/UTC
      VALKEY_PASSWORD: d24aa815934e53c75d60b9ba68decb90WORD
    group_add:
      - "568"
