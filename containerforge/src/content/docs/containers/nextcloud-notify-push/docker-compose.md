...
services:
  nextcloud-fpm:
    ...
    environment:
      ...
      NX_POSTGRES_PASSWORD: 9d20e7e7c7aae359f27f2700be42e9b2WORD
      NX_POSTGRES_PORT: "5432"
      NX_POSTGRES_USER: nextcloud-notify-push
      NX_REDIS_HOST: valkey
      NX_REDIS_PASS: 4210b4f14210b4da3b17df5ac80479e0WORD
      NX_REDIS_PORT: "6379"
      TZ: Etc/UTC
    group_add:
      - "568"
  ...
  nextcloud-notify-push:
    ...
    group_add:
      - "568"
    image: ghcr.io/trueforge-org/nextcloud-notify-push:1.3.5
    restart: unless-stopped
    shm_size: 256M
    volumes:
      - type: bind
  ...
  postgresql:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: 9d20e7e7c7aae359f27f2700be42e9b2WORD
  ...
  valkey:
    ...
    environment:
      TZ: Etc/UTC
      VALKEY_PASSWORD: 4210b4f14210b4da3b17df5ac80479e0WORD
    group_add:
      - "568"
