...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fb29ad5cfba9da100a9f2a7d599575b2WORD
      MARIADB_ROOT_PASSWORD: e8bbb6361dd5d6a23944d25635261fb4WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fb29ad5cfba9da100a9f2a7d599575b2WORD
      DB_PORT: "3306"
