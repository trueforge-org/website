...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 984a952b70b3f3b74329e09ffc063341WORD
      MARIADB_ROOT_PASSWORD: 74c7bd6ee39d11000e80a3550775fd26WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 984a952b70b3f3b74329e09ffc063341WORD
      DB_PORT: "3306"
