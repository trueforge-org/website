...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2793f8d8a87e86723ccce5269c427c71WORD
      MARIADB_ROOT_PASSWORD: 07246421a97dabd7116594f548c9c0c7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2793f8d8a87e86723ccce5269c427c71WORD
      DB_PORT: "3306"
