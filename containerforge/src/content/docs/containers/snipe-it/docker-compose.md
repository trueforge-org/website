...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e37b57e06c522528399498c2cdc24a3aWORD
      MARIADB_ROOT_PASSWORD: b0dafbe2650d53327dd6145400366b04WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e37b57e06c522528399498c2cdc24a3aWORD
      DB_PORT: "3306"
