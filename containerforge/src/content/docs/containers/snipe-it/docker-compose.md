...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 919b8cdf159543838d9d09dc1203ce59WORD
      MARIADB_ROOT_PASSWORD: d626892e0420014b497c799fc2ef15e4WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 919b8cdf159543838d9d09dc1203ce59WORD
      DB_PORT: "3306"
