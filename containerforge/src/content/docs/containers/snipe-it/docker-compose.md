...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8b0629588e53f99ec80637ded00d4dc6WORD
      MARIADB_ROOT_PASSWORD: 3fdd728704f5b1a58e3eb478cc11972cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8b0629588e53f99ec80637ded00d4dc6WORD
      DB_PORT: "3306"
