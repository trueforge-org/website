...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2b9afa47d5791b528cb6782a346376a0WORD
      MARIADB_ROOT_PASSWORD: b5000abdd554e54035e17d9ee7b7395bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2b9afa47d5791b528cb6782a346376a0WORD
      DB_PORT: "3306"
