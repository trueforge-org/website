...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3029fd16586fb0f209f05d21f125d0f6WORD
      MARIADB_ROOT_PASSWORD: 2fe4d1de797e67762af1f9e0439d6ab9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3029fd16586fb0f209f05d21f125d0f6WORD
      DB_PORT: "3306"
