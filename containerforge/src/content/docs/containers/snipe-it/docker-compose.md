...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 302ab63a906a217c16777e8f0217d7f8WORD
      MARIADB_ROOT_PASSWORD: e980daf29597b284672a789c39ab45efWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 302ab63a906a217c16777e8f0217d7f8WORD
      DB_PORT: "3306"
