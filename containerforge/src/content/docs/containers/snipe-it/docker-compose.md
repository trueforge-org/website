...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 22e0e6894a5f7eb8a842c8a4dc5fef77WORD
      MARIADB_ROOT_PASSWORD: 33c80959d2daa7d483acb101bf330a7eWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 22e0e6894a5f7eb8a842c8a4dc5fef77WORD
      DB_PORT: "3306"
