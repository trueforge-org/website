...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b7ba045f52df54c3d01cc389c9894a7bWORD
      MARIADB_ROOT_PASSWORD: cbf47fc48aeea449dd878899a11cfa0cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b7ba045f52df54c3d01cc389c9894a7bWORD
      DB_PORT: "3306"
