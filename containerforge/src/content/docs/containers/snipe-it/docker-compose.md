...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b0b7492de4735165b9ce283d0c434810WORD
      MARIADB_ROOT_PASSWORD: 45f12601964f8e17b6150aa0274e3793WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b0b7492de4735165b9ce283d0c434810WORD
      DB_PORT: "3306"
