...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 59bdf71b05c6660dfed973dfa074ba7fWORD
      MARIADB_ROOT_PASSWORD: ba80b10f6d4507f4d84ce48775b992acWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 59bdf71b05c6660dfed973dfa074ba7fWORD
      DB_PORT: "3306"
