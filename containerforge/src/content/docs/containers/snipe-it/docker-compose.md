...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: eacc736b03655ac108379330ddbaa9eeWORD
      MARIADB_ROOT_PASSWORD: d29bfa3ed0912b3d8306769ee4271fd1WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: eacc736b03655ac108379330ddbaa9eeWORD
      DB_PORT: "3306"
