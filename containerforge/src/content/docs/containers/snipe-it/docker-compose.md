...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 04c9bdad274dc9a419d36151b2f4832aWORD
      MARIADB_ROOT_PASSWORD: 918eac5415bc25d12dfa27249859810dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 04c9bdad274dc9a419d36151b2f4832aWORD
      DB_PORT: "3306"
