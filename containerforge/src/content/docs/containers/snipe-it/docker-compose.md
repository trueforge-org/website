...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 31374978a021a069692d5855a5370490WORD
      MARIADB_ROOT_PASSWORD: 7f2d76563ff3747c3279af7a380e53eeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 31374978a021a069692d5855a5370490WORD
      DB_PORT: "3306"
