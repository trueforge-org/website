...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6c89385a1db240edb260fdd615eff78fWORD
      MARIADB_ROOT_PASSWORD: 1604d8615f015cb024b195bba481b481WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6c89385a1db240edb260fdd615eff78fWORD
      DB_PORT: "3306"
