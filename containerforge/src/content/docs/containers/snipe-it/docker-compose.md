...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 38afafe24c91dbbd4480474b4bee28cbWORD
      MARIADB_ROOT_PASSWORD: 343e6ad1c4e4f52aa9c18bdd162c5a40WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 38afafe24c91dbbd4480474b4bee28cbWORD
      DB_PORT: "3306"
