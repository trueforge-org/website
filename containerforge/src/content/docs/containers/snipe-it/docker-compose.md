...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 30beec1f533535c710f4009472845d00WORD
      MARIADB_ROOT_PASSWORD: 19876aff5f90bbfaf1af7869f729be41WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 30beec1f533535c710f4009472845d00WORD
      DB_PORT: "3306"
