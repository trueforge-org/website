...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2d5ab2271745d94a607c3378d2480e52WORD
      MARIADB_ROOT_PASSWORD: f2581a14f1e5be6230a6ea12034e6c72WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2d5ab2271745d94a607c3378d2480e52WORD
      DB_PORT: "3306"
