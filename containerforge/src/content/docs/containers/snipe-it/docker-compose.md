...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b7cc014b29e9a567b794c701d0092955WORD
      MARIADB_ROOT_PASSWORD: 775c5379b81eb4fc039861b104f27724WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b7cc014b29e9a567b794c701d0092955WORD
      DB_PORT: "3306"
