...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 52a7d759b4414b2aecd042dd621756acWORD
      MARIADB_ROOT_PASSWORD: 1667276701dc04694bc158af3f387fb3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 52a7d759b4414b2aecd042dd621756acWORD
      DB_PORT: "3306"
