...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3340634ce4194af62439ded536de186cWORD
      MARIADB_ROOT_PASSWORD: 3e48d5c5a298802e966c78bc5a9915b8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3340634ce4194af62439ded536de186cWORD
      DB_PORT: "3306"
