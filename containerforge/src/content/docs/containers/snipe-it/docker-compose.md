...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 228d657212a0fe61c2dab0f9ce4d36f7WORD
      MARIADB_ROOT_PASSWORD: daa3bc12176f41702e6a85a88b80d745WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 228d657212a0fe61c2dab0f9ce4d36f7WORD
      DB_PORT: "3306"
