...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bcc73e5ba70601e6038facb254c831b8WORD
      MARIADB_ROOT_PASSWORD: 8770d8f40717fa36be4f1c720c59d809WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bcc73e5ba70601e6038facb254c831b8WORD
      DB_PORT: "3306"
