...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1c143d333f4e090ae029538363dd3457WORD
      MARIADB_ROOT_PASSWORD: 684a9abc20683f999167b979b5b4f13fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1c143d333f4e090ae029538363dd3457WORD
      DB_PORT: "3306"
