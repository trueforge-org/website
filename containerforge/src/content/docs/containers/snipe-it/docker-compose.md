...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5de4be200f4b42032d13a36d5f32f2a3WORD
      MARIADB_ROOT_PASSWORD: b9e77629a227f920cf28ab0b705218beWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5de4be200f4b42032d13a36d5f32f2a3WORD
      DB_PORT: "3306"
