...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dd2b6e08c782faf947b04c20968772c6WORD
      MARIADB_ROOT_PASSWORD: 50409ca9c6148d55f956228e24e2cd1fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dd2b6e08c782faf947b04c20968772c6WORD
      DB_PORT: "3306"
