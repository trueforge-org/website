...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3f2e0c66ca07539d713b76e403feb04cWORD
      MARIADB_ROOT_PASSWORD: 35220c5fd1eed25a87b7b39b97130d60WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3f2e0c66ca07539d713b76e403feb04cWORD
      DB_PORT: "3306"
