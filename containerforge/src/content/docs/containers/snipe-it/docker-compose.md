...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d7fe31b3c4160dd05e9ab44654721e62WORD
      MARIADB_ROOT_PASSWORD: fde9d9f4bc194a9fc70e34e8342750f8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d7fe31b3c4160dd05e9ab44654721e62WORD
      DB_PORT: "3306"
