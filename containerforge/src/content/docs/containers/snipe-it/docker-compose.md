...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8fd56f961a20e88712ef261fa13dea20WORD
      MARIADB_ROOT_PASSWORD: a6645b870ad5c62e0c031af7455b2395WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8fd56f961a20e88712ef261fa13dea20WORD
      DB_PORT: "3306"
