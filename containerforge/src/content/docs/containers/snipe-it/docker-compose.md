...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fdc560ce9e8437e537ab27426191d16eWORD
      MARIADB_ROOT_PASSWORD: 26a0c5cebf62cc789e964dbc7ec17097WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fdc560ce9e8437e537ab27426191d16eWORD
      DB_PORT: "3306"
