...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ce1ffbd3b670f0c4f1a4e8f0b39fbfedWORD
      MARIADB_ROOT_PASSWORD: 02d036f3a92beff692ba2ac623d2b8eeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ce1ffbd3b670f0c4f1a4e8f0b39fbfedWORD
      DB_PORT: "3306"
