...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f0aef6e06d5e620ca5ab6d5babb060dfWORD
      MARIADB_ROOT_PASSWORD: d02cd8c34bb1e02a23c7f11c6f96d1bfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f0aef6e06d5e620ca5ab6d5babb060dfWORD
      DB_PORT: "3306"
