...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08649e67188cdb889c0f5b24fea70530WORD
      MARIADB_ROOT_PASSWORD: 00d4b45d40eebeca1d7b9763939d51f3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08649e67188cdb889c0f5b24fea70530WORD
      DB_PORT: "3306"
