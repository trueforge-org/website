...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 54933f9f19815643280c9223e590fc3aWORD
      MARIADB_ROOT_PASSWORD: d4fb6a588ce5a587ea87f7ad37a6e93dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 54933f9f19815643280c9223e590fc3aWORD
      DB_PORT: "3306"
