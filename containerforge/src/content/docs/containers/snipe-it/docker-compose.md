...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 026541a4b3f676b0f5b01c519e8c6ff6WORD
      MARIADB_ROOT_PASSWORD: 0298a888b002587cc819fb257bec03a8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 026541a4b3f676b0f5b01c519e8c6ff6WORD
      DB_PORT: "3306"
