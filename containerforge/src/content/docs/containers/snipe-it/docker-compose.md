...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f50ef8858220d4524f1a91ab6d0bcaa1WORD
      MARIADB_ROOT_PASSWORD: 97e23dd9677654f03b6acd3d32f6cf87WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f50ef8858220d4524f1a91ab6d0bcaa1WORD
      DB_PORT: "3306"
