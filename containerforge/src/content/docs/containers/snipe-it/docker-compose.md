...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 89f90b502c90f85b6d0e45d02f25471fWORD
      MARIADB_ROOT_PASSWORD: a98fefb669a140c2a58e893c314ac29aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 89f90b502c90f85b6d0e45d02f25471fWORD
      DB_PORT: "3306"
