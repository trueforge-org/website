...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cda97141b1977a3fc9dabe4d6b8704edWORD
      MARIADB_ROOT_PASSWORD: 2f009767a56b8e9e4d4da7cb4a5fb59dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cda97141b1977a3fc9dabe4d6b8704edWORD
      DB_PORT: "3306"
