...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ff9250b813855e8715cc759bcc5aadb7WORD
      MARIADB_ROOT_PASSWORD: a70b782daaf55c24c420a7f322ed0bbcWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ff9250b813855e8715cc759bcc5aadb7WORD
      DB_PORT: "3306"
