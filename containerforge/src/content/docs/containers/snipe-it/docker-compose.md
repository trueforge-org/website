...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 06afd10c24ab50859799e3b7a500d846WORD
      MARIADB_ROOT_PASSWORD: 9b3bfe3eb1e00463db1c5b3f5cc08d51WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 06afd10c24ab50859799e3b7a500d846WORD
      DB_PORT: "3306"
