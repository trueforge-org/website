...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c080664a94e22216bf1bc95530e2b4caWORD
      MARIADB_ROOT_PASSWORD: b68919f93b74dac79702abf84e19f790WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c080664a94e22216bf1bc95530e2b4caWORD
      DB_PORT: "3306"
