...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dbe40eaf620b6fffe0e2a15fe6b2ca92WORD
      MARIADB_ROOT_PASSWORD: eb73562469aeadede87ec34b218226c6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dbe40eaf620b6fffe0e2a15fe6b2ca92WORD
      DB_PORT: "3306"
