...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d39ab770064a43e312def23efea8a5dWORD
      MARIADB_ROOT_PASSWORD: 31f95f56c8b1773fc1e4c43f10595b37WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d39ab770064a43e312def23efea8a5dWORD
      DB_PORT: "3306"
