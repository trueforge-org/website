...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ea65dba7dc9b7e89314fdc489be83a10WORD
      MARIADB_ROOT_PASSWORD: f11f68702ee580d46b36131eadffa76cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ea65dba7dc9b7e89314fdc489be83a10WORD
      DB_PORT: "3306"
