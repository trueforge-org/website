...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2c5fcb634574fd48c4c585b818955642WORD
      MARIADB_ROOT_PASSWORD: d2f18113c96c5381e62632ac9d09d578WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2c5fcb634574fd48c4c585b818955642WORD
      DB_PORT: "3306"
