...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 106ef9ee88ddaf346eb0e8ed80d45bd0WORD
      MARIADB_ROOT_PASSWORD: f576603af2696334a5151a034b63fd99WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 106ef9ee88ddaf346eb0e8ed80d45bd0WORD
      DB_PORT: "3306"
