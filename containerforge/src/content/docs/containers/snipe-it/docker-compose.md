...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 64ef2a5f6a53b6d63d3f318695e03b0eWORD
      MARIADB_ROOT_PASSWORD: 86b95dc9e5943a874b8dad3609b74d68WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 64ef2a5f6a53b6d63d3f318695e03b0eWORD
      DB_PORT: "3306"
