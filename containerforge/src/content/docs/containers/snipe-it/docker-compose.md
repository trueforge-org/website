...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c288fcd5ecedb62c07be5f04a90ec50dWORD
      MARIADB_ROOT_PASSWORD: ae26442cd1a8b47108a4057b311112c0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c288fcd5ecedb62c07be5f04a90ec50dWORD
      DB_PORT: "3306"
