...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c64838a252ca2262699931bf4ad2380aWORD
      MARIADB_ROOT_PASSWORD: 7adb0ce20446f1ec24a2f2053d68f8d4WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c64838a252ca2262699931bf4ad2380aWORD
      DB_PORT: "3306"
