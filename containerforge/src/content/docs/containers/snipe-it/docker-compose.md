...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c4671add5465c5069efe101d321c52c3WORD
      MARIADB_ROOT_PASSWORD: 66c0503d943c528ed09dbd8c63bf4146WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c4671add5465c5069efe101d321c52c3WORD
      DB_PORT: "3306"
