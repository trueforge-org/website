...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9516b801da9fce83fb8fa4d78bc9dec8WORD
      MARIADB_ROOT_PASSWORD: d3b670cce5aecd07bbde1b57573bd157WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9516b801da9fce83fb8fa4d78bc9dec8WORD
      DB_PORT: "3306"
