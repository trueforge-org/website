...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 019e4f20c84cafe16da36e0f3cb3f183WORD
      MARIADB_ROOT_PASSWORD: 196b3d4da984e65b2e0a2839d2c24381WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 019e4f20c84cafe16da36e0f3cb3f183WORD
      DB_PORT: "3306"
