...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 014e1c62bb35ec4d38482ee26fcde951WORD
      MARIADB_ROOT_PASSWORD: db272d2a39567508cdfc2b5c5e28047fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 014e1c62bb35ec4d38482ee26fcde951WORD
      DB_PORT: "3306"
