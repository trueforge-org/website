...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 14fcc8b209c216a016d6f79cf3d00a89WORD
      MARIADB_ROOT_PASSWORD: 6854f910990f23ef471c766ffc473b8aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 14fcc8b209c216a016d6f79cf3d00a89WORD
      DB_PORT: "3306"
