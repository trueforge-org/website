...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e7cc8a101add28dd3b1d9470fada675cWORD
      MARIADB_ROOT_PASSWORD: fb1c25db03ab305c51f313d487d60de7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e7cc8a101add28dd3b1d9470fada675cWORD
      DB_PORT: "3306"
