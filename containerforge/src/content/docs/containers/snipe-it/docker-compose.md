...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e15c636a766a6733f37944ddbf74feb2WORD
      MARIADB_ROOT_PASSWORD: 24ed88b4a671eed497ec906b681dcf35WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e15c636a766a6733f37944ddbf74feb2WORD
      DB_PORT: "3306"
