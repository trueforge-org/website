...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9718bb6d4b7c3bccf06cae54d0f8f491WORD
      MARIADB_ROOT_PASSWORD: 657ae383387e44ecad63b0084abd4150WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9718bb6d4b7c3bccf06cae54d0f8f491WORD
      DB_PORT: "3306"
