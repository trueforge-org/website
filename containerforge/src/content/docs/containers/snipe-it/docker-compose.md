...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 39993e14b1a7340fec360919a95fa792WORD
      MARIADB_ROOT_PASSWORD: 916fe6d7c13860a9ccd11deaa172f160WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 39993e14b1a7340fec360919a95fa792WORD
      DB_PORT: "3306"
