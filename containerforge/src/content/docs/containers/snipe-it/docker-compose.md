...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 145a39a7d9b6ac46a4e3802318c5518eWORD
      MARIADB_ROOT_PASSWORD: 4025a878c81c790b259e1921cd6c22baWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 145a39a7d9b6ac46a4e3802318c5518eWORD
      DB_PORT: "3306"
