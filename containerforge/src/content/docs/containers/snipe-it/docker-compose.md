...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a84ace0ca4e60041f343f536059e1903WORD
      MARIADB_ROOT_PASSWORD: 4c9c21ff77f27c071a95ab169b6a7469WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a84ace0ca4e60041f343f536059e1903WORD
      DB_PORT: "3306"
