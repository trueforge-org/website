...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8de232eb525d614c65b3e97df2c6a701WORD
      MARIADB_ROOT_PASSWORD: 63132c86ea4c1ce907d05dcaee285893WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8de232eb525d614c65b3e97df2c6a701WORD
      DB_PORT: "3306"
