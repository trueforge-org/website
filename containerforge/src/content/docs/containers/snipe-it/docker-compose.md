...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a6afeb045ec3c7a70ae639cca4c7c5f6WORD
      MARIADB_ROOT_PASSWORD: 73d00b4edb92848d61cd999c816df7e9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a6afeb045ec3c7a70ae639cca4c7c5f6WORD
      DB_PORT: "3306"
