...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 85681039261795981fa91cb89891c9b1WORD
      MARIADB_ROOT_PASSWORD: cb3c7b4e25584751c0dce9a1fe7a07d0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 85681039261795981fa91cb89891c9b1WORD
      DB_PORT: "3306"
