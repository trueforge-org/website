...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a78627344c8ea426fcde741d9cc7d200WORD
      MARIADB_ROOT_PASSWORD: f12dab7b7238be6f71ea427213a8b55bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a78627344c8ea426fcde741d9cc7d200WORD
      DB_PORT: "3306"
