...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6c04f7f6c699e578da855e69ae14123fWORD
      MARIADB_ROOT_PASSWORD: a7066f3ed37a0b79594a05143f01da01WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6c04f7f6c699e578da855e69ae14123fWORD
      DB_PORT: "3306"
