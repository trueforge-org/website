...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7fc90f80d13efa85b9f80ab2087ccb83WORD
      MARIADB_ROOT_PASSWORD: e40aa8867cf94625130ae8f737e2d0e1WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7fc90f80d13efa85b9f80ab2087ccb83WORD
      DB_PORT: "3306"
