...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3f20f8d362601b524a711fda0d6732a7WORD
      MARIADB_ROOT_PASSWORD: cfe07615cac2cebdf3b08cf0d505c514WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3f20f8d362601b524a711fda0d6732a7WORD
      DB_PORT: "3306"
