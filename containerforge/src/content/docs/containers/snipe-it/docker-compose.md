...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ad64b7ea8a88398d25a7656a9cfb2298WORD
      MARIADB_ROOT_PASSWORD: b86abbf002bb5a4ef05cac1f24f60337WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ad64b7ea8a88398d25a7656a9cfb2298WORD
      DB_PORT: "3306"
