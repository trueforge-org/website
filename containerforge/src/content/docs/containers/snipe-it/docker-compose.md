...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9d1843be48fedfd70eff1fd854f4827fWORD
      MARIADB_ROOT_PASSWORD: a1bcfc759e7020994b1ec5a3809e2cfcWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9d1843be48fedfd70eff1fd854f4827fWORD
      DB_PORT: "3306"
