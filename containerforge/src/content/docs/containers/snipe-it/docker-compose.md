...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 00b8256c2df4d8dcb56c904ebc00f626WORD
      MARIADB_ROOT_PASSWORD: b58be844959986e4f0cdb622dfff6e8fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 00b8256c2df4d8dcb56c904ebc00f626WORD
      DB_PORT: "3306"
