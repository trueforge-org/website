...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f9cfea68d759397476cfee8e685f9a5eWORD
      MARIADB_ROOT_PASSWORD: e48e2e1258624d6a4d88477cfdd46713WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f9cfea68d759397476cfee8e685f9a5eWORD
      DB_PORT: "3306"
