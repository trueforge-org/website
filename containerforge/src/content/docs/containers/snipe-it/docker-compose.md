...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c8901afb1f64936f1bcdcb4cf61fb74cWORD
      MARIADB_ROOT_PASSWORD: 9e31103af64684a6cdd05d15786942e0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c8901afb1f64936f1bcdcb4cf61fb74cWORD
      DB_PORT: "3306"
