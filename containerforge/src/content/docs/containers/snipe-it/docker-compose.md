...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 76e71949b19d2b24e1a7503e91b6b570WORD
      MARIADB_ROOT_PASSWORD: 8746210ede62dbba243dc68183e44dd3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 76e71949b19d2b24e1a7503e91b6b570WORD
      DB_PORT: "3306"
