...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8f0801e559f28df5947db8754b301420WORD
      MARIADB_ROOT_PASSWORD: 77d3dcb77277a22411dbec757704144eWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8f0801e559f28df5947db8754b301420WORD
      DB_PORT: "3306"
