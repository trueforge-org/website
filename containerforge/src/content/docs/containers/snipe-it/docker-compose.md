...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 35a8697802543644e6a068f04c220391WORD
      MARIADB_ROOT_PASSWORD: 29bff015c421d81a87d2ceb89373f769WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 35a8697802543644e6a068f04c220391WORD
      DB_PORT: "3306"
