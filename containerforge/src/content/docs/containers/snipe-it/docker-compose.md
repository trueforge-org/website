...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e0dbd7d7020c9a73ac04fa74c9b51e94WORD
      MARIADB_ROOT_PASSWORD: 6dc14e3c41fda46f850b3d4cc9f8c93dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e0dbd7d7020c9a73ac04fa74c9b51e94WORD
      DB_PORT: "3306"
