...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: bb859499a57aebdc087d79528bf1d81aWORD
      MARIADB_ROOT_PASSWORD: 76d38c288039c59e859df663a9660b7cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: bb859499a57aebdc087d79528bf1d81aWORD
      DB_PORT: "3306"
