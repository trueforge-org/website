...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: cd7179f034b4e0bdcb2f5ad8dd7988d0WORD
      MARIADB_ROOT_PASSWORD: 01d4014d1a72043bc8119b8168b9e28aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: cd7179f034b4e0bdcb2f5ad8dd7988d0WORD
      DB_PORT: "3306"
