...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f233773cffbda6b221060ad0981a865aWORD
      MARIADB_ROOT_PASSWORD: bc92b9b80ef23e4ad600a3e9a4ddeabeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f233773cffbda6b221060ad0981a865aWORD
      DB_PORT: "3306"
