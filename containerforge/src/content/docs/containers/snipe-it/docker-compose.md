...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dd231ba7fa1a9ec98b12ce1abb106698WORD
      MARIADB_ROOT_PASSWORD: 9cb360c1636c3478b60293b0291d3e0bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dd231ba7fa1a9ec98b12ce1abb106698WORD
      DB_PORT: "3306"
