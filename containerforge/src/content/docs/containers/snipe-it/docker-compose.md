...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8a11b07e67fedaadc645345c99b0021bWORD
      MARIADB_ROOT_PASSWORD: 0fd721518d37391a50acad70a6eac252WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8a11b07e67fedaadc645345c99b0021bWORD
      DB_PORT: "3306"
