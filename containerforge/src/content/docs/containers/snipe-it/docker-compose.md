...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3a4113ec63f11737b33b30ed3d94e630WORD
      MARIADB_ROOT_PASSWORD: efed47e658dc9378627d486b39649331WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3a4113ec63f11737b33b30ed3d94e630WORD
      DB_PORT: "3306"
