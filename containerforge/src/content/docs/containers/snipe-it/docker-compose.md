...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fc0e236ae2b8bbd9c959b4d1f6082540WORD
      MARIADB_ROOT_PASSWORD: b9f29b9ff318fc5cc5639a772ac579adWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fc0e236ae2b8bbd9c959b4d1f6082540WORD
      DB_PORT: "3306"
