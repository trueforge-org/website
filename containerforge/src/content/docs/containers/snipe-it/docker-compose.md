...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 982584a2c96a125f75a8364031fd7499WORD
      MARIADB_ROOT_PASSWORD: d536a5d0841ca6dbe6386a6b6d4c47f9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 982584a2c96a125f75a8364031fd7499WORD
      DB_PORT: "3306"
