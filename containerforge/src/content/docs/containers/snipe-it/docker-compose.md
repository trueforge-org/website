...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 73cac420850f7c98d0ed049fc0d279f4WORD
      MARIADB_ROOT_PASSWORD: bbb3da3721795ae4d9424e183c538358WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 73cac420850f7c98d0ed049fc0d279f4WORD
      DB_PORT: "3306"
