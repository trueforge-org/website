...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 87f29843403c49c8c22d170411870b7eWORD
      MARIADB_ROOT_PASSWORD: 9592cc97fe727e5b11a226d9ac15ac3aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 87f29843403c49c8c22d170411870b7eWORD
      DB_PORT: "3306"
