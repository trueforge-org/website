...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d958355b57d0828a92af792f741c6c12WORD
      MARIADB_ROOT_PASSWORD: ff5fa93106de4677da20d26828a196dbWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d958355b57d0828a92af792f741c6c12WORD
      DB_PORT: "3306"
