...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8b49c6d3792240b4359082e7dd2a9fdaWORD
      MARIADB_ROOT_PASSWORD: 17ad38717fa414d547f5749988ac091fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8b49c6d3792240b4359082e7dd2a9fdaWORD
      DB_PORT: "3306"
