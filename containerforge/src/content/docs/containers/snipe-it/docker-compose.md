...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e7709143f9897dadfb93b007e1f6ebaaWORD
      MARIADB_ROOT_PASSWORD: e521297e355ebd7b64471dbc55114b4fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e7709143f9897dadfb93b007e1f6ebaaWORD
      DB_PORT: "3306"
