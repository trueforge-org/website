...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f84350b595fb7ce0258525e71dc68d5aWORD
      MARIADB_ROOT_PASSWORD: 43a2f6c5b7629425c4bdff0e42e61601WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f84350b595fb7ce0258525e71dc68d5aWORD
      DB_PORT: "3306"
