...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 88973a076e0e946167086f47248e2f16WORD
      MARIADB_ROOT_PASSWORD: a92ee780dd4764cd0f291c1afc85dc9aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 88973a076e0e946167086f47248e2f16WORD
      DB_PORT: "3306"
