...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 532b6b8bb4191a064eb2db89ebe80d8cWORD
      MARIADB_ROOT_PASSWORD: cb87642b7d347daab73470ba76a168e8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 532b6b8bb4191a064eb2db89ebe80d8cWORD
      DB_PORT: "3306"
