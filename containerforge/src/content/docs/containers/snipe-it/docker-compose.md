...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ca4b5c7f3b97cdb68da7c929a077270eWORD
      MARIADB_ROOT_PASSWORD: 302af8f719ec06cd52faaef16e11fe48WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ca4b5c7f3b97cdb68da7c929a077270eWORD
      DB_PORT: "3306"
