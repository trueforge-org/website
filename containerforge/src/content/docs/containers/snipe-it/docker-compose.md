...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d9a0e802afaef125eab0dc0512bc3acWORD
      MARIADB_ROOT_PASSWORD: 9bda8412b4f769dbbfff737d3a062442WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d9a0e802afaef125eab0dc0512bc3acWORD
      DB_PORT: "3306"
