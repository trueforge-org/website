...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 90efca57029ece4a5c0945123242a63fWORD
      MARIADB_ROOT_PASSWORD: a41c670f9ca888f617deb898a5836678WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 90efca57029ece4a5c0945123242a63fWORD
      DB_PORT: "3306"
