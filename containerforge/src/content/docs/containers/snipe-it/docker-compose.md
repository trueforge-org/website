...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 78b392494bf944c862b04642829e4735WORD
      MARIADB_ROOT_PASSWORD: e9e278925bcc67438c5f65b0e76a78ddWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 78b392494bf944c862b04642829e4735WORD
      DB_PORT: "3306"
