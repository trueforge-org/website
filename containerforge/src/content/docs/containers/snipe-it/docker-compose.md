...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3409509939de8af03af8adda0e7ac127WORD
      MARIADB_ROOT_PASSWORD: f119a7e0f5b83af7e794452703533fdeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3409509939de8af03af8adda0e7ac127WORD
      DB_PORT: "3306"
