...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ec65c89f478539b3b14fa8d5084900adWORD
      MARIADB_ROOT_PASSWORD: 9be1cda111a48ca38ae31a302938a43dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ec65c89f478539b3b14fa8d5084900adWORD
      DB_PORT: "3306"
