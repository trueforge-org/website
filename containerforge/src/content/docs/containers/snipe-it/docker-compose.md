...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9fbc9400d797ed4e0968cb75a10c093bWORD
      MARIADB_ROOT_PASSWORD: 1d996294420f93398b72d056e93ac0eeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9fbc9400d797ed4e0968cb75a10c093bWORD
      DB_PORT: "3306"
