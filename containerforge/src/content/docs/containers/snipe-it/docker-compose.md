...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7613ed0719fd0f655f1e3dcd486f077cWORD
      MARIADB_ROOT_PASSWORD: cfb81d84c2f64c76045dbaf958ca85c7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7613ed0719fd0f655f1e3dcd486f077cWORD
      DB_PORT: "3306"
