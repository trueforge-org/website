...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e1e87d958a32226d4576d502efd6354eWORD
      MARIADB_ROOT_PASSWORD: 17f0d92a12991fe4b1dc1a83769c5212WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e1e87d958a32226d4576d502efd6354eWORD
      DB_PORT: "3306"
