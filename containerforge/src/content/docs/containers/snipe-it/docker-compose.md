...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 887b34a3347ab30b62423e6d8da3cfedWORD
      MARIADB_ROOT_PASSWORD: b90db2f582f666391cf7271de9f4d7a9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 887b34a3347ab30b62423e6d8da3cfedWORD
      DB_PORT: "3306"
