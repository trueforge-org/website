...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e4a4c2e98d5b257e89e911b8016ab709WORD
      MARIADB_ROOT_PASSWORD: 21fc3a9f2ab43ff8e1291928b719ebafWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e4a4c2e98d5b257e89e911b8016ab709WORD
      DB_PORT: "3306"
