...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 33b3e1bc57c075e8e2d2ba761faba8b2WORD
      MARIADB_ROOT_PASSWORD: 8dbcbf058535a7e612a45f5bbc2c84c3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 33b3e1bc57c075e8e2d2ba761faba8b2WORD
      DB_PORT: "3306"
