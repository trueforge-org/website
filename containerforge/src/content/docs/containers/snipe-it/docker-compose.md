...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 32eb9b234e7596c64f964e0eb781b71eWORD
      MARIADB_ROOT_PASSWORD: 5d1bedccd5f76002aba1581599a23c73WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 32eb9b234e7596c64f964e0eb781b71eWORD
      DB_PORT: "3306"
