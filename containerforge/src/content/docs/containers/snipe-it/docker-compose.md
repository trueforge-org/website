...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ac046c316004f9bfbe6bd81324bdb9e1WORD
      MARIADB_ROOT_PASSWORD: d70be225243a792bd33dd9abee14311aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ac046c316004f9bfbe6bd81324bdb9e1WORD
      DB_PORT: "3306"
