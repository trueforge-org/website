...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5a56d47f99e203d2745808272689df0cWORD
      MARIADB_ROOT_PASSWORD: 092d862ff6f1f9e28e50105a9eb0a22bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5a56d47f99e203d2745808272689df0cWORD
      DB_PORT: "3306"
