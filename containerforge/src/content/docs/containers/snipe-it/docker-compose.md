...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e2e5fab0ce64a358dd7358c7b45dea18WORD
      MARIADB_ROOT_PASSWORD: 69bb2c23da5564fd64e6f85076c6cae3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e2e5fab0ce64a358dd7358c7b45dea18WORD
      DB_PORT: "3306"
