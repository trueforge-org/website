...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c0eaece762f5887c71c55107d7afcef6WORD
      MARIADB_ROOT_PASSWORD: f8307f748d636430d7e69818fce13658WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c0eaece762f5887c71c55107d7afcef6WORD
      DB_PORT: "3306"
