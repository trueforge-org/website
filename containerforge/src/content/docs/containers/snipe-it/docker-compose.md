...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 496ca7c25012416b644395a7edc348d7WORD
      MARIADB_ROOT_PASSWORD: 2db9e887873dc8a2b3ea0f5567d11043WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 496ca7c25012416b644395a7edc348d7WORD
      DB_PORT: "3306"
