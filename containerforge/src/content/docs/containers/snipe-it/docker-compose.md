...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 75acce793f05beddcb9dcf84e484ccfbWORD
      MARIADB_ROOT_PASSWORD: 56a8311142022d1760763589f22d554fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 75acce793f05beddcb9dcf84e484ccfbWORD
      DB_PORT: "3306"
