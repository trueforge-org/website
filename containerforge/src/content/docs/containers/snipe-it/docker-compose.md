...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 29cd03bf57685e25388879f60c7194a1WORD
      MARIADB_ROOT_PASSWORD: 7afc1e2e5659a9b43635c06841afaa84WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 29cd03bf57685e25388879f60c7194a1WORD
      DB_PORT: "3306"
