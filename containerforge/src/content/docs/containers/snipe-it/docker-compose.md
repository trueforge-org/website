...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c93f4f8fd3bb750ee413a60b33ff8f4eWORD
      MARIADB_ROOT_PASSWORD: ab22a22247f5c40264185a207dbde732WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c93f4f8fd3bb750ee413a60b33ff8f4eWORD
      DB_PORT: "3306"
