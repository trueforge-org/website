...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b75a8e9d72cdaa87d54457a50f9e58eaWORD
      MARIADB_ROOT_PASSWORD: f26119bc98cc471bc3f37f70a4060732WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b75a8e9d72cdaa87d54457a50f9e58eaWORD
      DB_PORT: "3306"
