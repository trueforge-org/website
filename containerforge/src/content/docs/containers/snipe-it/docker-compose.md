...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5316a6f1f35f564e6edac9049620fafeWORD
      MARIADB_ROOT_PASSWORD: a9d522cad5b001825978b9fce096b28aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5316a6f1f35f564e6edac9049620fafeWORD
      DB_PORT: "3306"
