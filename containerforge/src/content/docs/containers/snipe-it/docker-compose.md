...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 914020dc46892a6fe9133058a61634d2WORD
      MARIADB_ROOT_PASSWORD: 6e8a4aa10f064116ab56f2c5b1d1c6feWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 914020dc46892a6fe9133058a61634d2WORD
      DB_PORT: "3306"
