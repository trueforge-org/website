...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 32d022972e3afe1fbedb4ae59c1cc084WORD
      MARIADB_ROOT_PASSWORD: f4e4e163ed4d8c83e24d66894d18ca71WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 32d022972e3afe1fbedb4ae59c1cc084WORD
      DB_PORT: "3306"
