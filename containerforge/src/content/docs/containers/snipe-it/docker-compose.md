...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f069e1ccacdab21643e5247fb2ddb5e7WORD
      MARIADB_ROOT_PASSWORD: 548625d34699f9285fe5917a7e038bd7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f069e1ccacdab21643e5247fb2ddb5e7WORD
      DB_PORT: "3306"
