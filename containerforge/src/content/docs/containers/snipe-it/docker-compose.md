...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6c273866983a241b5a76b8b06c6f48d2WORD
      MARIADB_ROOT_PASSWORD: e3e8a39a8f5c15059e4de4b31d9daf72WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6c273866983a241b5a76b8b06c6f48d2WORD
      DB_PORT: "3306"
