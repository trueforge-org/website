...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1df9440773030bffc179af8868bce47eWORD
      MARIADB_ROOT_PASSWORD: ba6a4af43c6fe94c7294c837e59f53d7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1df9440773030bffc179af8868bce47eWORD
      DB_PORT: "3306"
