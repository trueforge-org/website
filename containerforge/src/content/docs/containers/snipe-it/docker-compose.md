...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6472ca99a5dbbfff8916a6fed68f03ddWORD
      MARIADB_ROOT_PASSWORD: 0ef8193442d027f47dade7adfe0d6d50WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6472ca99a5dbbfff8916a6fed68f03ddWORD
      DB_PORT: "3306"
