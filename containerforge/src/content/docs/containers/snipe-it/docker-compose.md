...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6e42e1e98a56c6dc5a4ddb065ba8a988WORD
      MARIADB_ROOT_PASSWORD: 936c2c500037f849ff4b5603eea3d922WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6e42e1e98a56c6dc5a4ddb065ba8a988WORD
      DB_PORT: "3306"
