...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: fe7b9b54cd91ba937470885867da8d17WORD
      MARIADB_ROOT_PASSWORD: 8f7eeae6734f88d4c945536506aa76f3WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: fe7b9b54cd91ba937470885867da8d17WORD
      DB_PORT: "3306"
