...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d4afbf0d5f3b68532feb49395c4086aeWORD
      MARIADB_ROOT_PASSWORD: 78efce3d2aa65169cbdec14905e12dcfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d4afbf0d5f3b68532feb49395c4086aeWORD
      DB_PORT: "3306"
