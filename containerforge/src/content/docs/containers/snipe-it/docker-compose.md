...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 68d7be62e70804ddb998d8c1c5687f66WORD
      MARIADB_ROOT_PASSWORD: 233bf449caa10d12d25aee4ed636ae4bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 68d7be62e70804ddb998d8c1c5687f66WORD
      DB_PORT: "3306"
