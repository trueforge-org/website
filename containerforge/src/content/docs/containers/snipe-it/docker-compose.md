...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 498e6a978477143a53f9af34f80fdec8WORD
      MARIADB_ROOT_PASSWORD: 622534e4448e754f458ab8a671fbc84dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 498e6a978477143a53f9af34f80fdec8WORD
      DB_PORT: "3306"
