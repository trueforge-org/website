...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3b29f683e2ef91e1f7c998523dac0e10WORD
      MARIADB_ROOT_PASSWORD: 2d8b08f5f45cb579a727cf09cd18ec52WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3b29f683e2ef91e1f7c998523dac0e10WORD
      DB_PORT: "3306"
