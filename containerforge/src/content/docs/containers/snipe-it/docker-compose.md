...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a4223a135d4c18b739a4d4e297a1e12eWORD
      MARIADB_ROOT_PASSWORD: 762d7bfa9e274baa0ff81236d02d2fd6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a4223a135d4c18b739a4d4e297a1e12eWORD
      DB_PORT: "3306"
