...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f8ffa109bcf8aae4616601a2465c63f8WORD
      MARIADB_ROOT_PASSWORD: cd970181c2fec75f4adfc6edb57abc94WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f8ffa109bcf8aae4616601a2465c63f8WORD
      DB_PORT: "3306"
