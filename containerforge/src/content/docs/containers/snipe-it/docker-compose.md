...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: dfe9319c457f4f06eb9f94da5744d977WORD
      MARIADB_ROOT_PASSWORD: 0cc2477faf9213a113d643516d0ec7a9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: dfe9319c457f4f06eb9f94da5744d977WORD
      DB_PORT: "3306"
