...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ada04e2e7396d6b41da157a491653490WORD
      MARIADB_ROOT_PASSWORD: c6db8a2019446c92ba719c7fca370113WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ada04e2e7396d6b41da157a491653490WORD
      DB_PORT: "3306"
