...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: db99597bf1981dac8a9cbad61c2abe19WORD
      MARIADB_ROOT_PASSWORD: d12b040cef4a47de230265f43e461de5WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: db99597bf1981dac8a9cbad61c2abe19WORD
      DB_PORT: "3306"
