...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 56dcb3d7fb9dd3382e2e1071426a2dd2WORD
      MARIADB_ROOT_PASSWORD: b1b28080408449b0a4f50a8231c6565eWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 56dcb3d7fb9dd3382e2e1071426a2dd2WORD
      DB_PORT: "3306"
