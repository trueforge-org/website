...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b04ae239b9981c40a188a4d10b4bd5a7WORD
      MARIADB_ROOT_PASSWORD: 031af58569825065e10dd8d823a19d80WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b04ae239b9981c40a188a4d10b4bd5a7WORD
      DB_PORT: "3306"
