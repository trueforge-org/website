...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d377bcedf18b14b5c7af6090c7e6b7aWORD
      MARIADB_ROOT_PASSWORD: 9aaf1fde2022e0c14daa5d920f5f8175WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d377bcedf18b14b5c7af6090c7e6b7aWORD
      DB_PORT: "3306"
