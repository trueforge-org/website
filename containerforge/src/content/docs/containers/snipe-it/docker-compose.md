...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5a23def1e0af4250658f606ed2687cedWORD
      MARIADB_ROOT_PASSWORD: a173778cd8288da7442e7dc47cd09c84WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5a23def1e0af4250658f606ed2687cedWORD
      DB_PORT: "3306"
