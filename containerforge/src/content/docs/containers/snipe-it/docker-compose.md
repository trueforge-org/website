...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 87cc772d40003900e54f35461d27eaadWORD
      MARIADB_ROOT_PASSWORD: 01e554d9bdcace9dc526bc0b873cb601WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 87cc772d40003900e54f35461d27eaadWORD
      DB_PORT: "3306"
