...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 112767d945aa0f745f3a1477eb473490WORD
      MARIADB_ROOT_PASSWORD: 522577eb28c82a2829c506287f6e0e84WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 112767d945aa0f745f3a1477eb473490WORD
      DB_PORT: "3306"
