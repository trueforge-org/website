...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0abc8d87414e9f0014b47658ddf092d6WORD
      MARIADB_ROOT_PASSWORD: c2604a22944e5e9addb9c56cd5eb71b6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0abc8d87414e9f0014b47658ddf092d6WORD
      DB_PORT: "3306"
