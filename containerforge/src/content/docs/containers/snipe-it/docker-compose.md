...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0e05560147ac4fc7fcd7d2bfd6a7a5d1WORD
      MARIADB_ROOT_PASSWORD: ed776addde48a09b5780313a67eca360WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0e05560147ac4fc7fcd7d2bfd6a7a5d1WORD
      DB_PORT: "3306"
