...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8aa6f04a095c4b4a9c0ae0a60b14bff3WORD
      MARIADB_ROOT_PASSWORD: 3523070f49db552969545cd1fbd9f87cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8aa6f04a095c4b4a9c0ae0a60b14bff3WORD
      DB_PORT: "3306"
