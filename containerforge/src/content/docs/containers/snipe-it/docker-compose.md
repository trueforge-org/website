...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8cf5c4640f11d27d4a7b83755619dd2eWORD
      MARIADB_ROOT_PASSWORD: 34c639d77a86cd94896bf81b8b077a2cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8cf5c4640f11d27d4a7b83755619dd2eWORD
      DB_PORT: "3306"
