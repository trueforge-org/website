...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: c85a2e3f2c3dc7a5c43e1af384644933WORD
      MARIADB_ROOT_PASSWORD: 8d52657eccaea873857187f587c11677WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: c85a2e3f2c3dc7a5c43e1af384644933WORD
      DB_PORT: "3306"
