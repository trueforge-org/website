...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 208d28f0b4cdd404e26af5305fcc85d7WORD
      MARIADB_ROOT_PASSWORD: efe1b16f0b81748b109eb87f25f49ed1WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 208d28f0b4cdd404e26af5305fcc85d7WORD
      DB_PORT: "3306"
