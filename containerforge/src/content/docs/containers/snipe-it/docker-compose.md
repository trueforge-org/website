...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 251ca4b33b85070d29bd36c3dcb72f05WORD
      MARIADB_ROOT_PASSWORD: b64d9bf8ce74d8c9f6c728f085c87899WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 251ca4b33b85070d29bd36c3dcb72f05WORD
      DB_PORT: "3306"
