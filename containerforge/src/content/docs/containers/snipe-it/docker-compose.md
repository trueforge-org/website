...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1cb40f1a1c458653a58299a5f47aa5e6WORD
      MARIADB_ROOT_PASSWORD: ff9a025d358c614ff500bda752b5925dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1cb40f1a1c458653a58299a5f47aa5e6WORD
      DB_PORT: "3306"
