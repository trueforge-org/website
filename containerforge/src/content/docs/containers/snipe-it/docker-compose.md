...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: e8b7015d5bb9cc78f9afaaab72891761WORD
      MARIADB_ROOT_PASSWORD: 8993bb1c92c173de768db955b0b2bc59WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: e8b7015d5bb9cc78f9afaaab72891761WORD
      DB_PORT: "3306"
