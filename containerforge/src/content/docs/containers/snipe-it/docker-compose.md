...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3d2e65120faa85ab564f11e992665b81WORD
      MARIADB_ROOT_PASSWORD: c99f79d031f91b89025b50d9c5fa4e49WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3d2e65120faa85ab564f11e992665b81WORD
      DB_PORT: "3306"
