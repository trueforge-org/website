...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ef413645d0864751a258292698a512b4WORD
      MARIADB_ROOT_PASSWORD: 7b97e107ce44c503e89baea16e06b2e8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ef413645d0864751a258292698a512b4WORD
      DB_PORT: "3306"
