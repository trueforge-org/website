...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2ecab6e6827eb3aad49c17761bbd66deWORD
      MARIADB_ROOT_PASSWORD: 54e2381e23229eaacb432edfa77ce9e1WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2ecab6e6827eb3aad49c17761bbd66deWORD
      DB_PORT: "3306"
