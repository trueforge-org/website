...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6d3e02259e73c00874a280f1e4ed4545WORD
      MARIADB_ROOT_PASSWORD: 9a89b677cb5c7724049764073d216e22WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6d3e02259e73c00874a280f1e4ed4545WORD
      DB_PORT: "3306"
