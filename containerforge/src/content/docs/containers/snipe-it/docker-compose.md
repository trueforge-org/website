...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 569a5e79902a2592aa7d406b79800926WORD
      MARIADB_ROOT_PASSWORD: 197115c24dacc4beada66bd99a266adcWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 569a5e79902a2592aa7d406b79800926WORD
      DB_PORT: "3306"
