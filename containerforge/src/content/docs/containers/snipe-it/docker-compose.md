...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 769926ab77d456a8d0edfcb92389e516WORD
      MARIADB_ROOT_PASSWORD: 14beb51ef684e499bc1c58c5e75f4b9dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 769926ab77d456a8d0edfcb92389e516WORD
      DB_PORT: "3306"
