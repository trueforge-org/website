...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b8ab9256bd4181f37c33ce0c0666c4e7WORD
      MARIADB_ROOT_PASSWORD: dfe89fb285db219a5760e3286a387b96WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b8ab9256bd4181f37c33ce0c0666c4e7WORD
      DB_PORT: "3306"
