...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 9b1310ced0853651c628804f0645d295WORD
      MARIADB_ROOT_PASSWORD: 76e1d179eec24c6755f65a94d8a3ab7cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 9b1310ced0853651c628804f0645d295WORD
      DB_PORT: "3306"
