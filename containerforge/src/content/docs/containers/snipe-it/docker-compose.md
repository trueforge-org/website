...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1b4c47630a24645f21b14322654ad7ebWORD
      MARIADB_ROOT_PASSWORD: 9dea30276ef2d0db36bc9b668415ee34WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1b4c47630a24645f21b14322654ad7ebWORD
      DB_PORT: "3306"
