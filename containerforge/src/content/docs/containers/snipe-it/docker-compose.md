...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 21408658f1377d865644a5ecb2d69059WORD
      MARIADB_ROOT_PASSWORD: 4dedafa7ce298c362a68bfaa61cdfbbaWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 21408658f1377d865644a5ecb2d69059WORD
      DB_PORT: "3306"
