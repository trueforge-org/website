...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 75ba4b5cfa1deced965cc139124ff193WORD
      MARIADB_ROOT_PASSWORD: 588ca2463de5060f2289120ebf83cfb6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 75ba4b5cfa1deced965cc139124ff193WORD
      DB_PORT: "3306"
