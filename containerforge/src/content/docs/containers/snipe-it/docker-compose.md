...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: b061b90fca7c9ab829ffe003ae92ae95WORD
      MARIADB_ROOT_PASSWORD: aee7cbf6fa45206b6b202940ed93f8d0WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: b061b90fca7c9ab829ffe003ae92ae95WORD
      DB_PORT: "3306"
