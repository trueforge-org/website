...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ed20b671a1715243d55ab95d5c95455fWORD
      MARIADB_ROOT_PASSWORD: 62708af6f5af8e67aef0b26156b7e516WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ed20b671a1715243d55ab95d5c95455fWORD
      DB_PORT: "3306"
