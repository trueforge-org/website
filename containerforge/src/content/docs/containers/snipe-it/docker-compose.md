...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 660e8fe955fbd58e3400a90304c86740WORD
      MARIADB_ROOT_PASSWORD: 89b25abeb21e344b950b1d4a81a1d5bcWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 660e8fe955fbd58e3400a90304c86740WORD
      DB_PORT: "3306"
