...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: a845caf8c1b30daf257feb7e6e762925WORD
      MARIADB_ROOT_PASSWORD: 5432a9ecca3d7c009ee6bc17374bafc8WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: a845caf8c1b30daf257feb7e6e762925WORD
      DB_PORT: "3306"
