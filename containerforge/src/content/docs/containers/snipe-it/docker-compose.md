...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3d2b2ec77cf6d32a42604c6fae79faa5WORD
      MARIADB_ROOT_PASSWORD: 15327876c9ad809dc8c21fb693ca235aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3d2b2ec77cf6d32a42604c6fae79faa5WORD
      DB_PORT: "3306"
