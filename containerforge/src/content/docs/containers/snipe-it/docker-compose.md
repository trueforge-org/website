...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 34c319a3a15215025c72fdd7abe87cd6WORD
      MARIADB_ROOT_PASSWORD: 2d916d643625598af98248581fd4fa38WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 34c319a3a15215025c72fdd7abe87cd6WORD
      DB_PORT: "3306"
