...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 638231229ac4e13a557c4269f7caa967WORD
      MARIADB_ROOT_PASSWORD: d5c17b3dd78e42410937bbba3d097359WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 638231229ac4e13a557c4269f7caa967WORD
      DB_PORT: "3306"
