...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5afb797e42c494431135378b60947a62WORD
      MARIADB_ROOT_PASSWORD: fd0e4a2e200bbb6cde5860229ec82c15WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5afb797e42c494431135378b60947a62WORD
      DB_PORT: "3306"
