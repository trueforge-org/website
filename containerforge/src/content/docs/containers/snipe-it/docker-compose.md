...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 36572db6006e0cfa9aef5860f3eea94aWORD
      MARIADB_ROOT_PASSWORD: a610244217396b0c61de807a6edf87a6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 36572db6006e0cfa9aef5860f3eea94aWORD
      DB_PORT: "3306"
