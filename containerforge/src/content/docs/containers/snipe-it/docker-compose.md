...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0e1064c5f56c1fb5e413ba7e97a816dcWORD
      MARIADB_ROOT_PASSWORD: 074df27d7bdbea31e377bfa36141a716WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0e1064c5f56c1fb5e413ba7e97a816dcWORD
      DB_PORT: "3306"
