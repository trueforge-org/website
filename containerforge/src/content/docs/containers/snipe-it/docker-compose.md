...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 8390eec88d7f789180d0417207064ba5WORD
      MARIADB_ROOT_PASSWORD: 457f38295c67b41372a255b9d19a7c36WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 8390eec88d7f789180d0417207064ba5WORD
      DB_PORT: "3306"
