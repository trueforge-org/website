...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4293832b8488a0721327235c633f602bWORD
      MARIADB_ROOT_PASSWORD: 0ad2cdf0bc0336d49c939a1dbbf5e3dfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4293832b8488a0721327235c633f602bWORD
      DB_PORT: "3306"
