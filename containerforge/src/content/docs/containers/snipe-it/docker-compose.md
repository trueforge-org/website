...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f420744a15113bec95fdaaaa8b239ab0WORD
      MARIADB_ROOT_PASSWORD: 4349526f730aa203ae0291eaf0dc946eWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f420744a15113bec95fdaaaa8b239ab0WORD
      DB_PORT: "3306"
