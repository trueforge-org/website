...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 51465dbdfc5c40e0c2da28f67ce90ae8WORD
      MARIADB_ROOT_PASSWORD: 1bed5ceb7499f803e497352ab0882dbeWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 51465dbdfc5c40e0c2da28f67ce90ae8WORD
      DB_PORT: "3306"
