...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 5fbf3d6a55aae5a98c722cb99e5afee9WORD
      MARIADB_ROOT_PASSWORD: 06d10e03517add8ddd308ad091c72254WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 5fbf3d6a55aae5a98c722cb99e5afee9WORD
      DB_PORT: "3306"
