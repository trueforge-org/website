...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: ae796acdb8b9df3439bf6f118312cacaWORD
      MARIADB_ROOT_PASSWORD: 73bfcb1626339b09af4cb6c503b5ea76WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: ae796acdb8b9df3439bf6f118312cacaWORD
      DB_PORT: "3306"
