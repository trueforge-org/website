...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 76de1b64fef38853040f770212c9fa34WORD
      MARIADB_ROOT_PASSWORD: 17867863d33a6369d3e1f8148af1ae4eWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 76de1b64fef38853040f770212c9fa34WORD
      DB_PORT: "3306"
