...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 94bff40c3f299779cfa64def96b6f122WORD
      MARIADB_ROOT_PASSWORD: 7e7cc1f3e948b4008a27022682885a5cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 94bff40c3f299779cfa64def96b6f122WORD
      DB_PORT: "3306"
