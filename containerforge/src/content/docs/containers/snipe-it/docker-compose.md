...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f74a6f6656d7f7fd81e10526b112ebaeWORD
      MARIADB_ROOT_PASSWORD: b5bca5f75b16b3e031a3f63a02cbfe34WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f74a6f6656d7f7fd81e10526b112ebaeWORD
      DB_PORT: "3306"
