...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 05c0063e31f7dc357e15031549ad29daWORD
      MARIADB_ROOT_PASSWORD: ac0b1b77c9fd003e5622d502fce77a76WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 05c0063e31f7dc357e15031549ad29daWORD
      DB_PORT: "3306"
