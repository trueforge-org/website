...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 4b781744ef3d4c609cee6d61b1cb4b69WORD
      MARIADB_ROOT_PASSWORD: 17764cd270a78dffd5a2cd0c406f33c6WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 4b781744ef3d4c609cee6d61b1cb4b69WORD
      DB_PORT: "3306"
