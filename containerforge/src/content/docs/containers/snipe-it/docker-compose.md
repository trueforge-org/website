...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1aa9a8a4af00551d24ddaeb6e398269cWORD
      MARIADB_ROOT_PASSWORD: c737643c5e07c8aec6a5b6cfbe0d891cWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1aa9a8a4af00551d24ddaeb6e398269cWORD
      DB_PORT: "3306"
