...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: f187bc4a64c5e6bf17c699dadfcf0ae0WORD
      MARIADB_ROOT_PASSWORD: 5493355e39b8c2a2ec8a5bd9da1b141dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: f187bc4a64c5e6bf17c699dadfcf0ae0WORD
      DB_PORT: "3306"
