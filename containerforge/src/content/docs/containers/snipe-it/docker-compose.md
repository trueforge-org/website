...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6722cea40147a5c91c0a0e61510dbc7bWORD
      MARIADB_ROOT_PASSWORD: ac0e228109475086a17b0cb0a0ea929dWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6722cea40147a5c91c0a0e61510dbc7bWORD
      DB_PORT: "3306"
