...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 08709b88b20f1047a0381974052dc71aWORD
      MARIADB_ROOT_PASSWORD: e0187531e1380f33856d7ef67f7df605WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 08709b88b20f1047a0381974052dc71aWORD
      DB_PORT: "3306"
