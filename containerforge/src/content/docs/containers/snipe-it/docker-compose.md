...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 239fb7f4ddbf5af3e40a874e3594f17dWORD
      MARIADB_ROOT_PASSWORD: 715dc6e31a03b9207759cdc46d42ce1bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 239fb7f4ddbf5af3e40a874e3594f17dWORD
      DB_PORT: "3306"
