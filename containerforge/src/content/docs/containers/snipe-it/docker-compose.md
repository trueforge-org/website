...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 096fc1a056b68c6e1501408383fc8f5eWORD
      MARIADB_ROOT_PASSWORD: 14d198c787839450275f8a3cad2cdc33WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 096fc1a056b68c6e1501408383fc8f5eWORD
      DB_PORT: "3306"
