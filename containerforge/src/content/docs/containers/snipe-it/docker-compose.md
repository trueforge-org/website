...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 61ac55d2ffa22562af23a401b46b563aWORD
      MARIADB_ROOT_PASSWORD: 251e65754769697bd8660ada71359528WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 61ac55d2ffa22562af23a401b46b563aWORD
      DB_PORT: "3306"
