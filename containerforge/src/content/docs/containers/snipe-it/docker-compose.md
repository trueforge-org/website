...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: d9b7f69cd00953efcfff3cc1b073b5efWORD
      MARIADB_ROOT_PASSWORD: a57cd214f2938a59c63ac75cb7216985WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: d9b7f69cd00953efcfff3cc1b073b5efWORD
      DB_PORT: "3306"
