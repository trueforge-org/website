...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 30d92f5cf660484a717c7e6658438ae9WORD
      MARIADB_ROOT_PASSWORD: f44a5fc10c5a72a0947f00e4b144be19WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 30d92f5cf660484a717c7e6658438ae9WORD
      DB_PORT: "3306"
