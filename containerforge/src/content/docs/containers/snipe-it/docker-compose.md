...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 878482df39d157c910cf970262d1d826WORD
      MARIADB_ROOT_PASSWORD: 1c8a0273cfd63c4c1c3b347d507f6425WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 878482df39d157c910cf970262d1d826WORD
      DB_PORT: "3306"
