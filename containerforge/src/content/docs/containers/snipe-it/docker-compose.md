...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 595d8808b0af8ecd2dbbe4e0bf4d26a1WORD
      MARIADB_ROOT_PASSWORD: b206b4188546a990e969dbbbd5a83fccWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 595d8808b0af8ecd2dbbe4e0bf4d26a1WORD
      DB_PORT: "3306"
