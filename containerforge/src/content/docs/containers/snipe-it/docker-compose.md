...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3af9c5ad5313cabb31051820ba34e33fWORD
      MARIADB_ROOT_PASSWORD: aee5c6095b308a86cc76da87aecd6c4aWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3af9c5ad5313cabb31051820ba34e33fWORD
      DB_PORT: "3306"
