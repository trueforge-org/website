...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 1dbb37a206a0ace89fd57a148999c65eWORD
      MARIADB_ROOT_PASSWORD: 083e8aa42c8adb134589f3c60392b6bfWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 1dbb37a206a0ace89fd57a148999c65eWORD
      DB_PORT: "3306"
