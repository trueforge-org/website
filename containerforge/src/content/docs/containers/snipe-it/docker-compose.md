...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 0c31135e3ed5862e2fb0f3cbc8bca5d8WORD
      MARIADB_ROOT_PASSWORD: 317a6da14db412b77ed2ee84cdc4412fWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 0c31135e3ed5862e2fb0f3cbc8bca5d8WORD
      DB_PORT: "3306"
