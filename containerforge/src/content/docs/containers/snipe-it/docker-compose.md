...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 6abbcc75a4fe3bde9828c9d4e94bde17WORD
      MARIADB_ROOT_PASSWORD: 307184ab5adb11f53d7f78843e356bb9WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 6abbcc75a4fe3bde9828c9d4e94bde17WORD
      DB_PORT: "3306"
