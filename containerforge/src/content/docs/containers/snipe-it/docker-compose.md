...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 3ad3dbf2be33db1224c897247f29fddeWORD
      MARIADB_ROOT_PASSWORD: 23b873b2af2a081162bb91665e2eee91WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 3ad3dbf2be33db1224c897247f29fddeWORD
      DB_PORT: "3306"
