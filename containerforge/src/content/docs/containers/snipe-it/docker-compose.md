...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 7b0ff7e2d7d9c2a401fb64cee9c55529WORD
      MARIADB_ROOT_PASSWORD: de2472b9d076e9224f886e8c192a694bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 7b0ff7e2d7d9c2a401fb64cee9c55529WORD
      DB_PORT: "3306"
