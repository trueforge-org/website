...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 311d11ad03e473a128bb62462e7c37d9WORD
      MARIADB_ROOT_PASSWORD: 71aeea6a6a42ea4b3966d3bd8b8cf65bWORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 311d11ad03e473a128bb62462e7c37d9WORD
      DB_PORT: "3306"
