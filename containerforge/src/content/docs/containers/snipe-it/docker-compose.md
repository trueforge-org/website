...
services:
  mariadb:
    ...
    environment:
      ...
      MARIADB_PASSWORD: 2a7e00aa8f1b31f2598f68113249bad6WORD
      MARIADB_ROOT_PASSWORD: 513812e4c724d6253b84d8671fe22ee7WORD
  ...
  snipe-it:
    ...
    environment:
      ...
      DB_HOST: mariadb
      DB_PASSWORD: 2a7e00aa8f1b31f2598f68113249bad6WORD
      DB_PORT: "3306"
