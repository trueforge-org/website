...
- Push to git
- Wait for flux to get it deployed. This can be taken up to 30 minutes. Another option you can do is run [flux reconcile](/truetech/truecharts/guides/cheatsheet) or configure a flux [webhook](/truetech/truecharts/guides/fluxcd/webhook).
