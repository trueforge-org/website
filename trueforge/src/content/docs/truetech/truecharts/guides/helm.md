...
If you want to install a chart using helm, lookup the name of the chart in our [Chart list](/truetech/truecharts/charts/description-list). Then, run this command to install it directly from our OCI repository:

```shell title="Install Chart"
   helm install mychart oci://oci.trueforge.org/truetech/truecharts/CHARTNAME
   ```
...
```shell title="Install Chart With Settings"
   helm install mychart oci://oci.trueforge.org/truetech/truecharts/CHARTNAME -f values.yaml
   ```
...
```shell title="Chart Namespaces"
   helm install mychart oci://oci.trueforge.org/truetech/truecharts/CHARTNAME -f values.yaml -n NAMESPACE
   ```
...
```shell title="Chart Upgrades"
   helm upgrade oci://oci.trueforge.org/truetech/truecharts/CHARTNAME -f values.yaml -n NAMESPACE
   ```
