...
In this guide we are preparing LVM to use in a forgetool environment. Also the configuration is done in a way it can be used by e.g. volsync for backup/restore functionalities.
...
All are implemented and setup in forgetool for your convenience.
...
Add these two kernel modules. Use modprobe for typical linux installs or add them to your talconfig.yaml if using TalHelper or forgetool as shown below:
