...
- See the [Full Examples](/truetech/truecharts-common/container/envfrom#full-examples) section for complete examples.
...
You can opt out of this by setting [`expandObjectName`](/truetech/truecharts-common/container/envfrom#envfromsecretrefexpandobjectname) to `false`
...
You can opt out of this by setting [`expandObjectName`](/truetech/truecharts-common/container/envfrom#envfromconfigmaprefexpandobjectname) to `false`
