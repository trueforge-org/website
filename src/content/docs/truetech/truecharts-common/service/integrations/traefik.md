...
- See the [Full Examples](/truetech/truecharts-common/service/integrations/traefik#full-examples)
...
Alternatively you can set a [server name](/truetech/truecharts-common/service/integrations/traefik#servername)
and [root CAs](/truetech/truecharts-common/service/integrations/traefik#rootcas) to use when performing
TLS validation.
...
You can opt out of this by setting [`expandObjectName`](/truetech/truecharts-common/service/integrations/traefik#rootcassecretrefexpandobjectname)
to `false`
...
You can opt out of this by setting [`expandObjectName`](/truetech/truecharts-common/service/integrations/traefik#rootcasconfigmaprefexpandobjectname)
to `false`
