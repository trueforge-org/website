...
- See the [Full Examples](/truetech/truecharts-common/middlewares/traefik/add-prefix#full-examples) section for complete examples.
...
- See available middleware keys [here](/truetech/truecharts-common/middlewares).
