...
The GPU desired to be passed through to the Talos VM will need to be [isolated](/truetech/truetool/virtual-machines/truenas-scale/#gpu-isolation) within SCALE.
