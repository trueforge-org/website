...
See [below](/truetech/truecharts/systemrequirements/#best-effort-cpu-recommendations) for additional information.
...
You can find the VM install instructions [here](https://trueforge.org/forgetool/virtual-machines/truenas-scale/)
