...
In this documentation we will explain the standardized layout options. For an example layout, please see our standard Chart.yaml [template](https://github.com/trueforge-org/truecharts/blob/master/charts/stable/app-template/Chart.yaml)
...
Please refer to our standard Chart.yaml [template](https://github.com/trueforge-org/truecharts/blob/master/charts/stable/app-template/Chart.yaml) to see which unused values needs which treatment.
...
An example of how to list TrueCharts as a maintainer is available in our standard Chart.yaml [template](https://github.com/trueforge-org/truecharts/blob/master/charts/stable/app-template/Chart.yaml).
