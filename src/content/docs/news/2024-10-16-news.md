...
Check out the [guides](/truetool/csi/) to get started!
...
- [VM Setup](/truecharts/systemrequirements)
- [Getting Started with Clustertool](/truetool/getting-started/)
- [clustertool init](/truetool/commands/init/)
- Edit your config (talconfig.yaml and clusterenv.yaml)
- [clustertool genconfig](/truetool/commands/genconfig/)
- [clustertool apply](/truetool/commands/talos/apply/)
...
- [clustertool scaleexport](/truetool/commands/scale/export)
...
- [clustertool helmrelease install](/truetool/commands/helmrelease/install/)
